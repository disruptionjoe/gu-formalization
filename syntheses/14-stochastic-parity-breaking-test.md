...
**Source basis.** `passes/02-substrate-loophole-lenses/11-stochastic-geometer-loophole.md`, `passes/04-heterodox-problem-shape-math/21-ps-stochastic-heterodox.md`, `syntheses/00b-loophole-synthesis-witten-evasion-test.md`, `passes/02-substrate-loophole-lenses/12-quantum-measurement-loophole.md`, `passes/02-substrate-loophole-lenses/13-nondeterminism-loophole.md`. Cross-built against the six-axis protocol (WRK-375), the no-go-forgetful-image map (WRK-376), and the Nielsen protocol-analogy pilot (WRK-378).
