...
**Source basis.** `literature/04-spectral-triples-anomaly-chirality-distributed-systems-analogies.md`, `process/syntheses/00e-problem-shape-distributed-systems-meta-synthesis.md`, `roadmap/15-persona-pathway-ranking.md` (pathway E ranks 6/16 on the 15-persona panel; "best heterodox operational bridge"). Cross-built against the six-axis protocol (internal origin artifact) and the no-go-forgetful image map (internal origin artifact).
