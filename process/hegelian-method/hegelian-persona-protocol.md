...
**Status.** Public draft artifact. Generated 2026-05-30 as the single-pass output of WRK-381. Public path: `process/hegelian-method/hegelian-persona-protocol.md`.
...
- Source artifacts (all in `gu-formalization/`):
  - `process/persona-passes/INDEX.md` and the 35 persona passes themselves (01-35 across five lens families).
  ...
  - `roadmap/15-persona-pathway-ranking.md` — the persona-voted pathway ranking that scoped this card.
