...
- `process/persona-passes/` contains 35 persona passes across mathematical physics, computation-substrate, heterodox problem-shape, and distributed-systems lenses.
...
The current priority ranking is in `roadmap/five-persona-value-ranking-rubric.md` and `roadmap/15-persona-pathway-ranking.md`. The first public pathway artifacts begin at `canon/six-axis-specification-protocol.md`.
