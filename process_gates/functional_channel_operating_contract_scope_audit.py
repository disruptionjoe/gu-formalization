...
assert contract["standing_ledger"]["ref"].endswith("conditional-physics-ledger-v0.5.json")
...
print("PASS: functional channels, v0.5 ledger, adverse-row independence, source-silent repaired horn, circularity fence and the soldering/weld/null-domain gate are wired without lane or system promotion")
