...
assert contract["standing_ledger"]["ref"].endswith("v0.85.json")
assert "latest_metric_transverse_torsion_evidence" in contract["active_scientific_directives"][0]
assert "CONSTRUCT_MOVING_SHIAB_HODGE_CURVATURE_DENSITY_OBSERVATION" in json.dumps(contract)
