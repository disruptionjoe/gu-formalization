...
checks = {
    ...
    "LANES points to v0.16": "conditional-physics-ledger-v0.16.json" in read("LANES.yaml"),
    ...
    "context pack points to v0.16": "conditional-physics-ledger-v0.16" in read("lab/process/agent-context-pack.md"),
    "contract points to v0.16": "conditional-physics-ledger-v0.16" in read("lab/process/functional-channel-operating-contract-v1.0.md"),
    "contract JSON points to v0.16": "conditional-physics-ledger-v0.16" in read("lab/process/functional-channel-operating-contract-v1.0.json"),
