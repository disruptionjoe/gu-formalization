...
assert reaches_historical_snapshot(
    contract, "lab/process/conditional-physics-ledger-v0.44.json"
)
...
print("PASS: historical v0.44 source-lift rank certificate is immutable and reachable from the current append-only ledger without full-action, scalar, domain, BV/BFV, datum, quotient or posture inflation")
