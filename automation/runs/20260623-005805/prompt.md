...
Run id: 20260623-005805
Run started at: 2026-06-23T00:58:05.0482271-05:00
...
6. Write a run summary at `automation/runs/20260623-005805/summary.md`.
...
- the newest relevant files under `explorations/`, `active-research/`, `roadmap/`, and `papers/`
...
- write `automation/runs/20260623-005805/summary.md` with:
  - selected goals
  - files changed
  - verdicts
  - unresolved blockers
