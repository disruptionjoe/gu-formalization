...
- `official-transcript-reviewed` - an official transcript was inspected for the
  named claim windows in a linked source packet.
- `machine-captions-reviewed` - automated captions were inspected for
  discovery and negative-scope purposes; they are not quotation authority.
- `secondary-exposition-reviewed` - a secondary mathematical explainer was
  checked claim by claim against primary sources and repo receipts; it is a
  construction map, not formula authority.
...
| `GU-POD-2020-PORTAL-SPECIAL` | 2020-04-02 | The Portal, "A Portal Special Presentation - Geometric Unity: A First Look" | Eric Weinstein | LOCAL: `lab/sources/transcripts/portal-special-gu-first-look-2020-04-02.md` (+ [Portal Group source](https://theportal.group/a-portal-special-presentation-geometric-unity-a-first-look/)) | Full GU presentation: preface, Oxford lecture recording, and supplementary presentation. Key ledger passage: 00:43:47 exogenous-data statement. | `transcript-available` (local) | Very high: canonical public GU presentation surface. |
...
| `GU-POD-2020-KEATING-EP49` | 2020-05-19 | Into the Impossible, "Eric Weinstein: Theories of Everything, Geometric Unity & Science's Paths" | Brian Keating | [Portal Wiki](<https://theportal.wiki/wiki/Eric_Weinstein:_Theories_of_Everything,_Geometric_Unity_%26_Science%E2%80%99s_Paths._Ep_49_(YouTube_Content)>) | Automated captions were reviewed for the 14D pullback, nonconstant cosmological/VEV, and Lagrangian windows. They display no current, Riesz, Noether, or full-20 zero-order map. | `machine-captions-reviewed` | Discovery/negative-scope only; use the author draft for construction formulas. |
| `GU-POD-2020-DARKHORSE-FUNDAMENTAL-TRUTH` | 2020-06-27 | DarkHorse Podcast, "Bret Weinstein and Eric Weinstein: Fundamental Truth and How to Think About it" | Bret Weinstein / Heather Heying | [official Portal Group page](https://theportal.group/bret-weinstein-and-eric-weinstein-fundamental-truth-and-how-to-think-about-it/) | Automated captions were reviewed for the observerse/hairband section. The phrase "extra piece of data" belongs to an economics/social-choice discussion, not the GU datum. No current source-action map was found. | `machine-captions-reviewed` | Observerse framing and a Layer-0 homonym control only. |
...
| `GU-POD-2021-KEATING-REVEALED-1` | 2021-04-09 | Into the Impossible, "Eric Weinstein: Geometric Unity...REVEALED! Part 1" | Brian Keating | [official Portal Group transcript](https://theportal.group/into-the-impossible-eric-weinstein-geometric-unity-revealed/) | Reviewed windows include the equations/Lagrangian distinction, Einstein orbit-perpendicularity, promoted gauge transformations, unresolved VEV choice/location, and missing preferred Shiab projection. | `official-transcript-reviewed` | High for source intent and explicit open boundaries; the draft remains the formula authority. |
| `GU-POD-2021-KEATING-REVEALED-2` | 2021-04-09 | Into the Impossible, "Part 2 Eric Weinstein: Geometric Unity...REVEALED!" | Brian Keating | [official Portal Group transcript](https://theportal.group/into-the-impossible-eric-weinstein-geometric-unity-revealed/) | Reviewed as the paired official transcript surface; no full current/Riesz/zero-order placement is supplied. | `official-transcript-reviewed` | Use with Part 1 and the author draft; not a mathematical receipt by itself. |
...
| `GU-POD-2025-KEATING-DESI-GU` | 2025-06-12 | Into the Impossible, "Eric Weinstein's Theory of Everything Confirmed?" | Brian Keating | [official Portal Group transcript](https://theportal.group/eric-weinstein-and-brian-keating-eric-weinsteins-theory-of-everything-confirmed/) · [secondary Tapesearch locator](https://www.tapesearch.com/episode/eric-weinstein-s-theory-of-everything-confirmed/LNnJAd34FMDjbSFkrZywQU) | The official transcript verifies the two-field dark-energy/flatness argument at `00:44:13--00:45:52`: two movable fields are proposed to reduce two puzzles to one. It does not identify the curvature object or supply the action/rank proof. Local source record: `lab/sources/keating-interview-2025-06-12-source-record.md`. | `official-transcript-reviewed` | High for source intent. Cite the exact timestamped passage; keep the spatial-flatness versus four-curvature Layer-0 fence and use the April seminar for the separate theta formula. |
| `GU-MEDIA-2025-UCSD-SEMINAR` | 2025-04 | UCSD / Into the Impossible GU seminar transcript | Eric Weinstein / Brian Keating | LOCAL: `papers/drafts/Transcript into the impossible.md` | Raw transcript contains the two-connection distortion, double-coset equivariance, divergence-free motivation, Higgs/Yukawa/minimal-coupling discussion, and VEV language. | `transcript-available` (local raw) | High for modern source wording; verify load-bearing quotations against video. |
...
| `GU-MEDIA-2025-TOE-ICEBERG` | 2025-04-23 | Theories of Everything, "The Geometric Unity Iceberg... Oh Boy" / in-depth GU explanation | Curt Jaimungal | [YouTube](https://youtu.be/AThFAxF7Mgw); [transcript mirror](https://podscripts.co/podcasts/theories-of-everything-with-curt-jaimungal/the-geometric-unity-iceberg-oh-boy) | Three-hour secondary mathematical exposition with a 30-step recap, explicit recovery crosswalk, and important self-caveats around `U(64,64)`, Klein--Gordon, Einstein, and Yang--Mills reconstructions. A user-supplied `1280x960` Step 13 still, independently locatable at `00:53:03` and recorded under SHA-256 `66a6438569fe0e1e5528b3b09de303dfa7c2f992d81ca3a322f27fa64f352fb2`, explicitly types the gauge-group/potential/connection-space analogies and proposed `Omega^1(S)+Omega^0(S)` odd carrier while labelling the slide rough notes. | `transcript-available`, `secondary-exposition-reviewed`, `paired-followup-reviewed` | High as a construction map; not primary Weinstein formula authority. Reconciled row by row in `curt-jaimungal-gu-iceberg-claim-reconciliation-2026-07-31.md` and paired with Weinstein's corrections in `paired-curt-eric-gu-axiom-and-argument-reconstruction-2026-07-31.md`. |
...
| `TOE-TUROK-QG-NO-STRINGS` | (episode date TBD) | Theories of Everything, "A Route to Quantum Gravity Without Strings" (quadratic gravity; ghost handling adjacent to the pairing-family conjecture) | Neil Turok | (podscripts slug: neil-turok-a-route-to-quantum-gravity-without-strings) | — | `candidate` (intake on pull; pairing-family + Boyle-Turok legs expected) |
