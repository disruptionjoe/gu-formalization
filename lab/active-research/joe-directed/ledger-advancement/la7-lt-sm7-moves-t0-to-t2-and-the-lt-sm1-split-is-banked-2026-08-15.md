...
### 1.4 The middle node is `SU(3,2)`, decided by integers
...
selection, not a re-transcription:** the audio was not re-listened to. What is
established is which of the two readings already present in the repo is
consistent with the source's own adjacent, twice-repeated statement.
