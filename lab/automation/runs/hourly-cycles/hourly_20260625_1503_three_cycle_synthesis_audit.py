#!/usr/bin/env python3
"""Audit the 1503 three-cycle fifteen-hole synthesis."""
...
DOC = ROOT / "explorations" / "hourly-20260625-1503-three-cycle-fifteen-hole-synthesis.md"
...
class ThreeCycleSynthesis1503Audit(unittest.TestCase):
    @classmethod
    ...
    def test_identity_and_verdict(self) -> None:
        self.assertEqual(
            ...
            "Hourly20260625_1503_ThreeCycleFifteenHoleSynthesis_V1",
        )
    ...
    def test_cycle3_matrix_counts_are_conservative(self) -> None:
        ...
        self.assertEqual(matrices["quality_candidates_claimed"], 28)
    ...
    def test_result_counts_match_holes(self) -> None:
        ...
        self.assertEqual(counts["scoped_negative_not_identity_receipt"], 2)
    ...
    def test_final_category_review_blocks_inflation(self) -> None:
        ...
        for key in [
            ...
            "dgu_adjacent_windows_not_actual_identity_fields",
            "dgu_scoped_negative_not_vz_replay",
            "ucsd_transcript_locator_not_typed_rs_operator",
            "ucsd_locator_not_frame_evidence",
            "qft_branch_template_not_physical_quotient",
            "scoped_negative_not_global_no_go",
        ]:
            self.assertTrue(review[key], key)
        self.assertFalse(review["target_import_used"])

    def test_1503_specific_commits_and_next_objects_are_present(self) -> None:
        self.assertEqual(self.summary["cycle_commits"]["cycle_1"], "b1a2cc5")
        self.assertEqual(self.summary["cycle_commits"]["cycle_2"], "74090c4")
        for token in [
            "OfficialTzSEvmqxu48FormulaSourceAssetPacketDecision_1503_Cycle2_Lane1_V1",
            "IG_D7_FORMAL_OR_CAS_PROOF_OBJECT_ADMISSION_1503_C2_L2_V1",
            "DGUActual01SectorIdentityPacket_V1",
            "RS_UCSD_VISUAL_LOCATOR_OR_UNAVAILABILITY_PACKET",
...
if __name__ == "__main__":
    result = unittest.TextTestRunner(verbosity=2).run(
        unittest.defaultTestLoader.loadTestsFromTestCase(ThreeCycleSynthesis1503Audit)
    )
