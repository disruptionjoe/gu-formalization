...
External deep-research briefs and adversarial-hardening passes run against the program's results -- prompts
sent to web-enabled deep-research models, and the reports that came back. Used to verify prior art, harden
claims, and stress-test the lead paper.

- `dr1-identification-boundary-eta-2026-06-28.md`, `dr2-tangential-einvariant-2026-06-28.md`,
  `dr6-novelty-prior-art-2026-06-28.md` — topic briefs (boundary eta-invariant, tangential e-invariant,
  novelty / prior art).
