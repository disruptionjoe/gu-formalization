---
title: "Perspective 40 — Information / Coding Theorist (holographic codes)"
status: process
doc_type: perspective_pass
updated_at: "2026-06-26"
---

# Perspective 40 — Information / Coding Theorist (holographic codes)

**Lens:** quantum error correction, channel capacity, holographic / HaPPY codes, bulk-boundary encoding, CSS / homological codes, rate-distortion. (Sibling to Perspective 18, tensor networks.)
