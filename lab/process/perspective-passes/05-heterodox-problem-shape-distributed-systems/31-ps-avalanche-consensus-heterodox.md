---
title: "Perspective 31 — Avalanche / Snowball / Metastable Consensus (Heterodox Lean)"
status: process
doc_type: perspective_pass
updated_at: "2026-05-31"
---

# Perspective 31 — Avalanche / Snowball / Metastable Consensus (Heterodox Lean)

**Date:** 2026-05-28
**Perspective:** Distributed-systems specialist in the Avalanche / Snowball / Slush family (Team Rocket 2018), repeated subsampled voting, probabilistic safety/liveness, DAG-based ledgers, metastability, FLP, CAP, asynchronous BFT, VRF sortition.
