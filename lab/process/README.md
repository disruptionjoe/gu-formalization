...
- `conditional-physics-ledger-v0.18.json` - current machine ledger; 82 active targets, exact compact-core `q0-q0` bulk-numerator zero and a typed mixed `q0-qm` completion fork. Verdict counts remain `33/19/24/6`, residue remains `84 + >=19 functions + 9 forks`, and four scoped quotients remain ranked. Four rows migrate; `LT-SM8` returns from `PROVEN_UNSUPPLYABLE` to `MISSING_CONSTRUCTION` without consuming P1/P2/P3.
