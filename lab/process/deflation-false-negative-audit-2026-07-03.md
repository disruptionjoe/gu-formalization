...
| 9 | Stochastic parity-breaking substrate (PERSPECTIVE-M) | `triage-pass-...-2026-06-30.md` | "analogy only, zero derived parity" — but explicitly NOT killed because a cheap GFF even-d Bochner closure exists | **CORRECTLY handled** (declined to KILL where a cheap closure survives) | — anti-over-deflation discipline working |
...
3. **It declines to KILL when a cheap closure survives** (PERSPECTIVE-M) and **PARKs rather than KILLs even
