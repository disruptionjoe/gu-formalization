...
| `Lean/GUFormalization/GroupActionBurnsideBisetCoend.lean` | Fixed-middle balance law for Burnside restriction correspondences, quotient descent through its equivalence closure, and three-stage associativity coherence | `LEAN-VERIFIED`; 2026-08-31 focused computational-interface integration with `11/11` nonnormal `S3` controls; no all-object coend, universal property, bicategory classification, Mackey 2-functor or physical/source realization |
