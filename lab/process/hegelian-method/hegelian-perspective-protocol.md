...
**Status.** Public draft artifact. Generated 2026-05-30 as the single-pass output of WRK-381. Public path: `lab/process/hegelian-method/hegelian-perspective-protocol.md`.
...
- Source artifacts (all in `gu-formalization/`):
  - `lab/process/perspective-passes/INDEX.md` and the 35 perspective passes themselves (01-35 across five lens families).
  ...
  - `lab/roadmap/15-perspective-pathway-ranking.md` — the perspective-voted pathway ranking that scoped this card.
