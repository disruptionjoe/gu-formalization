...
When halting: append a dated `## HALT` note to `lab/process/loop-adversarial-log.md` with the
...
3. Read `lab/process/runbooks/five-lane-frontier-run.md`.
4. Read `lab/process/runbooks/claim-status-consistency-quality-workflow.md`.
...
```json
{
  ...
  "unit_runbook": "lab/process/runbooks/five-lane-frontier-run.md",
  "cycles": 3,
  "lanes_per_cycle": 5,
