...
IC4 (from `explorations/geometry-curvature-emergence/ic4-lagrangian-tmunu-derivation-2026-06-23.md`) at reconstruction grade.
...
from `explorations/geometry-curvature-emergence/codazzi-sp64-2026-06-23.md` Section 7.1.

IC4 (`explorations/geometry-curvature-emergence/ic4-lagrangian-tmunu-derivation-2026-06-23.md`) identifies
...
Additionally, the rfail-umbilic note (`explorations/geometry-curvature-emergence/rfail-umbilic-sections-2026-06-23.md`)
...
| result | source |
|---|---|
| Gimmel metric gg, signature (9,5), frame {e_a^H, F_{(bc)}} | `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md` |
| Gimmel Christoffel symbols H-H-V, H-H-H, V-V-V blocks | `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md` §3 |
| Gauss equation: G^X = G^Y_T + Q(B) + E^Psi | `explorations/geometry-curvature-emergence/codazzi-sp64-2026-06-23.md` §4 |
| IC4: term-by-term Lagrangian match T^{dist} = Q^{TF}/8piG, T^{DD} = E^{Psi,TF}/8piG | `explorations/geometry-curvature-emergence/ic4-lagrangian-tmunu-derivation-2026-06-23.md` §6.2 |
| Codazzi equation [CodEq-Explicit] for II_s^H | `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md` |
| Q^{TF}(B) = 0 for umbilic sections | `explorations/geometry-curvature-emergence/codazzi-general-non-umbilic-2026-06-23.md` §3.2 |
...
Recall from `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md` that the gimmel metric gg on
...
`explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md` Section 3:
...
we use the moving-frame Christoffels derived in `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md`.
...
`explorations/geometry-curvature-emergence/codazzi-sp64-2026-06-23.md`): j_s: N_s -> ad(P_s). Under this identification:
...
SO(1,3)-representation from `explorations/geometry-curvature-emergence/ic1-soldering-map-ns-adps-2026-06-23.md`. The
...
(from `explorations/geometry-curvature-emergence/codazzi-sp64-2026-06-23.md` §4), we rewrite:
...
From the IC4 derivation (`explorations/geometry-curvature-emergence/ic4-lagrangian-tmunu-derivation-2026-06-23.md`
§6.2, Match 3):
...
C_{Gauss} is defined in `explorations/geometry-curvature-emergence/ic4-lagrangian-tmunu-derivation-2026-06-23.md`
...
From `explorations/geometry-curvature-emergence/cpa1-tobs-coefficient-2026-06-23.md`, the Tikhonov regularization
scale is:
...
From the rfail-umbilic computation (`explorations/geometry-curvature-emergence/rfail-umbilic-sections-2026-06-23.md`),
...
The zero-order verification of Shiab (from `explorations/vz-evasion/vz-subprincipal-symbol-rs-2026-06-23.md`
and `explorations/vz-evasion/vz-oq2-lower-order-curvature-2026-06-23.md`) established that Shiab
...
curvature pieces H^{(1,2,3)} from `explorations/geometry-curvature-emergence/hc1-hidden-curvature-components-2026-06-22.md`
and `explorations/geometry-curvature-emergence/hc1-sl2c-bianchi-spinor-2026-06-23.md` are sourced by the distortion
...
From `explorations/geometry-curvature-emergence/cpa1-tobs-coefficient-2026-06-23.md`, the CPA-1 computation uses the
...
This matches T^{YM,TF} + T^{mix,TF} from `explorations/geometry-curvature-emergence/ic4-lagrangian-tmunu-derivation-2026-06-23.md`
Section 3.
...
`explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md`, contracted to give [G^Y_T]^{TF}_{mu nu},
...
**Builds on:**
- `explorations/geometry-curvature-emergence/ic4-lagrangian-tmunu-derivation-2026-06-23.md` (IC4 term-by-term match,
  OQ1 and OQ3 formulation)
- `explorations/geometry-curvature-emergence/codazzi-sp64-2026-06-23.md` (Gauss equation, IC1 soldering map)
- `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md` (gimmel Christoffels, moving-frame gauge)
- `explorations/geometry-curvature-emergence/rfail-umbilic-sections-2026-06-23.md` (ambient curvature gate identification)
- `explorations/geometry-curvature-emergence/cpa1-tobs-coefficient-2026-06-23.md` (Simons +4K correction, CPA-1 gate)
- `explorations/geometry-curvature-emergence/ic2-positivity-soldering-normal-2026-06-23.md` (IC2 positivity, B_fund = 512h)
- `explorations/geometry-curvature-emergence/hc1-sl2c-bianchi-spinor-2026-06-23.md` (H^{(i)} hidden curvature, torsion sourcing)
...
from `explorations/geometry-curvature-emergence/ic4-lagrangian-tmunu-derivation-2026-06-23.md`.
