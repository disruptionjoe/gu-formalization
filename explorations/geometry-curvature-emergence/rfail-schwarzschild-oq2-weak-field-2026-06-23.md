...
**This note uses:**
- `explorations/geometry-curvature-emergence/rfail-non-umbilic-schwarzschild-2026-06-23.md` — exact Schwarzschild
...
- `explorations/geometry-curvature-emergence/codazzi-sp64-bundle-2026-06-23.md` — Gauss identity; R_fail definition;
  Q(B), G^Y_T, E^Psi structure
- `explorations/geometry-curvature-emergence/codazzi-general-non-umbilic-2026-06-23.md` — Q^{TF}(B) formula;
  quadratic structure in hat-B
- `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md` — second fundamental form;
