...
s: X^4 -> Y^14 is (from `explorations/geometry-curvature-emergence/codazzi-sp64-bundle-2026-06-23.md`):
...
from `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md`, but the symmetry argument
forces G^Y_T^{TF} = 0.
...
- `explorations/geometry-curvature-emergence/codazzi-sp64-bundle-2026-06-23.md` — Gauss equation, R_fail definition
...
- `explorations/geometry-curvature-emergence/codazzi-sp64-2026-06-23.md` — full Sp(64) Codazzi equation, IC1-IC3
- `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md` — II_s^H = 0 for tautological section,
  gimmel Christoffel symbols
- `explorations/geometry-curvature-emergence/ic2-positivity-soldering-normal-2026-06-23.md` — IC2 positivity
- `explorations/geometry-curvature-emergence/ic3-nonlinear-conservation-2026-06-23.md` — IC3 nonlinear conservation
- `explorations/geometry-curvature-emergence/ic4-lagrangian-tmunu-derivation-2026-06-23.md` — IC4 Lagrangian match
