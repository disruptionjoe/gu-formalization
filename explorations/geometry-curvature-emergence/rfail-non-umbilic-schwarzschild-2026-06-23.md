...
(`explorations/geometry-curvature-emergence/codazzi-sp64-bundle-2026-06-23.md`, `explorations/geometry-curvature-emergence/rfail-umbilic-sections-2026-06-23.md`):
...
From `explorations/geometry-curvature-emergence/codazzi-general-non-umbilic-2026-06-23.md` §3.3:
...
(from `explorations/generation-sector/oq3a-willmore-k3-selection-2026-06-23.md` and IC4); if this is
...
- `explorations/geometry-curvature-emergence/rfail-umbilic-sections-2026-06-23.md` — vacuum umbilic case:
  R_fail = 0 (CONDITIONALLY_RESOLVED)
- `explorations/geometry-curvature-emergence/codazzi-general-non-umbilic-2026-06-23.md` — general non-umbilic case:
...
**This note uses:**
- `explorations/geometry-curvature-emergence/codazzi-sp64-bundle-2026-06-23.md` — R_fail definition and Gauss equation
- `explorations/geometry-curvature-emergence/rfail-umbilic-sections-2026-06-23.md` — umbilic case resolution
- `explorations/geometry-curvature-emergence/codazzi-general-non-umbilic-2026-06-23.md` — Q^{TF}(B) structure
- `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md` — II_s^H and distortion theta
- `explorations/geometry-curvature-emergence/ic4-lagrangian-tmunu-derivation-2026-06-23.md` — GU action and EL equation
- `explorations/generation-sector/oq3a-willmore-k3-selection-2026-06-23.md` — Willmore variational principle
