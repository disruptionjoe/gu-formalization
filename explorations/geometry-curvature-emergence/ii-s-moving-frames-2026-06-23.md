...
`explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md` (Phase 5) by adding:
...
- Section 6 (B1-B3): explicit assessment of the three unit-identification conditions
  from `explorations/time-as-finality-crosswalk/observer-section-error-model-2026-06-23.md` required to close CPA-1.
...
- `explorations/geometry-curvature-emergence/ii-s-coordinate-formula-2026-06-23.md` (prior coordinate formula)
- `explorations/geometry-curvature-emergence/4d-reduction-section-pullback-2026-06-22.md` (B1, B3 at reconstruction)
- `explorations/anomaly-and-bordism/n1-signature-audit-y14-clifford-algebra-2026-06-22.md` (signature (9,5))
- `explorations/geometry-curvature-emergence/codazzi-sp64-bundle-2026-06-23.md` (Codazzi setup, K(A,s) formula)
- `explorations/geometry-curvature-emergence/codazzi-sp64-2026-06-23.md` (full Codazzi equation for Sp(64))
- `explorations/time-as-finality-crosswalk/observer-section-error-model-2026-06-23.md` (B1-B3 conditions)
- `explorations/geometry-curvature-emergence/cpa1-tobs-coefficient-2026-06-23.md` (C_GU = 8 derivation)
