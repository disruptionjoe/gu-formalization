...
**Prior state.** `explorations/geometry-curvature-emergence/pc2-gauss-y14-curvature-2026-06-23.md` established
...
1. **Component identity.** `[G^Y_T]^{TF}_{mu nu} = T^{YM,TF}_{mu nu} + T^{mix,TF}_{mu nu}`
   ...
   Christoffel symbols from `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md`.
...
From `explorations/geometry-curvature-emergence/rfail-umbilic-sections-2026-06-23.md` Section 5.2:
...
From `explorations/geometry-curvature-emergence/ic4-lagrangian-tmunu-derivation-2026-06-23.md` Section 6.4:
...
(from `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md` §3) are:
...
from `explorations/geometry-curvature-emergence/ic4-lagrangian-tmunu-derivation-2026-06-23.md` §3.
...
From `explorations/geometry-curvature-emergence/pc2-gauss-y14-curvature-2026-06-23.md` §8:
...
From `explorations/geometry-curvature-emergence/rfail-umbilic-sections-2026-06-23.md` §3.3 (verified exactly):
...
**This note builds on:**
- `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md` (gimmel Christoffels, MF formula)
- `explorations/geometry-curvature-emergence/ic4-lagrangian-tmunu-derivation-2026-06-23.md` (IC4 term-by-term match)
- `explorations/geometry-curvature-emergence/codazzi-sp64-2026-06-23.md` (Gauss equation, IC1 j_s)
- `explorations/geometry-curvature-emergence/rfail-umbilic-sections-2026-06-23.md` (named obstruction, failure conditions)
- `explorations/geometry-curvature-emergence/pc2-gauss-y14-curvature-2026-06-23.md` (prior consistency argument for C_{Gauss}=1 and [G^Y_T]^{TF})
- `explorations/geometry-curvature-emergence/ic2-positivity-soldering-normal-2026-06-23.md` (B_fund = 512h normalization)
- `explorations/geometry-curvature-emergence/codazzi-general-non-umbilic-2026-06-23.md` (Q^{TF}(B)=0 for umbilic)
- `explorations/geometry-curvature-emergence/cpa1-tobs-coefficient-2026-06-23.md` (Simons +4K correction, ambient curvature)
