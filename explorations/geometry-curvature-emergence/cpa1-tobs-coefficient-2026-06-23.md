...
- `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md`: moving-frame derivation, C_GU = 8 SO(5)
  Casimir argument (Section 9).
- `explorations/time-as-finality-crosswalk/observer-section-error-model-2026-06-23.md`: B1-B3 original formulation.
...
- `explorations/perspective-and-dialectic/4d-reduction-62-perspective-steelman-hegelian-2026-06-22.md` (P62): Tikhonov
