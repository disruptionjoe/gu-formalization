...
The CPA-1 cross-program contact established in `explorations/geometry-curvature-emergence/cpa1-tobs-coefficient-2026-06-23.md`
and `explorations/geometry-curvature-emergence/cpa1-omega-tuning-2026-06-23.md` has the form:
...
From `explorations/geometry-curvature-emergence/cpa1-omega-tuning-2026-06-23.md` Section 6.2:
...
From `explorations/geometry-curvature-emergence/codazzi-sp64-2026-06-23.md` and `explorations/geometry-curvature-emergence/ic1-soldering-map-ns-adps-2026-06-23.md`,
...
(from `explorations/geometry-curvature-emergence/codazzi-sp64-2026-06-23.md`), the curvature acts on an element X in j_s(N_s) as:
...
From `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md`, the gimmel Christoffel symbols in
...
The prior work (`explorations/geometry-curvature-emergence/cpa1-tobs-coefficient-2026-06-23.md`) uses a specific formula
...
From `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md`, this block IS the second fundamental form:
...
The tangential projection [G^Y_T]_{mu nu} from `explorations/geometry-curvature-emergence/pc2-gauss-y14-curvature-2026-06-23.md`
...
E[s] = integral |II_s^H|^2 and the Christoffel symbols from `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md`.
...
symbols from `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md`, showing the result equals the
...
**Builds on:**
- `explorations/geometry-curvature-emergence/cpa1-tobs-coefficient-2026-06-23.md` (C_GU = 8 derivation; rough Laplacian
  eigenvalue; null-ray model)
- `explorations/geometry-curvature-emergence/cpa1-omega-tuning-2026-06-23.md` (Omega-constant; delta_curv = +4K as single
  remaining gate; three-model comparison)
- `explorations/geometry-curvature-emergence/pc2-gauss-y14-curvature-2026-06-23.md` (V^{ij} R^{N_s}_{ij} identification;
  gimmel Riemann structure)
- `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md` (gimmel Christoffel symbols; SO(5) Casimir
  argument for C_GU = 8)
- `explorations/geometry-curvature-emergence/rfail-umbilic-sections-2026-06-23.md` (ambient curvature gate identification)

**Closes:**
- F7 from `explorations/geometry-curvature-emergence/cpa1-tobs-coefficient-2026-06-23.md` (ambient curvature verification)
- OQ1 from `explorations/geometry-curvature-emergence/cpa1-omega-tuning-2026-06-23.md` (explicit curvature of Met(S^4))
