...
- `explorations/pc1-spin77-spinor-decomp-2026-06-23.md` (CONDITIONALLY_RESOLVED): the
...
`explorations/vz-subprincipal-symbol-rs-2026-06-23.md` (OQ2-a RESOLVED):
...
And from `explorations/vz-oq2-lower-order-curvature-2026-06-23.md`:
...
The SC1 file (`explorations/sc1-shiab-domain-codomain-2026-06-23.md`, §5, OQ2) stated:
...
symbols from `explorations/ii-s-moving-frames-2026-06-23.md`, write out the
