...
**What this note does.** This is IC4 from `explorations/codazzi-general-non-umbilic-2026-06-23.md`
and `explorations/codazzi-sp64-2026-06-23.md`: derive T_{mu nu} from the GU action
...
- **IC1 (Soldering map):** `explorations/codazzi-sp64-2026-06-23.md` — the soldering map
...
- **IC3 (Conservation):** `explorations/codazzi-sp64-2026-06-23.md` §6.3 — the identity
...
convention (from `explorations/ii-s-moving-frames-2026-06-23.md`):
```
...
Section 3.3 of `explorations/codazzi-general-non-umbilic-2026-06-23.md`:
```
...
The Codazzi identification (from `explorations/codazzi-sp64-2026-06-23.md` Section 7.1)
states:
```
...
|---|---|---|
| IC1 (Soldering map j_s: N_s -> ad(P_s)) | CONDITIONALLY_RESOLVED | `explorations/codazzi-sp64-2026-06-23.md` §2; j_s = (1/4)[gamma^a, gamma^{(bc)}] n_{ab} |
| IC2 (Positivity: B_fund = 512 h > 0 on TT modes) | CONDITIONALLY_RESOLVED | `explorations/ic2-positivity-soldering-normal-2026-06-23.md`; 5 TT graviton modes positive |
| IC3 (Conservation: nabla^nu Q^{TF}_{mu nu} + K_nu = 0) | VERIFIED at linear order; OPEN nonlinear | `explorations/codazzi-sp64-2026-06-23.md` §6.3 |
...
IC2 opening question (OQ1 from `explorations/codazzi-sp64-2026-06-23.md`).
...
(the Christoffel symbols are explicit from `explorations/ii-s-moving-frames-2026-06-23.md`).
...
- `explorations/codazzi-general-non-umbilic-2026-06-23.md` (Q^{TF}(B) structure, IC1-IC4 formulation)
- `explorations/codazzi-sp64-2026-06-23.md` (full Codazzi equation, IC1 closure, IC3 linear verification)
- `explorations/ic1-soldering-map-ns-adps-2026-06-23.md` (j_s explicit construction)
- `explorations/ic2-positivity-soldering-normal-2026-06-23.md` (B_fund positivity)
- `explorations/ii-s-moving-frames-2026-06-23.md` (B = nabla^perp theta, Christoffel symbols)
- `explorations/dark-energy-noether-closure-2026-06-22.md` (D_A^* theta = 0 on-shell)
- `explorations/sc1-shiab-domain-codomain-2026-06-23.md` (Shiab domain/codomain confirmed)
- `explorations/anomaly-audit-cl95-gauge-group-2026-06-22.md` (Sp(64) as gauge group)
- `explorations/n1-signature-audit-y14-clifford-algebra-2026-06-22.md` (Cl(9,5) algebra)

**This note closes:**
- IC4 from `explorations/codazzi-general-non-umbilic-2026-06-23.md`: CONDITIONALLY_RESOLVED
- OQ3 from `explorations/codazzi-sp64-2026-06-23.md`: partially addressed (Lagrangian
