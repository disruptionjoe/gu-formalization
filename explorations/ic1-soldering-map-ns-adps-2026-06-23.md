...
**Problem.** Condition IC1 in `explorations/codazzi-general-non-umbilic-2026-06-23.md` states:
...
- Section s: X^4 -> Y^14 has normal bundle N_s ~= Sym^2 T*X^4, dimension 10
  (from `explorations/4d-reduction-section-pullback-2026-06-22.md`, reconstruction grade).
...
- `explorations/codazzi-general-non-umbilic-2026-06-23.md`: parent file, IC1-IC4 formulation
- `explorations/codazzi-sp64-bundle-2026-06-23.md`: K(A,s) and Q(B) formulas
- `explorations/ii-s-moving-frames-2026-06-23.md`: gimmel Christoffels and II_s^H = nabla^perp theta
- `explorations/4d-reduction-section-pullback-2026-06-22.md`: N_s ~= Sym^2 T*X^4
- `explorations/n1-signature-audit-y14-clifford-algebra-2026-06-22.md`: Cl(9,5) ~= M(64,H), S = H^64
- `explorations/anomaly-audit-cl95-gauge-group-2026-06-22.md`: Sp(64), sp(64), dim = 8256
- `explorations/generation-count-sm-branching-closure-2026-06-22.md`: spinor branching S = S(3,1) tensor S(6,4)
