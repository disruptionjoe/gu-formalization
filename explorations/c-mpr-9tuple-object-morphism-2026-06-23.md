...
- **Signed-readout boundary theorem** (`explorations/signed-readout-theorem-statement-2026-06-23.md`,
...
- **Re-attaching Cert/P_O.** If `P_O` (observer protocol) is to be real structure rather than
  ...
  `explorations/signed-readout-oq1-record-graph-2026-06-23.md` is the candidate index data).
