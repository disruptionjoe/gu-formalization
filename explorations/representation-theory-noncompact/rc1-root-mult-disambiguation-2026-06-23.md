...
supersedes: explorations/representation-theory-noncompact/rc1-root-multiplicity-check-2026-06-23.md (which was CONDITIONALLY_RESOLVED for the wrong pair)
---
...
- `explorations/representation-theory-noncompact/oq1-split-rank-verification-2026-06-23.md` (split-rank = 3, sigma_B computation: primary basis for this file)
- `explorations/representation-theory-noncompact/rc1-root-multiplicity-check-2026-06-23.md` (BC_1 model under sigma_A: superseded)
- `explorations/representation-theory-noncompact/rc1-discrete-series-verification-pack-2026-06-23.md` (FAILS_AS_STATED, involution conflict)
- `explorations/representation-theory-noncompact/tau-twisted-rs-admissibility-kobayashi-2026-06-23.md` (tau route FAILS)
