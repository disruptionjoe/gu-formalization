...
was established at reconstruction grade in `explorations/representation-theory-noncompact/n5-discrete-series-gl4r-2026-06-23.md`
...
- `explorations/representation-theory-noncompact/n5-discrete-series-gl4r-2026-06-23.md` (Sections 2-6, 15-19) -- split-rank = 1
...
- `explorations/generation-sector/oq3a-gu-variational-k3-selection-2026-06-23.md` -- K3-type X^4 (Â=2, sigma=-16)
  selected by GU Willmore variational principle; ind_H(D_GU) = 8*2 + 8 = 24 from the 2+1 split.
- `explorations/generation-sector/generation-count-sm-branching-closure-2026-06-22.md` -- S(6,4) = C^16 Pati-Salam
...
The topological factor from X^4 is established in `explorations/representation-theory-noncompact/n5-discrete-series-gl4r-2026-06-23.md`
(Sections 10-13) and `explorations/generation-sector/oq3a-gu-variational-k3-selection-2026-06-23.md`:
...
`explorations/representation-theory-noncompact/n5-discrete-series-gl4r-2026-06-23.md`. The §6.3 note in that file ("the Weyl
