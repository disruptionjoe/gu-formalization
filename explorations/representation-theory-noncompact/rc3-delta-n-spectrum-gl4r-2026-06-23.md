...
- `explorations/vz-evasion/vz-f6-eft-decoupling-2026-06-23.md` (F6 analysis; RC3 opened here)
- `explorations/representation-theory-noncompact/n5-discrete-series-gl4r-2026-06-23.md` §19 (split-rank = 1 VERIFIED)
- `explorations/geometry-curvature-emergence/codazzi-sp64-2026-06-23.md` (normal Laplacian and Codazzi correction)
- `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md` (fiber metric V; R_s = t_obs identification)
- `explorations/geometry-curvature-emergence/cpa1-tobs-coefficient-2026-06-23.md` (M_KK alignment with Lambda_GU)
- `explorations/geometry-curvature-emergence/hc1-codazzi-correction-2026-06-23.md` (Weyl correction on K3; delta_k_1 subleading)
