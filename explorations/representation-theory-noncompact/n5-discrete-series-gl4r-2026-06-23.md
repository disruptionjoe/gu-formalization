...
`explorations/analytic-index-fredholm/discrete-series-fiber-dirac-index-2026-06-23.md`. The correct
...
- `explorations/generation-sector/generation-count-sm-branching-closure-2026-06-22.md` — Pati-Salam
  branching verified; representation-theory conditions CLOSED.
- `explorations/analytic-index-fredholm/n5-ind-h-analytic-conditions-2026-06-22.md` — fiber homotopy type
  RP^3 established; Bismut families index not applicable to noncompact fibers;
  discrete-series condition sharply formulated.
- `explorations/analytic-index-fredholm/discrete-series-fiber-dirac-index-2026-06-23.md` — ordinary finite
...
- Harish-Chandra, "Discrete series for semisimple Lie groups I", Acta Mathematica 113
  (1965), 241-318.
- Prior context: `explorations/generation-sector/generation-count-sm-branching-closure-2026-06-22.md`,
...
prior `explorations/analytic-index-fredholm/ind-top-x4-atiyah-singer-2026-06-23.md` established three resolution
...
From `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md`, the curvature of S(6,4) over
X^4 is:
...
From the Codazzi data (established in `explorations/geometry-curvature-emergence/codazzi-general-non-umbilic-2026-06-23.md`):
...
From the VZ evasion computation (EVADED, reconstruction, `explorations/vz-evasion/vz-schur-complement-2026-06-23.md`
and `explorations/vz-evasion/vz-oq1-sr-squared-identity-2026-06-23.md`), the key structural fact is:
...
- OQ3a (GU variational principle selects K3-type): addressed at reconstruction grade
  in `explorations/generation-sector/oq3a-gu-variational-k3-selection-2026-06-23.md`.
