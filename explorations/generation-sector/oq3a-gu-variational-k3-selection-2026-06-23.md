...
**What is being computed.** OQ3a from `explorations/representation-theory-noncompact/n5-discrete-series-gl4r-2026-06-23.md` §10:
...
- `explorations/representation-theory-noncompact/n5-discrete-series-gl4r-2026-06-23.md` §10 — restructured generation
  count, 2+1 split, K3-type identified as the candidate
- `explorations/analytic-index-fredholm/ind-top-x4-atiyah-singer-2026-06-23.md` — Â(X^4) = 3 for flat S(6,4)
  is Rokhlin-blocked; Lorentzian APS bypass; three paths to RESOLVED identified
- `explorations/analytic-index-fredholm/ind-top-eta-s3-aps-2026-06-23.md` — flat APS eta=0 on S^3; APS route
  to ind_top=3 ruled out for flat background; directs to discrete-series route
- `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md` — II_s^H explicit in moving frames;
...
- `explorations/geometry-curvature-emergence/codazzi-sp64-2026-06-23.md` — full Codazzi equation derived; IC1
...
From `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md`, the horizontal-normalized second
fundamental form is:
...
From `explorations/geometry-curvature-emergence/cpa1-tobs-coefficient-2026-06-23.md` and
`explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md`, the Tikhonov-regularized section
problem is:
...
2. For `theta = 0`, the second Codazzi equation (from `explorations/geometry-curvature-emergence/codazzi-sp64-2026-06-23.md`)
...
- **Rokhlin eliminates Â = 3**: The APS eta = 0 computation in
  `explorations/analytic-index-fredholm/ind-top-eta-s3-aps-2026-06-23.md` confirmed that the flat APS route
...
computation from `explorations/geometry-curvature-emergence/codazzi-sp64-2026-06-23.md` does not yet determine this
value.
...
data in `explorations/geometry-curvature-emergence/codazzi-sp64-2026-06-23.md`. If this is zero (flat-bundle
...
- Prior explorations:
  - `explorations/representation-theory-noncompact/n5-discrete-series-gl4r-2026-06-23.md` (2+1 split, OQ3a-c formulated)
  - `explorations/analytic-index-fredholm/ind-top-x4-atiyah-singer-2026-06-23.md` (three paths to ind_top=3)
  - `explorations/analytic-index-fredholm/ind-top-eta-s3-aps-2026-06-23.md` (APS eta=0 flat, Â=3 route ruled out)
  - `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md` (II_s explicit, C_GU=8)
