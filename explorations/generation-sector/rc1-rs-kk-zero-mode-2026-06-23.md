...
- `explorations/vz-evasion/vz-f6-eft-decoupling-2026-06-23.md` (F6 EFT decoupling; RC1 cited as gate)
- `explorations/representation-theory-noncompact/n5-discrete-series-gl4r-2026-06-23.md` §§12-19 (AF1-AF4; ind_H = 8 for RS; split-rank = 1 VERIFIED)
- `explorations/vz-evasion/af4-tau-rs-gauge-fixing-2026-06-23.md` (gauge-fixed RS H-types; ind_H = 8; GF1-GF5 failure conditions)
- `explorations/representation-theory-noncompact/oq-weyl3-limit-discrete-series-2026-06-23.md` (OQ-LD-1 through OQ-LD-4; compact root wall resolution)
- `explorations/representation-theory-noncompact/rc3-delta-n-spectrum-gl4r-2026-06-23.md` (Delta_N spectrum; BC_1 poles at nu_n = (2n+1)/2)
- `explorations/representation-theory-noncompact/rc3-harish-chandra-c-function-2026-06-23.md` (c(lambda) explicit; (m_1,m_2)=(7,1); rho=9/2)
- `explorations/representation-theory-noncompact/rc3-root-multiplicity-bc1-2026-06-23.md` (m_1=7, m_2=1 CONDITIONALLY_RESOLVED)
- `explorations/representation-theory-noncompact/rc3-oq3-lorentzian-casimir-2026-06-23.md` (Delta_C = +3/R_s^2 sign positive)
