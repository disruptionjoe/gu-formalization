...
depends_on:
  - explorations/representation-theory-noncompact/n5-discrete-series-gl4r-2026-06-23.md  # OQ3b (RS index=8), OQ3c sketch (§13, §16)
  - explorations/representation-theory-noncompact/n5-plancherel-multiplicity-2026-06-23.md  # Weyl-orbit + fiber count m_H^fiber=8
  - explorations/generation-sector/rc1-rs-kk-zero-mode-2026-06-23.md  # ind_H(S_R^eff)=8 via three convergent paths
  - explorations/generation-sector/oq3a-gu-variational-k3-selection-2026-06-23.md  # spin-1/2 sector Â(K3)=2
  - explorations/vz-evasion/vz-schur-complement-2026-06-23.md  # VZ evasion; block structure of D_GU
  - explorations/vz-evasion/vz-oq1-sr-squared-identity-2026-06-23.md  # A S_R = xi^2 Id_R exact; RS not sub-module
---
...
From `explorations/vz-evasion/vz-schur-complement-2026-06-23.md` (§8) and the VZ evasion chain
...
From `explorations/representation-theory-noncompact/n5-discrete-series-gl4r-2026-06-23.md` §12-16 and
`explorations/vz-evasion/vz-schur-complement-2026-06-23.md` §8, the **effective RS operator** is
...
(or the KSp-theory framework: see `explorations/signed-calm-jordan/signed-readout-oq2a-k-theory-lift-2026-06-23.md`).
...
Prior context files:
- `explorations/representation-theory-noncompact/n5-discrete-series-gl4r-2026-06-23.md` §12-19 (OQ3b, OQ3c sketches,
  Casimir correction, AF2 exact, split-rank = 1 explicit bracket computation)
- `explorations/representation-theory-noncompact/n5-plancherel-multiplicity-2026-06-23.md` §5-8 (Weyl orbit, fiber count)
- `explorations/generation-sector/rc1-rs-kk-zero-mode-2026-06-23.md` (ind_H(S_R^{eff})=8, three paths)
- `explorations/generation-sector/oq3a-gu-variational-k3-selection-2026-06-23.md` (ind_H(D_{spin-1/2})=16)
- `explorations/vz-evasion/vz-schur-complement-2026-06-23.md` §8, §17-18 (D_GU block structure,
  section pullback, Clifford identity verified exact)
- `explorations/vz-evasion/vz-oq1-sr-squared-identity-2026-06-23.md` (A S_R = xi^2 Id_R exact;
  B E^{-2} C != 0 explicitly; RS not sub-Clifford-module)
- `explorations/signed-calm-jordan/signed-readout-oq2a-k-theory-lift-2026-06-23.md` (KSp framework for
  H-linear index)
