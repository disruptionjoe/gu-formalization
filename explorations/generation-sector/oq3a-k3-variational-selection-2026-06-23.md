...
is the induced metric. From `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md`, in the
...
split formula (from the discrete-series computation, `explorations/representation-theory-noncompact/n5-discrete-series-gl4r-2026-06-23.md` §10).
...
`explorations/geometry-curvature-emergence/codazzi-sp64-2026-06-23.md`, IC3 at linear order).
...
- **8**: RS sector contribution, from Atiyah-Schmid formal-degree sum (OQ3b result,
  `explorations/representation-theory-noncompact/n5-discrete-series-gl4r-2026-06-23.md` §12-16)
...
`explorations/representation-theory-noncompact/n5-discrete-series-gl4r-2026-06-23.md` §10) addresses this but remains at
...
in `explorations/geometry-curvature-emergence/codazzi-sp64-2026-06-23.md`. If zero, the flat-bundle approximation is
...
**OQ3b/OQ3c.** See the parallel computations referenced in `explorations/representation-theory-noncompact/n5-discrete-series-gl4r-2026-06-23.md`.
...
- Prior explorations:
  - `explorations/generation-sector/oq3a-gu-variational-k3-selection-2026-06-23.md` (prior OQ3a computation)
  - `explorations/representation-theory-noncompact/n5-discrete-series-gl4r-2026-06-23.md` §10-19 (2+1 split, OQ3a-c)
  - `explorations/ii-s-horizontal-convention-hessian-2026-06-23.md` (Hessian, C_GU)
  - `explorations/geometry-curvature-emergence/codazzi-sp64-2026-06-23.md` (Codazzi, IC3)
  - `explorations/generation-sector/rc1-rs-kk-zero-mode-2026-06-23.md` (RS KK zero modes, ind_H = 8)
  - `explorations/representation-theory-noncompact/weyl-group-s4-orbit-2026-06-23.md` (Weyl orbit, m_H = 24)
