...
depends_on:
  - explorations/representation-theory-noncompact/oq3b-tau-correction-closure-2026-06-23.md
...
supersedes:
  - explorations/generation-sector/rc1-rs-kk-zero-mode-2026-06-23.md (scalar BC1 chain)
  - explorations/representation-theory-noncompact/rc3-harish-chandra-c-function-2026-06-23.md (scalar BC1 chain)
---
...
- `explorations/representation-theory-noncompact/oq3b-tau-correction-closure-2026-06-23.md` -- prior closure attempt; three
  gates all fail; tau-correction route retired.
- `explorations/generation-sector/oq3b-rs-index-closed-2026-06-23.md` -- three OQ1-independent paths after
...
- `explorations/representation-theory-noncompact/oq1-split-rank-verification-2026-06-23.md` -- RESOLVED: split-rank = 3 under sigma_B.
- `explorations/generation-sector/rs-analytic-rank3-rebuild-or-demotion-2026-06-23.md` -- non-compact routes
  R1/R2/R3 all fail; APS route (R4) survives.
- `explorations/analytic-index-fredholm/oc1-oc2-aps-closure-2026-06-23.md` -- APS route providing Path 3.
- `explorations/generation-sector/oq-rk1-rs-rank-first-principles-2026-06-23.md` -- rank_H(S_RS^+) = 4,
