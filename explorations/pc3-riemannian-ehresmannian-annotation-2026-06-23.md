...
- `explorations/pc2-met-x4-bundle-formalization-stub-2026-06-22.md` and
  `explorations/pc2-gauss-y14-curvature-2026-06-23.md` (PC2: Met(X^4) bundle formalization;
...
- `explorations/n5-discrete-series-gl4r-2026-06-23.md` (discrete-series Plancherel multiplicity)
- `explorations/pc2-met-x4-bundle-formalization-stub-2026-06-22.md` (Met(X^4) bundle)
- `explorations/pc2-gauss-y14-curvature-2026-06-23.md` (PC2 Gauss equation / Y^14 curvature)
- `explorations/hc1-sl2c-bianchi-spinor-2026-06-23.md` (hidden curvature SL(2,C) labels)
- `explorations/hc1-coupling-coefficients-2026-06-23.md` (HC coupling coefficients)
