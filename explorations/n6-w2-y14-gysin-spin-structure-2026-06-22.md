...
(a) **The analytic index** ind_ℍ(D_ℊ) from topology, required for the generation count
    to equal 3 (N5 condition (i), still open in `explorations/generation-count-sm-branching-closure-2026-06-22.md`).
...
`explorations/pc2-met-x4-bundle-formalization-stub-2026-06-22.md` (§6.1). Primary
