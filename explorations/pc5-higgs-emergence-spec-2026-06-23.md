...
- explorations/pc1-spin77-spinor-decomp-2026-06-23.md (spinor S as coefficient bundle)
- explorations/pc2-met-x4-bundle-formalization-stub-2026-06-22.md (section pullback)
- explorations/4d-reduction-section-pullback-2026-06-22.md (s*(theta) = II_s)
- explorations/ii-s-moving-frames-2026-06-23.md (explicit Christoffels, II_s^H)
- explorations/ic1-soldering-map-ns-adps-2026-06-23.md (j_s: N_s -> ad(P_s))
- explorations/hc1-sl2c-bianchi-spinor-2026-06-23.md (theta irreducible decomposition)
- explorations/pc4-torsion-lambda-derivation-2026-06-23.md (||theta||^2 as Lambda replacement)
- explorations/generation-count-sm-branching-closure-2026-06-22.md (S(6,4) SM content)
- explorations/ic2-positivity-soldering-normal-2026-06-23.md (Sp(64) inner product on j_s image)
