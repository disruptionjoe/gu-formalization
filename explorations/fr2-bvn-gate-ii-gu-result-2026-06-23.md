...
- **BvN Layer-5 gate (i):** The inclusion I: CAlg -> OMLat has no left adjoint natural
  ...
  `explorations/fr2-bvn-layer5-promotion-gate-2026-06-23.md`
...
- **GU Tikhonov section selection:** Lambda ~ epsilon^2/t_obs^2 from Tikhonov regularization
  ...
  `explorations/cpa1-tobs-coefficient-2026-06-23.md` and `explorations/ii-s-moving-frames-2026-06-23.md`
...
- BvN gate (i) (Layer-5 formal denial): `explorations/fr2-bvn-layer5-promotion-gate-2026-06-23.md`
- Observer-section bridge model: `explorations/observer-section-error-model-2026-06-23.md`
- Tikhonov coefficient (C_GU = 8, Lambda derivation): `explorations/cpa1-tobs-coefficient-2026-06-23.md`
- II_s moving frames (Tikhonov/Willmore computation): `explorations/ii-s-moving-frames-2026-06-23.md`
- Anomaly cancellation input (Sp(64) pseudoreality): `explorations/anomaly-audit-cl95-gauge-group-2026-06-22.md`
