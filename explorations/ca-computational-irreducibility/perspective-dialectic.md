---
title: "WRK-395 — 5-Perspective Dialectic on CA-Class Substrate Exploration"
status: exploration
doc_type: synthesis
updated_at: "2026-05-31"
---

# WRK-395 — 5-Perspective Dialectic on CA-Class Substrate Exploration

**Status.** Local-only artifact. WRK-395 implementation/1.
**Generated.** 2026-05-31.
**Perspectives (from card body §5).** Wolfram CA mathematician (thesis); Lattice QFT theorist (thesis); Complexity science / adaptive systems expert (antithesis); Skeptical mathematical physicist (antithesis); Honest-verdict gatekeeper (synthesis).
...
The CA-class recoding works *in principle* and *in practice* on the GW axial-charge case, exactly as the Wolfram lens predicted in §6 of the six-perspective dialectic. The rr-axis classifies actual CA observables — Class-4 (Rule 110) ↔ comp-irred, reversible-CA-with-signed-flux ↔ signed-BV, simple-CA-with-monotone-aggregate ↔ mono-red.
...
## 6. Synthesis across perspectives
...
## 7. What none of the perspectives covered
