...
- `explorations/vz-schur-complement-2026-06-23.md` (VZ evasion 14D+4D; OQ3-V1/V2/V3)
- `explorations/vz-f5-curvature-check-2026-06-23.md` (zero-order curvature at 4D)
- `explorations/vz-oq2-lower-order-curvature-2026-06-23.md` (curvature zero-order at 14D)
- `explorations/vz-subprincipal-symbol-rs-2026-06-23.md` (subprincipal analysis)
