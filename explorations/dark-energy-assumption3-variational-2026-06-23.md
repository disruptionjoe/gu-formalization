...
- `explorations/dark-energy-c1-c2-path-gimmel-ginvariance-2026-06-23.md`: identifies the specific blocking point — identifying theta with D_A* F_A is Assumption 3 restated.
...
- `explorations/dark-energy-c1-c2-path-gimmel-ginvariance-2026-06-23.md` — C1 established, C2 fails independently; blocking failure condition identified.
- `explorations/dark-energy-divergence-free-proof-2026-06-22.md` — equivariance of theta (V1), C1/C2 conditions identified.
- `explorations/dark-energy-noether-closure-2026-06-22.md` — C3 path (Noether's second theorem for full S_GU).
