...
- `explorations/oq3b-rs-index-closed-2026-06-23.md` — OQ3b post-OQ1 status; three paths; tau-correction gate
- `explorations/rc1-rs-kk-zero-mode-2026-06-23.md` — Tau-shift argument Lambda_RS^{FJ} = 3/2 (superseded)
- `explorations/rc1-root-mult-disambiguation-2026-06-23.md` — RESOLVED: A3 root system, not BC1
- `explorations/rs-analytic-rank3-rebuild-or-demotion-2026-06-23.md` — R1/R2/R3 demoted; APS (R4) survives
- `explorations/oc1-oc2-aps-closure-2026-06-23.md` — APS route for ind_H = 24
