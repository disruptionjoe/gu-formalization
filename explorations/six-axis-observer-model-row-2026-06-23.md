...
The parent computation (`explorations/signed-readout-oq1-record-graph-2026-06-23.md`)
...
- `explorations/signed-readout-oq1-record-graph-2026-06-23.md` -- the RESOLVED
  record-graph computation. All definitions in this file derive from Sections 3-9
  of that document.
- `explorations/signed-readout-monotonicity-pn-jordan-2026-06-23.md` -- the iff
...
- `explorations/six-axis-l1l2-coupling-filled-example-2026-06-23.md` -- the prior
...
(`explorations/signed-readout-monotonicity-pn-jordan-2026-06-23.md`); record-graph
construction (`explorations/signed-readout-oq1-record-graph-2026-06-23.md`, Sec. 3-5).
...
`explorations/signed-readout-oq2d-gu-contact-2026-06-23.md`): 24 nodes in a bipartite
...
(`explorations/signed-readout-monotonicity-pn-jordan-2026-06-23.md`); GU record-graph
construction (`explorations/signed-readout-oq2d-gu-contact-2026-06-23.md`); specific-object
...
and `explorations/fr4-cadence-delta-second-example-2026-06-23.md`), the finality predicate
...
CALM-cadence second example `explorations/fr4-cadence-delta-second-example-2026-06-23.md`.
...
reconstruction grade in `explorations/n5-discrete-series-gl4r-2026-06-23.md`, §12-19,
and confirmed in `explorations/signed-readout-oq2d-gu-contact-2026-06-23.md`).
...
multiplicity-one, `explorations/n5-discrete-series-gl4r-2026-06-23.md` §18, AF3). The
...
3. Assign integer weights: lambda(r_i) = +1 if the instanton contributes n_+ to the
   ...
   assignment from `explorations/signed-readout-monotonicity-pn-jordan-2026-06-23.md`,
...
- RC2: The chirality bridge claim (m_H(S(6,4)) = 24 lifted to G_R^{GU}) requires the
  ...
  These are named open conditions in `explorations/n5-discrete-series-gl4r-2026-06-23.md`.
