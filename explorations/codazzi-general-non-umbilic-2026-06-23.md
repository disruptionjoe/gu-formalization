...
From `explorations/codazzi-sp64-bundle-2026-06-23.md`:
...
Christoffel symbols derived in `explorations/ii-s-moving-frames-2026-06-23.md`.
...
- `explorations/codazzi-sp64-bundle-2026-06-23.md`: provides K(A,s) and Q(B) formulas
- `explorations/ii-s-moving-frames-2026-06-23.md`: provides II_s^H = nabla^perp theta
...
- `explorations/hc1-hidden-curvature-components-2026-06-22.md`: the three hidden
