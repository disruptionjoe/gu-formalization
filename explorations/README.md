...
- [`rb4-observer-cartan-moving-family-2026-07-30.md`](rb4-observer-cartan-moving-family-2026-07-30.md)
  ...
  \(\chi\) is not P2, and \(\epsilon_{\rm IG}\)-ownership, flag
  Euler/Hessian selection, physical compactification, retained mode, SM
  placement, VEV, mass, cosmology, index, and count remain open.
