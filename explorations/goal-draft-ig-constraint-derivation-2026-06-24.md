...
owned_path: "explorations/goal-draft-ig-constraint-derivation-2026-06-24.md"
depends_on:
...
- `explorations/ig-dynamics-nonzero-theta-action-gate-2026-06-24.md` for the free-beta
  obstruction and the Branch 1/2/3 split.
- `explorations/gu-closed-loop-action-ig-branch-2026-06-24.md` for the current branch matrix,
  exact GR gate, FLRW `xi_eff` gate, and Branch 2A recommendation.
- `explorations/gu-minimal-action-spec-2026-06-24.md` for the action inventory, EL tuple,
  sign conventions, normalization, and failure conditions.
- `explorations/gu-typed-operator-action-spine-2026-06-24.md` for the typed carrier,
...
- `explorations/live-claim-dag-fault-finality-ledger-2026-06-24.md` for the live statuses:
