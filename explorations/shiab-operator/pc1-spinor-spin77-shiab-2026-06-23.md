...
- `explorations/shiab-operator/pc1-spin77-spinor-decomp-2026-06-23.md` — S does not embed in Lambda^bullet;
  Cl(7,7) real-type branching infrastructure.
- `explorations/shiab-operator/sc1-oq1-shiab-uniqueness-2026-06-23.md` — (9,5) Hom space = H oplus H; parity
  collapse to diagonal; the contrast case for this file.
- `explorations/shiab-operator/sc1-shiab-domain-codomain-2026-06-23.md` — equivariance, H-linearity, naturalness
  of Phi in (9,5).
...
- `explorations/anomaly-and-bordism/n1-signature-audit-y14-clifford-algebra-2026-06-22.md` — (9,5) is the correct
  signature (Frobenius + trace-reversal).
- `explorations/misc/positive-gu-constructions-lane-proposal-2026-06-22.md` — Target 4 spec and
  falsification test.
