...
- **Primary:** `explorations/representation-theory-noncompact/rc1-root-mult-disambiguation-2026-06-23.md`
...
- **Secondary:** `explorations/generation-sector/generation-count-rank3-resolution-2026-06-23.md`
...
Supporting audit: `explorations/representation-theory-noncompact/split-rank-reconciliation-audit-2026-06-23.md`
...
`explorations/representation-theory-noncompact/rc1-root-mult-disambiguation-2026-06-23.md` §§1–4 for the explicit
...
See `explorations/representation-theory-noncompact/rc1-root-mult-disambiguation-2026-06-23.md` §2.2 for the comparison
table and `explorations/generation-sector/generation-count-rank3-resolution-2026-06-23.md` Part A for the
...
See `explorations/representation-theory-noncompact/rc1-root-mult-disambiguation-2026-06-23.md` §5.2 and
`explorations/representation-theory-noncompact/split-rank-reconciliation-audit-2026-06-23.md` replacement language R1.
...
See `explorations/representation-theory-noncompact/rc1-root-mult-disambiguation-2026-06-23.md` §2.1 for why the BC_1
...
See `explorations/generation-sector/generation-count-rank3-resolution-2026-06-23.md` Part C and
`explorations/representation-theory-noncompact/rc1-root-mult-disambiguation-2026-06-23.md` §5.3.
...
See `explorations/representation-theory-noncompact/rc1-root-mult-disambiguation-2026-06-23.md` §1 for the sigma_A vs.
sigma_B distinction and `explorations/generation-sector/generation-count-rank3-resolution-2026-06-23.md`
...
See `explorations/generation-sector/generation-count-rank3-resolution-2026-06-23.md` §§A–B for the
...
the OQ1 resolution chain. See `explorations/representation-theory-noncompact/oq1-split-rank-verification-2026-06-23.md`
...
`explorations/representation-theory-noncompact/tau-twisted-rs-admissibility-kobayashi-2026-06-23.md`.
Readers should note that the tau-correction route marked "surviving" in this file is
now also superseded.
See `explorations/generation-sector/generation-count-rank3-resolution-2026-06-23.md` Part B for all four
...
See `explorations/generation-sector/generation-count-rank3-resolution-2026-06-23.md` Parts A–B for
...
superseded by `explorations/representation-theory-noncompact/tau-twisted-rs-admissibility-kobayashi-2026-06-23.md`.
See `explorations/generation-sector/generation-count-rank3-resolution-2026-06-23.md` Part B.
...
See `explorations/representation-theory-noncompact/rc1-root-mult-disambiguation-2026-06-23.md` §5 for the A_3 replacement.

---

**File:** `explorations/representation-theory-noncompact/n5-parthasarathy-casimir-sl4r-2026-06-23.md`
...
See `explorations/representation-theory-noncompact/rc1-root-mult-disambiguation-2026-06-23.md` §5.2.

---

**File:** `explorations/vz-evasion/af4-tau-rs-gauge-fixing-2026-06-23.md`
...
See `explorations/generation-sector/generation-count-rank3-resolution-2026-06-23.md` §C2 for the APS
...
See `explorations/representation-theory-noncompact/split-rank-reconciliation-audit-2026-06-23.md` replacement R1 for
precise language about RC3 data.

---

**File:** `explorations/representation-theory-noncompact/oq-weyl3-limit-discrete-series-2026-06-23.md`
...
in `explorations/generation-sector/generation-count-rank3-resolution-2026-06-23.md` Part B.
...
`explorations/representation-theory-noncompact/split-rank-reconciliation-audit-2026-06-23.md` NEXT-STEPS §51).
...
See `explorations/generation-sector/generation-count-rank3-resolution-2026-06-23.md` for the current state.
...
the Casimir correction are robust. See `explorations/representation-theory-noncompact/split-rank-reconciliation-audit-2026-06-23.md` R1.
...
**File:** `explorations/signed-calm-jordan/signed-readout-oq2d-gu-contact-2026-06-23.md` and
...
1. `explorations/representation-theory-noncompact/rc1-root-mult-disambiguation-2026-06-23.md` (RESOLVED: A_3, not BC_1)
2. `explorations/generation-sector/generation-count-rank3-resolution-2026-06-23.md` (CONDITIONALLY_RESOLVED: APS/K3 route)
3. `explorations/representation-theory-noncompact/split-rank-reconciliation-audit-2026-06-23.md` (replacement language)
