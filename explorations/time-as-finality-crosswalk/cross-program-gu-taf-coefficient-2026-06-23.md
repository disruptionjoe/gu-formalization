...
depends_on:
  - "explorations/dark-energy-cosmology/cross-program-lambda-coefficient-2026-06-23.md"
...
- `explorations/geometry-curvature-emergence/cpa1-tobs-coefficient-2026-06-23.md`: C_GU = 8 algebraic derivation,
  B1-B3 original formulation, null-ray shot-noise model, algebraic identity.
- `explorations/dark-energy-cosmology/cross-program-lambda-coefficient-2026-06-23.md`: units correction,
  Lambda_GU vs lambda_max^2 vs Gamma_min^2, failure conditions.
- `explorations/time-as-finality-crosswalk/observer-section-error-model-2026-06-23.md`: bridge model
  epsilon_sec^2 ~ epsilon_dec; B1-B3 not-established verdict.
- `explorations/dark-energy-cosmology/theta-field-flrw-eos-2026-06-23.md`: M_KK = 2*sqrt(2)/R_s = 2*sqrt(2)*H_0;
