...
`explorations/time-as-finality-crosswalk/freed-hopkins-nonforgettable-observer-2026-06-23.md` §6-8). The lane
...
- `explorations/time-as-finality-crosswalk/freed-hopkins-nonforgettable-observer-2026-06-23.md`: structural no-go
...
- `explorations/time-as-finality-crosswalk/freed-hopkins-observer-pairing-enriched-bordism-toy-2026-06-23.md`:
  ...
  relabeling.
- `explorations/signed-calm-jordan/signed-readout-oq2a-k-theory-lift-2026-06-23.md`: the index-bundle
...
`explorations/signed-calm-jordan/signed-readout-oq2a-k-theory-lift-2026-06-23.md`) states that
...
space) in `explorations/time-as-finality-crosswalk/freed-hopkins-nonforgettable-observer-2026-06-23.md` §12.
