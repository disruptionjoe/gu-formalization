...
- `explorations/dark-energy-cosmology/cross-program-lambda-coefficient-2026-06-23.md` (GU/TaF comparison)
- `explorations/time-as-finality-crosswalk/fr2-bvn-rate-of-classicality-derivation-2026-06-22.md`
  (Gamma_min derivation)
- `explorations/perspective-and-dialectic/4d-reduction-62-perspective-steelman-hegelian-2026-06-22.md` (P62 Tikhonov proposal)
