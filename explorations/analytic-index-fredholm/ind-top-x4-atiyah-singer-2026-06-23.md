...
decomposition from `explorations/representation-theory-noncompact/n5-discrete-series-gl4r-2026-06-23.md` gives:
...
- `explorations/representation-theory-noncompact/n5-discrete-series-gl4r-2026-06-23.md` — Flensted-Jensen equal-rank
...
- `explorations/analytic-index-fredholm/n5-ind-h-analytic-conditions-2026-06-22.md` — fiber homotopy type
  ...
  topology.
- `explorations/generation-sector/generation-count-sm-branching-closure-2026-06-22.md` — ind_H(D_GU)
  counts H-lines; 8 H-lines per SM generation; 3 generations = 24 H-lines total.
- `explorations/anomaly-and-bordism/n6-w2-y14-gysin-spin-structure-2026-06-22.md` — Y^14 is spin for
...
(established context; `explorations/generation-sector/generation-count-sm-branching-closure-2026-06-22.md`).
...
From the moving-frames computation in `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md`,
...
The discrete-series computation in `explorations/representation-theory-noncompact/n5-discrete-series-gl4r-2026-06-23.md`
...
II_s formula in `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md`. If the Codazzi
...
- Prior context: `explorations/representation-theory-noncompact/n5-discrete-series-gl4r-2026-06-23.md`,
