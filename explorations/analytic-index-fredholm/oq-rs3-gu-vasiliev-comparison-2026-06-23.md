...
`explorations/perspective-and-dialectic/vz1-62-perspective-steelman-hegelian-2026-06-22.md` and named as a remaining
open item in `explorations/vz-evasion/vz-14d-mixed-covectors-2026-06-23.md` (OQ-RS-3).
...
**VZ evasion (EVADED at principal-symbol level):** `explorations/vz-evasion/vz-14d-mixed-covectors-2026-06-23.md`
and `explorations/vz-evasion/vz-e-block-direct-clifford-2026-06-23.md`. The effective RS principal
...
**RS sector definition:** `explorations/vz-evasion/vz-schur-complement-2026-06-23.md`. The RS sector
...
**Generation count (CONDITIONALLY_RESOLVED):** `explorations/generation-sector/oq3b-rs-index-closed-2026-06-23.md`.
