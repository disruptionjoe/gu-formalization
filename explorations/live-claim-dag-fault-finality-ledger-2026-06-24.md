...
- Owner file: `explorations/generation-count-rs-clifford-projector-computation-2026-06-24.md`.
...
- Owner file: `explorations/generation-count-rs-symbol-index-contract-2026-06-24.md`.
...
- Owner file: `explorations/generation-count-rs-rank-gate-2026-06-24.md`, with top-level posture in `RESEARCH-STATUS.md` and `CANON.md`.
- Current status: `open`.
...
- Owner file: `explorations/vz-principal-symbol-convention-reconciliation-2026-06-24.md`.
- Current status: `specified_open`.
...
- Owner file: `explorations/vz-proof-grade-verification-gate-2026-06-24.md`, `explorations/vz-e-block-independent-rederivation-2026-06-24.md`, and `explorations/no-go-velo-zwanziger-canon-entry-2026-06-23.md`.
...
- Owner file: `canon/no-go-class-relative-map.md`, `explorations/no-go-velo-zwanziger-canon-entry-2026-06-23.md`, and `explorations/vz-proof-grade-verification-gate-2026-06-24.md`.
- Current status: `conditional`.
- Proof grade: `conditional_reconstruction`.
...
- Owner file: `explorations/type-ii1-construction-or-nogo-gate-2026-06-24.md`, `canon/type-ii1-spectral-sm-checklist.md`, and `specifications/type-ii1-spectral-sm/type-ii1-extension-requirements.md`.
- Current status: `conditional`.
...
- Owner file: `explorations/type-ii1-selector-candidate-2026-06-24.md` and `explorations/type-ii1-selector-anti-smuggling-theorem-2026-06-24.md`.
...
- Owner file: `explorations/ig-dynamics-nonzero-theta-action-gate-2026-06-24.md`.
...
- Owner file: `explorations/gu-action-4d-physics-gate-2026-06-24.md` and `explorations/gu-minimal-action-spec-2026-06-24.md`.
- Current status: `open`.
- Proof grade: `specification`.
- Finality posture: `not_final`.
...
- Owner file: `explorations/gu-action-4d-physics-gate-2026-06-24.md`, `explorations/gu-minimal-action-spec-2026-06-24.md`, `canon/theta-field-flrw-dark-energy-eos.md`, and `explorations/dark-energy-w-window-mechanism-2026-06-23.md`.
- Current status: `open`.
- Proof grade: `conditional_reconstruction`.
...
- Owner file: `explorations/observer-finality-physical-forcing-gate-2026-06-24.md`, `explorations/time-as-finality-crosswalk/observer-finality-layer.md`, and `explorations/h3-chsh-four-patch-fixture-2026-06-23.md`.
- Current status: `conditional`.
...
- Owner file: `explorations/observer-finality-pati-salam-chsh-fixture-2026-06-24.md`, `explorations/observer-finality-gu-derived-chsh-state-attempt-2026-06-24.md`, and `explorations/observer-finality-physical-forcing-gate-2026-06-24.md`.
