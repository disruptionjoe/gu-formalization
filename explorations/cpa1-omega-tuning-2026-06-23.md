...
The prior cpa1-tobs computation (`explorations/cpa1-tobs-coefficient-2026-06-23.md`) established:
...
From `explorations/observer-section-error-model-2026-06-23.md`, three candidate models:
...
- `explorations/cpa1-tobs-coefficient-2026-06-23.md` -- prior CPA-1 computation; C_GU = 8,
  null-ray model derivation, algebraic identity C_GU * epsilon_sec^2 = 1 for all n.
- `explorations/observer-section-error-model-2026-06-23.md` -- B1-B3 bridge model; decoherence
  model formulation.
...
- `explorations/ii-s-moving-frames-2026-06-23.md` -- Section 9-10; C_GU = 8 via SO(5) Casimir
