...
- `explorations/hc1-sl2c-bianchi-spinor-2026-06-23.md` — SL(2,C) labels for H^(i) and T^(i);
  Open Q1 resolved (theta decomposes into same irreducibles as T)
- `explorations/ii-s-moving-frames-2026-06-23.md` — explicit Christoffel blocks and II_s^H
  master formula [MF] in moving-frame gauge
- `explorations/codazzi-sp64-2026-06-23.md` — full Codazzi equation for Sp(64) bundle
- `explorations/dark-energy-noether-closure-2026-06-22.md` — theta = D_A* F_A on-shell;
  D_A* theta = 0
...
- `explorations/hc1-sl2c-bianchi-spinor-2026-06-23.md` (SL(2,C) labels; Open Q1 resolution)
- `explorations/hc1-hidden-curvature-components-2026-06-22.md` (parent HC1)
- `explorations/ii-s-moving-frames-2026-06-23.md` (master formula [MF], Christoffel blocks)
- `explorations/codazzi-sp64-2026-06-23.md` (Codazzi equation [CodEq] for Sp(64))
- `explorations/ic1-soldering-map-ns-adps-2026-06-23.md` (j_s construction, equivariance)
- `explorations/ic2-positivity-soldering-normal-2026-06-23.md` (Clifford-trace factor 512)
- `explorations/ic3-nonlinear-conservation-2026-06-23.md` (conservation; Bianchi cascade)
- `explorations/dark-energy-noether-closure-2026-06-22.md` (theta = D_A* F_A on-shell)
- `explorations/vz-schur-complement-2026-06-23.md` (RS sector VZ evasion)
