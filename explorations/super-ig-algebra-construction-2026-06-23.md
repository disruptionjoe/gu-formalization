...
1. `explorations/weinstein-ucsd-2025-04-analysis-2026-06-22.md` identifies the
...
2. `explorations/ig-dimension-matching-sp64-tau-plus-2026-06-22.md` fixes the
...
3. `explorations/anomaly-audit-cl95-gauge-group-2026-06-22.md` fixes the corrected
   gauge group and anomaly setting: `Cl(9,5) ~= M(64,H)`, `S = H^64`, and the natural
   gauge group is quaternionic unitary `Sp(64)`.

4. `explorations/vz-f6-eft-decoupling-2026-06-23.md` conditionally resolves the
...
- `explorations/weinstein-ucsd-2025-04-analysis-2026-06-22.md`, New Object F.
