...
(`explorations/ig-dimension-matching-sp64-tau-plus-2026-06-22.md`) marked N4 RESOLVED
...
- `explorations/anomaly-audit-cl95-gauge-group-2026-06-22.md`: Cl(9,5) ≅ M(64,ℍ),
  ...
  N4 targets.
- `explorations/ig-dimension-matching-sp64-tau-plus-2026-06-22.md`: τ⁺ is purely
...
- `explorations/super-ig-algebra-construction-2026-06-23.md`: the IG infinitesimal
  algebra is `ig = Ω⁰(ad P) ⋉ Ω¹(ad P)`, the connection-space analogue of the Poincaré
  algebra, translation part abelian.
- `explorations/anomaly-sp64-global-pi15-2026-06-23.md`: its FC-3 ("subgroup escape via
...
Repo files:
- `explorations/ig-dimension-matching-sp64-tau-plus-2026-06-22.md` — prior N4 (dissolution).
- `explorations/anomaly-audit-cl95-gauge-group-2026-06-22.md` — §4.3, §5.1(a)/(b) flag this residual.
- `explorations/anomaly-sp64-global-pi15-2026-06-23.md` — FC-3 (subgroup escape) couples here.
- `explorations/super-ig-algebra-construction-2026-06-23.md` — IG infinitesimal algebra `ig = gP ⋉ V`.
