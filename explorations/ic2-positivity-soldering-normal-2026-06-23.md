...
RESOLVED, `explorations/ic1-soldering-map-ns-adps-2026-06-23.md`), the 10-dimensional image
...
- `explorations/ic1-soldering-map-ns-adps-2026-06-23.md` (IC1 soldering map — prerequisite for IC2)
- `explorations/codazzi-general-non-umbilic-2026-06-23.md` (IC2 appears as condition on Q^{TF}(B))
- `explorations/codazzi-sp64-bundle-2026-06-23.md` (Q_{mu nu}(B) and K(A,s) formulas)
- `explorations/ii-s-moving-frames-2026-06-23.md` (II_s^H as normal-bundle scalar fields)
- `explorations/n1-signature-audit-y14-clifford-algebra-2026-06-22.md` (Cl(9,5), S = H^64)
- `explorations/anomaly-audit-cl95-gauge-group-2026-06-22.md` (Sp(64), sp(64), dim = 8256)
- `explorations/dark-energy-noether-closure-2026-06-22.md` (D_A*theta = 0 on-shell, YM action)
