...
**Context.** From `explorations/codazzi-sp64-2026-06-23.md`, the Einstein identification
...
- IC3 at **linear order** in B: VERIFIED (from `explorations/codazzi-sp64-2026-06-23.md`)
...
moving-frame Christoffel symbols from `explorations/ii-s-moving-frames-2026-06-23.md`.
...
- `explorations/codazzi-general-non-umbilic-2026-06-23.md` (Q^{TF}(B), K(A,s) explicit)
- `explorations/ii-s-moving-frames-2026-06-23.md` (gimmel Christoffels, II_s^H = nabla^perp theta)
- `explorations/ic1-soldering-map-ns-adps-2026-06-23.md` (j_s: N_s -> ad(P_s))
- `explorations/ic2-positivity-soldering-normal-2026-06-23.md` (IC2 status)
