...
status: exploration (pre-registered Node B2, simplex camp; five perspectives inline, one worker, no independent reviewers; deterministic grade-decomposition probe, exit 0)
created: 2026-07-20
...
simplex camp (B2). B2 is the hypergraph perspective's dissent, and the only reading
