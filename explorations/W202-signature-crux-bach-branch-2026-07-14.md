...
- conformal/record-count mode `G(eta,eta) = 4 - 16 lambda = -12 < 0` (Krein-NEGATIVE) on BOTH (B1);
...
| record-count/conformal Krein sign | NEGATIVE on both | B1: `G(eta,eta)=-12` |
