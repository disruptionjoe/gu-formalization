...
- `explorations/discrete-series-fiber-dirac-index-2026-06-23.md` (prior note: Steps A-E)
- `explorations/n5-ind-h-analytic-conditions-2026-06-22.md` (fiber homotopy, Atiyah-Schmid)
