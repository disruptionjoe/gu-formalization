...
- **Specification:** The substrate is Y^14 = Met(X^4): the bundle of Lorentzian metrics on
  ...
  index computation in `explorations/n5-discrete-series-gl4r-2026-06-23.md`). The substrate
...
- **Literature anchor:** GU construction (Weinstein UCSD transcript 2025-04); gimmel metric
  (`explorations/n1-signature-audit-y14-clifford-algebra-2026-06-22.md`); Clifford spinor
  module (`explorations/anomaly-audit-cl95-gauge-group-2026-06-22.md`); discrete-series
  chirality invariant (`explorations/n5-discrete-series-gl4r-2026-06-23.md`).
