...
(`explorations/anomaly-audit-cl95-gauge-group-2026-06-22.md`, §3) closed the *perturbative*
...
- `explorations/ig-dimension-matching-sp64-tau-plus-2026-06-22.md` — τ⁺/IG with Sp(64);
  adjoint-dimension question (§5.1b cross-ref).
- `explorations/n1-signature-audit-y14-clifford-algebra-2026-06-22.md` — Cl(9,5) ≅ M(64,ℍ)
