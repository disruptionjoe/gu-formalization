...
- `explorations/ii-s-moving-frames-2026-06-23.md` (gimmel Christoffels; fiber metric V)
- `explorations/n5-discrete-series-gl4r-2026-06-23.md` §12-19 (RS zero modes; ind_H = 8; OQ3a-c)
- `explorations/cpa1-tobs-coefficient-2026-06-23.md` (Lambda_GU = lambda_max^2; M_KK alignment)
- `explorations/ic3-nonlinear-conservation-2026-06-23.md` (Bianchi identity; normal curvature conservation)
- `explorations/hc1-sl2c-bianchi-spinor-2026-06-23.md` (hidden curvature H^{(i)} SL(2,C) labels)
