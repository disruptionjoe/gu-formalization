...
(established in `explorations/cpa1-tobs-coefficient-2026-06-23.md`). The substrate includes
...
(`explorations/n1-signature-audit-y14-clifford-algebra-2026-06-22.md`); Tikhonov
section selection (`explorations/ii-s-moving-frames-2026-06-23.md`); Lindblad/pointer-basis
decoherence model (`explorations/observer-section-error-model-2026-06-23.md`).
...
`explorations/fr2-bvn-layer5-promotion-gate-2026-06-23.md`) and no definite classical
section is available.

**Literature anchor:** BvN gate (i) proof at `explorations/fr2-bvn-layer5-promotion-gate-2026-06-23.md`;
Lindblad/pointer-basis model at `explorations/observer-section-error-model-2026-06-23.md`;
...
at `explorations/fr2-bvn-layer5-promotion-gate-2026-06-23.md`; fr2-gate-ii GU result at
`explorations/fr2-bvn-gate-ii-gu-result-2026-06-23.md`; Lindblad decoherence model at
...
operator on S^4 at l=2, n=4; verified in `explorations/cpa1-tobs-coefficient-2026-06-23.md`
and `explorations/ii-s-moving-frames-2026-06-23.md`). The emergence class is specific-object
...
(`explorations/cpa1-tobs-coefficient-2026-06-23.md`); CPA-1 cross-program contact
...
GU Tikhonov derivation at `explorations/cpa1-tobs-coefficient-2026-06-23.md`; explicit Lambda
formula at `explorations/ii-s-moving-frames-2026-06-23.md`; observer-section coupling at
`explorations/observer-section-error-model-2026-06-23.md`; L6 cadence confirmation at
...
m_H(S(6,4)) = 24 (reconstruction-grade, from `explorations/n5-discrete-series-gl4r-2026-06-23.md`).
...
(already computed in `explorations/cpa1-tobs-coefficient-2026-06-23.md`; lowest TT
...
5. **F5 (coefficient mismatch):** The cross-program contact Lambda_GU = lambda_max^2
   (from CPA-1, `explorations/cpa1-omega-tuning-2026-06-23.md`) is not an algebraic
