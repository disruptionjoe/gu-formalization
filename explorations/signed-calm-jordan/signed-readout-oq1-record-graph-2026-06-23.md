...
`explorations/signed-calm-jordan/signed-readout-monotonicity-pn-jordan-2026-06-23.md`: a scalar readout
...
- `explorations/signed-calm-jordan/signed-readout-monotonicity-pn-jordan-2026-06-23.md` -- proved the
...
- `explorations/misc/fr2-bvn-gate-ii-gu-result-2026-06-23.md` -- scope condition for
...
- **OQ1-A (TaF contact).** Does the finality-semantics condition F(O, r_j) in this file
  ...
  dictionary) remains open in `explorations/time-as-finality-crosswalk/n3-h3-cech-holonomy-2026-06-23.md`.
