...
- `explorations/oq1-split-rank-verification-2026-06-23.md` — RESOLVED: split-rank = 3
- `explorations/oq3b-rs-index-8-2026-06-23.md` — Parent file, tau-correction mechanism
- `explorations/rc1-rs-kk-zero-mode-2026-06-23.md` — BC1 chain (superseded for scalar pair)
- `explorations/rc1-discrete-series-verification-pack-2026-06-23.md` — FAILS_AS_STATED note
- `explorations/generation-count-sm-branching-closure-2026-06-22.md` — SM branching
