...
- `explorations/dark-energy-cosmology/dark-energy-divergence-free-proof-2026-06-22.md` — equivariance proof (§2), C1/C2 conditions identified (§5).
- `explorations/dark-energy-cosmology/dark-energy-noether-closure-2026-06-22.md` — C3 path (Noether's second theorem).
