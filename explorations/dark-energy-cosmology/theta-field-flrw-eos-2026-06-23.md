...
- `explorations/dark-energy-cosmology/dark-energy-noether-closure-2026-06-22.md`: D_A * theta = 0 on-shell, from
  Noether's second theorem. The GU vacuum field equation identifies theta = D_A * F_A.

- `explorations/cycle-gates-and-audits/gu-testable-predictions-2026-06-23.md` Candidate D: The theta field on a
...
- `explorations/representation-theory-noncompact/rc3-delta-n-spectrum-gl4r-2026-06-23.md`: The lowest eigenvalue of the
...
- `explorations/geometry-curvature-emergence/cpa1-tobs-coefficient-2026-06-23.md`: With R_s = c * t_obs (Hubble sphere
  approximation), M_KK = 2*sqrt(2) H_0 where H_0 = 1/t_obs.

- `explorations/geometry-curvature-emergence/rfail-umbilic-sections-2026-06-23.md`: In the vacuum (umbilic section),
...
- `explorations/cycle-gates-and-audits/gu-testable-predictions-2026-06-23.md`: Candidate D setup; M_KK ~ 2.83 H_0.
- `explorations/representation-theory-noncompact/rc3-delta-n-spectrum-gl4r-2026-06-23.md`: M_KK = 2*sqrt(2)/R_s from fiber spectrum.
- `explorations/dark-energy-cosmology/dark-energy-noether-closure-2026-06-22.md`: D_A*theta = 0 on-shell.
- `explorations/geometry-curvature-emergence/rfail-umbilic-sections-2026-06-23.md`: Umbilic vacuum, Lambda_eff constant.
- `explorations/geometry-curvature-emergence/cpa1-tobs-coefficient-2026-06-23.md`: M_KK = 2.83 H_0 with R_s = t_obs.
