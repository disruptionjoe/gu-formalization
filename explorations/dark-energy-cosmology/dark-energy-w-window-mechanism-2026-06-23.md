...
- `explorations/dark-energy-cosmology/dark-energy-oq3a-slow-roll-ic-sign-2026-06-23.md` — window derivation, criterion.
- `explorations/dark-energy-cosmology/theta-field-flrw-matter-era-ode-2026-06-23.md` — full FLRW baseline, ratio formula.
- `explorations/dark-energy-cosmology/dark-energy-c1-c2-path-gimmel-ginvariance-2026-06-23.md` — orthogonal divergence-free leg.
- `explorations/representation-theory-noncompact/rc3-delta-n-spectrum-gl4r-2026-06-23.md` — `M_KK` from fiber spectrum.
