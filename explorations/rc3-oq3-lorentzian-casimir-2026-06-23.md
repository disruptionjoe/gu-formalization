...
- `explorations/rc3-delta-n-spectrum-gl4r-2026-06-23.md` §7.3-7.4 (parent computation, Delta m^2 = +3/R_s^2)
- `explorations/rc3-harish-chandra-c-function-2026-06-23.md` §8 F4 (OQ-RC3-3 stated as falsification)
- `explorations/n5-discrete-series-gl4r-2026-06-23.md` §12-19 (RS K-type = D(1/2,0)+D(0,1/2))
- `explorations/vz-f6-eft-decoupling-2026-06-23.md` (VZ EFT evasion; requires RS at KK scale)
