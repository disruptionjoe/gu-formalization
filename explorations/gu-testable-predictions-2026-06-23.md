...
depends_on:
  ...
  - explorations/n5-generation-count-synthesis-2026-06-23.md
...
- `explorations/cpa1-tobs-coefficient-2026-06-23.md` (Lambda_GU = 1/t_obs^2; C_GU = 8)
- `explorations/cpa1-omega-tuning-2026-06-23.md` (Omega = 1 under null-ray model; epsilon_sec = 1/(2*sqrt(2)))
- `explorations/vz-f6-eft-decoupling-2026-06-23.md` (M_KK ~ 1/R_s; RS/spin-1/2 mass ratio)
- `explorations/n5-generation-count-synthesis-2026-06-23.md` (ind_H(D_GU) = 24; 3 generations exact)
- `explorations/rc3-delta-n-spectrum-gl4r-2026-06-23.md` (normal Laplacian spectrum, m_RS^2 = 11/R_s^2)
- `explorations/rfail-umbilic-sections-2026-06-23.md` (R_fail = 0 in vacuum; Lambda from trace equation)
- `explorations/dark-energy-noether-closure-2026-06-22.md` (D_A * theta = 0 on-shell, Noether proof)
- `explorations/ic4-lagrangian-tmunu-derivation-2026-06-23.md` (T^{dist}_{mu nu} derivation)
