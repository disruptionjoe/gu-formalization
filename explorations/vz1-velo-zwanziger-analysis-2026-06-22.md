...
From `explorations/generation-count-sm-branching-closure-2026-06-22.md` §4:
...
`explorations/anomaly-audit-cl95-gauge-group-2026-06-22.md`), the spin-3/2 field
...
- `explorations/generation-count-sm-branching-closure-2026-06-22.md` §4 (RS sector
...
- `explorations/anomaly-audit-cl95-gauge-group-2026-06-22.md` (Sp(64) gauge group).
