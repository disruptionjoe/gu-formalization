...
Three perspectives reason INLINE in this one worker (each in-character, then a
synthesis; NEVER one agent per perspective). Read-only interpretation of the settled
