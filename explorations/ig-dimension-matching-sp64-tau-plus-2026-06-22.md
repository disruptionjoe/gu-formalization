...
**The driving question.** The anomaly audit (`explorations/anomaly-audit-cl95-gauge-group-2026-06-22.md`)
...
`explorations/dark-energy-divergence-free-proof-2026-06-22.md` and
...
Repo files:
- `explorations/anomaly-audit-cl95-gauge-group-2026-06-22.md` — Sp(64) determination,
  anomaly cancellation, §4.3 residual identified here.
- `explorations/n1-signature-audit-y14-clifford-algebra-2026-06-22.md` — (9,5) signature,
  Cl(9,5) ≅ M(64,ℍ), shiab existence.
- `explorations/dark-energy-divergence-free-proof-2026-06-22.md` — equivariance of θ.
- `explorations/dark-energy-noether-closure-2026-06-22.md` — D_A*θ = 0 on-shell.
