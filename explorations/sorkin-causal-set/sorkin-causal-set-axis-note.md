---
title: "Sorkin Causal-Set Axis-Drop — Scoping Note"
status: exploration
doc_type: synthesis
...
This is the same bet as the partial-order DAG lens (`lab/process/perspective-passes/05-heterodox-problem-shape-distributed-systems/32-ps-dag-partial-order-heterodox.md`) but on the spacetime substrate rather than on the protocol substrate. Sorkin causal-sets and the distributed-systems partial-order axis are sibling axis-drops on the **same axis** (L4), populating different classes (L4 = d vs. L4 = b CALM-monotonic).
...
### 9.5 Sibling — non-pipeline cross-ref: `lab/process/perspective-passes/05-heterodox-problem-shape-distributed-systems/32-ps-dag-partial-order-heterodox.md`

**Relation.** The DAG / partial-order lens in `lab/process/perspective-passes/05` introduces L4 = b (CALM-monotonic partial-order) as the distributed-systems sibling of L4 = d (Sorkin causal-set). The two are **different classes on the same axis**, populating L4 differently:
...
- Perspective dialectic applied per the card's Divergent Perspective Dialectic Seed (causal-set theorist, general relativist, QFT-on-causal-sets lens, chirality skeptic, distributed-systems partial-order lens, heterodox synthesizer).
- Source-basis files in this repo:
  - `lab/process/perspective-passes/05-heterodox-problem-shape-distributed-systems/32-ps-dag-partial-order-heterodox.md` (the DAG / partial-order lens that introduced the L4 axis-drop framing).
  ...
  - `lab/roadmap/15-perspective-pathway-ranking.md` (per the card's "The Work" section).
