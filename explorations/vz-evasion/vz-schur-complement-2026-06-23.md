...
This depends on the Codazzi equation for the Sp(64) bundle (explorations/geometry-curvature-emergence/codazzi-sp64-bundle-2026-06-23.md).
...
terms). The Codazzi equation for the Sp(64) bundle (from `explorations/geometry-curvature-emergence/codazzi-sp64-2026-06-23.md`)
gives:
...
- `explorations/vz-evasion/vz-oq1-sr-squared-identity-2026-06-23.md` (OQ1 resolved: S_R^2 != xi2 Id exactly)
- `explorations/vz-evasion/vz-oq2-lower-order-curvature-2026-06-23.md` (OQ2: curvature protection)
- `explorations/vz-evasion/vz-subprincipal-symbol-rs-2026-06-23.md` (subprincipal symbol analysis)
