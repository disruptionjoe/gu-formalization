...
- `explorations/vz-evasion/vz1-schur-complement-symbol-2026-06-23.md` (prior horizontal minimal result)
- `explorations/vz-evasion/vz1-velo-zwanziger-analysis-2026-06-22.md` (VZ setup and OQ1)
