...
of Dirac type. This requires the Codazzi equation (explorations/geometry-curvature-emergence/codazzi-sp64-bundle-2026-06-23.md)
...
- `explorations/vz-evasion/vz-schur-complement-2026-06-23.md` (principal symbol, VZ EVADED)
- `explorations/vz-evasion/vz-oq1-sr-squared-identity-2026-06-23.md` (S_R^2 identity clarification)
- `explorations/vz-evasion/vz-oq2-lower-order-curvature-2026-06-23.md` (curvature zero-order argument; parent for OQ2-a, OQ2-b)
- `explorations/anomaly-and-bordism/n1-signature-audit-y14-clifford-algebra-2026-06-22.md` (Cl(9,5) algebra, signature (9,5))
- `explorations/geometry-curvature-emergence/codazzi-sp64-bundle-2026-06-23.md` (OQ3, 4D pullback)
