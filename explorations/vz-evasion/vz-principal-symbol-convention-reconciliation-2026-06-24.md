...
target_gate: FC-VZ-1
owned_path: explorations/vz-evasion/vz-principal-symbol-convention-reconciliation-2026-06-24.md
depends_on:
  ...
  - explorations/shiab-operator/sc1-oq3-gauge-equivariance-2026-06-23.md
...
- `explorations/vz-evasion/vz1-schur-complement-symbol-2026-06-23.md` explicitly assumes
  `D_GU(u, psi) = (d_A^* psi, d_A u + Phi(d_A psi))` and defines
  `F_xi := sigma(Phi o d_A)(xi)`.
- `explorations/vz-evasion/vz-oq2-lower-order-curvature-2026-06-23.md` and
  `explorations/vz-evasion/vz-subprincipal-symbol-rs-2026-06-23.md` describe the shiab term as
