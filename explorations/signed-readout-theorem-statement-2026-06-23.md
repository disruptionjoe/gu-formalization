...
`explorations/signed-readout-monotonicity-pn-jordan-2026-06-23.md` §4. The proof is
...
`explorations/signed-readout-monotonicity-pn-jordan-2026-06-23.md` §5.

### 8.3 Record-Graph Semantics (Established)

OQ1 is RESOLVED in `explorations/signed-readout-oq1-record-graph-2026-06-23.md`. The four
...
OQ2 is CONDITIONALLY_RESOLVED in `explorations/signed-readout-oq2-integer-index-2026-06-23.md`.
...
OQ2-A is CONDITIONALLY_RESOLVED in `explorations/signed-readout-oq2a-k-theory-lift-2026-06-23.md`.
...
OQ2-D is CONDITIONALLY_RESOLVED in `explorations/signed-readout-oq2d-gu-contact-2026-06-23.md`.
