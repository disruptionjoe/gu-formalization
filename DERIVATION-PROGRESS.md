...
**Key files:**
- `explorations/anomaly-and-bordism/n1-signature-audit-y14-clifford-algebra-2026-06-22.md` (N1 audit — RESOLVES the condition)
- `explorations/shiab-operator/n2-shiab-computation-spin77-branching-rules-2026-06-22.md` (structural computation, done under (7,7) assumption; result survives)
- `explorations/misc/positive-gu-constructions-lane-proposal-2026-06-22.md` (PC1 six-axis spec)
- `lab/literature/weinstein-ucsd-2025-04-transcript.md` (primary source, [00:43:04] trace-reverse claim)
...
**Computation files:**
- `explorations/anomaly-and-bordism/n1-signature-audit-y14-clifford-algebra-2026-06-22.md` (N1 audit, resolves condition)
- `explorations/shiab-operator/n2-shiab-computation-spin77-branching-rules-2026-06-22.md` (structural computation)
...
**Key files:**
- `lab/literature/weinstein-ucsd-2025-04-transcript.md` (~00:17-00:27)
- `explorations/cycle-gates-and-audits/weinstein-ucsd-2025-04-analysis-2026-06-22.md` (§1.2 dark energy claim)
- `explorations/misc/positive-gu-constructions-lane-proposal-2026-06-22.md` (PC4, torsion-for-Λ)
...
**Key files:**
- `explorations/dark-energy-cosmology/dark-energy-divergence-free-proof-2026-06-22.md` (equivariance + conditional)
- `explorations/dark-energy-cosmology/dark-energy-noether-closure-2026-06-22.md` (C3 closure — this closes Layer 2)
...
|---|---|---|---|
| A | Anomaly audit — Cl(9,5) gauge group and Nguyen §2 | SUPERSEDED: NGUYEN_U128_PINCER_SUBSTANTIALLY_ADDRESSED; FULL_GU_ANOMALY_OPEN | `explorations/anomaly-and-bordism/anomaly-audit-cl95-gauge-group-2026-06-22.md` |
| B | Generation count — Cl(9,5) Dirac-DeRham complex | SUPERSEDED: OPEN | `explorations/generation-sector/generation-count-cl95-dirac-derham-2026-06-22.md` |
| C | VZ1 + HC1 — Velo-Zwanziger no-go and hidden curvature | VZ1: unconfirmed evasion; HC1: THREE HIDDEN CONFIRMED under torsion-sourcing reading | `explorations/geometry-curvature-emergence/hc1-hidden-curvature-components-2026-06-22.md` |
| D | DD1 + PC2 — Distortion literature and bundle stub | DD1: PARTIALLY_NAMED; PC2: formalization stub complete | `explorations/geometry-curvature-emergence/dd1-distortion-tensor-literature-check-2026-06-22.md`, `explorations/geometry-curvature-emergence/pc2-met-x4-bundle-formalization-stub-2026-06-22.md` |
...
### VZ1 62-Perspective Steelman Pass
...
- File: `explorations/perspective-and-dialectic/vz1-62-perspective-steelman-hegelian-2026-06-22.md`
...
| task | result | file |
|---|---|---|
| VZ Schur complement | RS/non-RS off-diagonal coupling is nonzero in the local rolled-up principal-symbol model; the horizontal RS sector is not a closed native 14D subsystem. Minimal horizontal Schur complement has no off-null kernel. Full 14D inversion remains open. | `explorations/vz-evasion/vz1-schur-complement-symbol-2026-06-23.md` |
| Explicit `II_s` formula | Gimmel Christoffels and graph-section second fundamental form are now explicit. Local OQ-2 is formula-closed, but physical interpretation depends on choosing literal graph immersion versus horizontal-normalized/reference-subtracted convention. | `explorations/geometry-curvature-emergence/ii-s-coordinate-formula-2026-06-23.md` |
| Codazzi/Sp(64) | Gauss-Codazzi-Ricci equations are formulated for the tautological section and Sp(64) lift. The exact residuals are `K(A,s)` and `R_fail`; these are the next pass/fail objects for Einstein recovery. | `explorations/geometry-curvature-emergence/codazzi-sp64-bundle-2026-06-23.md` |
| Fiber Dirac analytic index | Ordinary finite `dim_H ker_L2(D_fib)=24` on `GL(4,R)/O(3,1)` is not coherent. The analytic target must be reframed as a compactified/quotient/equivariant-index or relative-discrete-series multiplicity problem. | `explorations/analytic-index-fredholm/discrete-series-fiber-dirac-index-2026-06-23.md` |
| Cross-program Lambda coefficient | The GU/TaF comparison must use rate-squared quantities: `Lambda_GU` compares to `lambda_max^2` or `Gamma_min^2`. Exact invariant coefficient remains blocked by the `II_s` Hessian on `S^4`. | `explorations/dark-energy-cosmology/cross-program-lambda-coefficient-2026-06-23.md` |

A sixth, narrow VZ follow-up was produced by the brief scheduled run before it was stopped and was retained: `explorations/vz-evasion/vz1-schur-vertical-extension-2026-06-23.md`. It closes the horizontal-covector vertical one-form extension: vertical one-forms do not modify the horizontal Schur complement under the horizontal gamma-trace RS projection. The remaining VZ target is now the mixed-covector/full-14D-gamma-trace case.

**Automation added.** Local hourly automation was created under `lab/automation/`:

- `lab/automation/hourly-frontier-prompt.md`
- `lab/automation/gui-automation-pointer-prompt.md`
- `lab/automation/run-hourly-frontier.ps1`
- Windows Scheduled Task: `GU Formalization Hourly Frontier Dispatch`

The task runs hourly starting 2026-06-23 02:00 local time. It uses the first working local CLI runner it can resolve. A GUI-compatible pointer prompt is also available for Codex app automations that can schedule a prompt directly. In this session, the Codex WindowsApps executable was present but not executable from PowerShell (`Access is denied`); the script therefore supports overriding the runner with `GU_FRONTIER_RUNNER` or bypassing the shell runner by pasting `lab/automation/gui-automation-pointer-prompt.md` into a GUI hourly automation.
...
File: `explorations/geometry-curvature-emergence/hc1-sl2c-bianchi-spinor-2026-06-23.md`
...
File: `explorations/shiab-operator/sc1-shiab-domain-codomain-2026-06-23.md`
...
File: `explorations/representation-theory-noncompact/n5-discrete-series-gl4r-2026-06-23.md`
...
| Parthasarathy-Casimir for fiber Dirac | Casimir condition formulated: `pi(C_g) = 9/2 + rho_constant` for candidate `S(6,4)|_{SL(2,C)} ~= (3/2,1/2) + (1/2,3/2)` (reconstruction grade). Vogan infinitesimal-character condition stated. Open: rho-constant from restricted roots; spectral confirmation; multiplicity `m_H = 24`. | `explorations/representation-theory-noncompact/n5-parthasarathy-casimir-sl4r-2026-06-23.md` |
...
File: `explorations/geometry-curvature-emergence/cpa1-tobs-coefficient-2026-06-23.md`
...
File: `explorations/vz-evasion/vz-schur-complement-2026-06-23.md`
...
File: `explorations/geometry-curvature-emergence/ii-s-moving-frames-2026-06-23.md`
...
File: `explorations/geometry-curvature-emergence/codazzi-general-non-umbilic-2026-06-23.md`
...
File: `explorations/shiab-operator/pc1-spin77-spinor-decomp-2026-06-23.md`
...
File: `explorations/vz-evasion/vz-oq1-sr-squared-identity-2026-06-23.md`
...
File: `explorations/vz-evasion/vz-oq2-lower-order-curvature-2026-06-23.md`
...
File: `explorations/analytic-index-fredholm/ind-top-x4-atiyah-singer-2026-06-23.md`
...
File: `explorations/geometry-curvature-emergence/ic1-soldering-map-ns-adps-2026-06-23.md`
...
File: `explorations/geometry-curvature-emergence/ic2-positivity-soldering-normal-2026-06-23.md`
...
File: `explorations/geometry-curvature-emergence/codazzi-sp64-2026-06-23.md`
...
File: `explorations/vz-evasion/vz-subprincipal-symbol-rs-2026-06-23.md`
...
File: `explorations/analytic-index-fredholm/ind-top-eta-s3-aps-2026-06-23.md`
...
File: `explorations/geometry-curvature-emergence/ic3-nonlinear-conservation-2026-06-23.md`
...
File: `explorations/generation-sector/oq3a-gu-variational-k3-selection-2026-06-23.md`
...
File: `explorations/geometry-curvature-emergence/ic4-lagrangian-tmunu-derivation-2026-06-23.md`
...
File: `explorations/analytic-index-fredholm/g2-kk-zero-mode-unitarity-2026-06-23.md`
...
File: `explorations/geometry-curvature-emergence/rfail-umbilic-sections-2026-06-23.md`
...
File: `explorations/vz-evasion/vz-f5-curvature-check-2026-06-23.md`
...
File: `explorations/representation-theory-noncompact/n5-plancherel-multiplicity-2026-06-23.md`
...
File: `explorations/time-as-finality-crosswalk/n3-h3-cech-holonomy-2026-06-23.md`
...
File: `explorations/geometry-curvature-emergence/cpa1-omega-tuning-2026-06-23.md`
...
File: `explorations/vz-evasion/vz-f6-eft-decoupling-2026-06-23.md`
...
File: `explorations/geometry-curvature-emergence/hc1-coupling-coefficients-2026-06-23.md`
...
File: `explorations/geometry-curvature-emergence/pc4-torsion-lambda-derivation-2026-06-23.md`
...
File: `explorations/geometry-curvature-emergence/pc2-gauss-y14-curvature-2026-06-23.md`
...
File: `explorations/representation-theory-noncompact/weyl-group-s4-orbit-2026-06-23.md`
...
File: `explorations/misc/fr2-bvn-layer5-promotion-gate-2026-06-23.md`
...
File: `explorations/geometry-curvature-emergence/hc1-codazzi-correction-2026-06-23.md`
...
File: `explorations/representation-theory-noncompact/rc3-delta-n-spectrum-gl4r-2026-06-23.md`
...
File: `explorations/misc/fr2-bvn-gate-ii-gu-result-2026-06-23.md`
...
File: `explorations/representation-theory-noncompact/rc3-harish-chandra-c-function-2026-06-23.md`
...
File: `explorations/generation-sector/oq-rk1-cas-matrix-rank-2026-06-23.md`
...
File: `explorations/misc/six-axis-l1l2-coupling-filled-example-2026-06-23.md`
...
File: `explorations/misc/six-axis-l1l2-coupling-second-example-2026-06-23.md`
...
File: `explorations/shiab-operator/sc1-oq2-ellipticity-split-signature-2026-06-23.md`
...
File: `explorations/representation-theory-noncompact/rc3-oq3-lorentzian-casimir-2026-06-23.md`
...
File: `explorations/geometry-curvature-emergence/cpa1-ambient-curv-y14-2026-06-23.md`
...
File: `explorations/shiab-operator/sc1-oq2b-symmetric-hyperbolic-2026-06-23.md`
...
File: `explorations/representation-theory-noncompact/rc3-root-multiplicity-bc1-2026-06-23.md`
...
File: `explorations/shiab-operator/sc1-oq3-gauge-equivariance-2026-06-23.md`
...
File: `explorations/geometry-curvature-emergence/cpa1-oq2-gimmel-hessian-direct-2026-06-23.md`
...
File: `explorations/shiab-operator/sc1-oq2c-null-mode-interpretation-2026-06-23.md`
...
File: `explorations/geometry-curvature-emergence/pc3-riemannian-ehresmannian-annotation-2026-06-23.md`
...
File: `explorations/geometry-curvature-emergence/ic2-cas-clifford-trace-verification-2026-06-23.md`
...
File: `explorations/misc/fr4-cadence-delta-second-example-2026-06-23.md`
...
File: `explorations/shiab-operator/sc1-oq1-shiab-uniqueness-2026-06-23.md`
...
File: `explorations/generation-sector/rc1-rs-kk-zero-mode-2026-06-23.md`
...
File: `explorations/time-as-finality-crosswalk/six-axis-observer-model-row-2026-06-23.md`
...
File: `explorations/misc/fr3-filtered-sheaf-gu-chirality-test-2026-06-23.md`
...
File: `explorations/time-as-finality-crosswalk/taf-h3-contact-2026-06-23.md`
...
File: `explorations/signed-calm-jordan/signed-readout-theorem-statement-2026-06-23.md`
...
File: `explorations/type-ii1-spectral/type-ii1-sm-checklist-tightening-2026-06-23.md`
...
File: `explorations/type-ii1-spectral/type-ii1-finite-control-selector-attempt-2026-06-23.md`
...
File: `explorations/time-as-finality-crosswalk/n3-cech-fixture-specification-2026-06-23.md`
...
File: `explorations/vz-evasion/vz1-oq3-gravitational-vz-weyl-tensor-2026-06-23.md`
...
File: `explorations/type-ii1-spectral/type-ii1-oq1-j2-section-pullback-2026-06-23.md`
...
File: `explorations/type-ii1-spectral/type-ii1-oq2-dgu-inner-fluctuations-2026-06-23.md`
...
File: `explorations/signed-calm-jordan/signed-readout-oc1-oc2-noncompact-fredholm-2026-06-23.md`
...
File: `explorations/time-as-finality-crosswalk/h3-cech-sheaf-fixture-spec-2026-06-23.md`
...
File: `explorations/representation-theory-noncompact/rc1-discrete-series-verification-pack-2026-06-23.md`
...
File: `explorations/generation-sector/oq3a-k3-variational-selection-2026-06-23.md`
...
File: `explorations/generation-sector/oq3c-index-additivity-2026-06-23.md`
...
File: `explorations/generation-sector/oq3b-rs-index-8-2026-06-23.md`
...
File: `explorations/representation-theory-noncompact/rc1-root-multiplicity-check-2026-06-23.md`
...
File: `explorations/representation-theory-noncompact/oq1-split-rank-verification-2026-06-23.md`
...
File: `explorations/generation-sector/oq3c-cross-term-cancellation-2026-06-23.md`
...
File: `explorations/analytic-index-fredholm/oc2-h-linear-fredholm-y14-2026-06-23.md`
...
File: `explorations/type-ii1-spectral/type-ii1-semifinite-triple-2026-06-23.md`
...
File: `explorations/analytic-index-fredholm/oc1-noncompact-atiyah-jannich-2026-06-23.md`
...
File: `explorations/generation-sector/oq3a-willmore-k3-selection-2026-06-23.md`
...
File: `explorations/time-as-finality-crosswalk/taf-h3-c3-spacelike-overlap-2026-06-23.md`
...
File: `explorations/time-as-finality-crosswalk/freed-hopkins-nonforgettable-observer-2026-06-23.md`
---
...
File: `explorations/time-as-finality-crosswalk/taf-h3-c1-type-bridge-2026-06-23.md`
...
File: `explorations/representation-theory-noncompact/tau-correction-oshima-matsuki-rs-2026-06-23.md`
...
File: `explorations/representation-theory-noncompact/oq-weyl3-root-wall-plancherel-2026-06-23.md`
...
File: `explorations/representation-theory-noncompact/split-rank-reconciliation-audit-2026-06-23.md`
...
File: `explorations/geometry-curvature-emergence/ic4-ricci-flat-k3-selection-2026-06-23.md`
...
File: `explorations/analytic-index-fredholm/oc2-analytic-fredholm-ksp-upgrade-2026-06-23.md`
...
File: `explorations/representation-theory-noncompact/tau-twisted-rs-admissibility-kobayashi-2026-06-23.md`
...
File: `explorations/analytic-index-fredholm/oc2-y14-weighted-fredholm-parametrix-2026-06-23.md`
...
File: `explorations/generation-sector/oq3a-t4-vs-k3-disambiguation-2026-06-23.md`
...
File: `explorations/geometry-curvature-emergence/ic4-source-free-k3-gate-2026-06-23.md`
...
File: `explorations/analytic-index-fredholm/oc1-oc2-aps-closure-2026-06-23.md`
...
File: `explorations/representation-theory-noncompact/rc1-root-mult-disambiguation-2026-06-23.md`
...
File: `explorations/generation-sector/oq3b-rs-index-closed-2026-06-23.md`
...
File: `explorations/type-ii1-spectral/type-ii1-ko-dimension-2026-06-23.md`
...
File: `explorations/generation-sector/rs-analytic-rank3-rebuild-or-demotion-2026-06-23.md`
...
File: `explorations/time-as-finality-crosswalk/h3-outcome-d-prime-gu-bridge-2026-06-23.md`
...
File: `explorations/geometry-curvature-emergence/ic4-gyt-component-verification-2026-06-23.md`
...
File: `explorations/analytic-index-fredholm/oc1-oc2-kernel-count-2026-06-23.md`
...
File: `explorations/representation-theory-noncompact/oq3b-tau-correction-closure-2026-06-23.md`
...
File: `explorations/cycle-gates-and-audits/distler-garibaldi-precision-carveout-2026-06-23.md`
...
File: `explorations/time-as-finality-crosswalk/h3-gap1-nac-sbp-no-lhv-theorem-2026-06-23.md`
...
File: `explorations/analytic-index-fredholm/oq-kk1-rs-fiber-wavefunction-2026-06-23.md`
...
File: `explorations/cycle-gates-and-audits/gu-testable-predictions-2026-06-23.md`
...
File: `explorations/generation-sector/oq-rk1-rs-rank-first-principles-2026-06-23.md`
...
File: `explorations/analytic-index-fredholm/oq-rk2-aps-boundary-rs-k3-2026-06-23.md`
...
File: `explorations/geometry-curvature-emergence/rfail-non-umbilic-schwarzschild-2026-06-23.md`
...
File: `explorations/generation-sector/oq3b-literature-verification-2026-06-23.md`
...
File: `explorations/dark-energy-cosmology/theta-field-flrw-eos-2026-06-23.md`
...
File: `explorations/time-as-finality-crosswalk/h3-gap2-f2-pati-salam-bipartite-2026-06-23.md`
...
File: `explorations/time-as-finality-crosswalk/h3-gap2-gu-universality-2026-06-23.md`
...
File: `explorations/geometry-curvature-emergence/rfail-schwarzschild-oq2-weak-field-2026-06-23.md`
...
File: `lab/active-research/signed-readout/theorem-statement-v1-2026-06-23.md`
...
File: `explorations/type-ii1-spectral/type-ii1-twisted-real-structure-2026-06-23.md`
...
File: `explorations/analytic-index-fredholm/oc2-b-parametrix-y14-2026-06-23.md`
...
File: `explorations/analytic-index-fredholm/oq-kk1a-cas-norm-fiber-wavefunction-2026-06-23.md`
...
File: `explorations/time-as-finality-crosswalk/cross-program-gu-taf-coefficient-2026-06-23.md`
...
Scope: `explorations/geometry-curvature-emergence/rfail-schwarzschild-oq2-weak-field-2026-06-23.md` and `canon/schwarzschild-weak-field-rfail.md`
...
Files modified: `explorations/geometry-curvature-emergence/rfail-schwarzschild-oq2-weak-field-2026-06-23.md`, `canon/schwarzschild-weak-field-rfail.md`

---

### vz-14d-mixed-covectors correction (2026-06-23) [VZ-02]
Issue: VZ-02 (moderate severity). The `B E^{-2} C` formula in §5 of `explorations/vz-evasion/vz-14d-mixed-covectors-2026-06-23.md` stated explicit numerical coefficients `2842`, `98`, `203/7` with no derivation trace, no reference to a prior repo file, and no CAS verification. These numbers were sourced from `vz-oq1-sr-squared-identity-2026-06-23.md`, which was not yet committed to the repo and could not be independently verified.
...
File: `explorations/vz-evasion/vz-14d-mixed-covectors-2026-06-23.md`
...
File: `explorations/vz-evasion/vz-e-block-direct-clifford-2026-06-23.md`
...
File: `explorations/analytic-index-fredholm/oc2-sobolev-a1-bounded-transform-2026-06-23.md`
...
File: `explorations/geometry-curvature-emergence/pc5-higgs-su2l-u1y-gate-2026-06-23.md`
File: `explorations/cycle-gates-and-audits/rank-one-archive-supersession-index-2026-06-23.md`
...
File: `explorations/time-as-finality-crosswalk/h3-chsh-four-patch-fixture-2026-06-23.md`
...
File: `explorations/type-ii1-spectral/type-ii1-exit-cs1-af-embedding-2026-06-23.md`
...
**Changes applied to `explorations/vz-evasion/vz-14d-mixed-covectors-2026-06-23.md`:**
...
**File corrected:** `lab/active-research/signed-readout/theorem-statement-v1-2026-06-23.md`
...
**Discipline:** the assembly code (tests/oq_rk1_e_rs_eff_assembly.py) hard-refuses to fabricate E_RS^eff — the all-slots-present branch raises RuntimeError rather than inventing the quotient (anti-FC4-HOLONOMY-01). Files: explorations/generation-sector/oq-rk1-e-rs-eff-specification-2026-06-26.md, tests/oq_rk1_e_rs_eff_assembly.py.
...
- **(A) KILLED — GU's shiab is NOT the codifferential d_A* [SHIAB-A].** Built both explicitly: the canon Clifford-contraction shiab Phi is Clifford-ODD (single generators c(e^a), anticommute with omega), the codifferential symbol is Clifford-EVEN (identity on S) — so they cannot be proportional; `||Phi - lambda*d_A*|| = full norm` for the best lambda=0, `<d_A*, Phi> = 0` forced by Tr(gamma)=0. Confirms this file's SC1 §3.5 distinction; REFUTES the perspective-sprint "adjointness forces shiab=(d_A)*" convergence (the FHE/probabilist selector argument fails on parity grounds). `||Phi||_F = sqrt(91*2*128) = 152.63` (exact). Independently reproduced with a fresh recursive-doubling rep.
...
Built an EXPLICIT basis of the SHIAB-03 family (null space of the stacked equivariance constraints; map-span rank = 2 per chiral block = 4 complex / 8 real; canon shiab = pure Clifford-trace channel, coords (1,0,1,0); two channels = Clifford-trace (S+) and Rarita-Schwinger (omega_1+omega_6); quaternionic J verified J^2=-I, [J,Cl]=0). Then tested five candidate SELECTORS by computing the surviving dimension of the family under each (compute -> adversarial verify; verifier re-ran all code + independently re-derived the headline FOUR ways; verdict mildly_overstated / land_with_fixes — one isolated side-bug, fixes folded in; headline sound). Files: explorations/shiab-operator/shiab-selector-search-2026-06-26.md, tests/shiab_family_basis.py, tests/shiab_selector_{complex_closure,sp64,seesaw_selfadjoint,quaternionic_Hlinear,gamma_trace}.py.
...
The topological gate (the repo's own S_XCharacteristicClassPacket_V0): does the GLOBAL Y14 object supply C2's ~94%? Design -> Build -> adversarial Kill over 3 approaches (ch2 from Codazzi, APS eta for the real operator, the C2<->index audit); ALL genuine=True, target-import clean, no blocked shortcuts, reproduced; load-bearing facts independently re-derived in the main loop. No canon change. Synthesis: explorations/anomaly-and-bordism/topological-edge-c2-not-an-index-2026-06-27.md.
...
Next gate from SOURCE-02: build the ACTUAL gimmel curvature on Y14=Met(X4), restrict to the physical section's null cone (Joe's "slice we live in"), test whether it drives C2 (155.36) to 0. Design -> Build -> adversarial Kill over 3 curvature approaches; ALL THREE C2_FLOORS_NEEDS_GLOBAL, genuine=True, all guards held, reproduced on re-run; structural core independently re-confirmed in the main loop. No canon change. Synthesis: explorations/anomaly-and-bordism/c2-is-global-y14-end-data-2026-06-27.md.

**(1) Clean NEGATIVE: local/fiber curvature is insufficient.** The genuine so(9,5) gimmel curvature 2-form (assembled a-priori from the ii-s Christoffels / Willmore RY_block; reads only eta + Christoffels, rebuild defect 0.0; non-equivariant 1.87; so(9,5) defect 9e-16) does NOT drive C2 down: floors at ~152.5 (~1.8% dent), increases to 167.3 at natural scale. Cleanest diagnostic: a-priori floor over ALL planes = 155.36 = exactly bare (0% drop); even a cheating C2-reading solve reaches only 6.2%, so ~94% of C2 (145.68 of 155.36) is GLOBAL/topological residual. Structural reason (independently re-confirmed, tests/c2_holonomy_global_obstruction.py, ~10s): C2 is Gamma-independent and a holonomy carrier B_W=Gamma(id(x)G_W) cannot pull it below bare -- 8 random so(9,5) holonomies x 3 scales gave min 303.42 (0/24 below bare). Anti-trap held (58.72), s^2 nonvacuous, carrier a-priori (not fixed-solve). HONEST SCOPE: proves local insufficiency; does NOT prove global end-data reconciles C2.

**(2) Joe's "slice we live in", honest verdict.** The physical null cone (light cone of eta) is structurally distinguished -- null plane (152.53) beats spacelike (155.36 = bare, no effect) -- but its effect is tiny and not uniquely privileged at the local level (null 152.53 ~ timelike 152.52). The slice matters, but GLOBALLY (the section's global/topological structure), not in its local light cone.

**(3) CONVERGENCE (loop closed).** C2's final obstruction is ~94% global => needs the non-compact Y14 end-data = boundary holonomy / spectral section (K3 chi-gate / APS). This is EXACTLY where Joe's record-issuance-boundary idea landed (record-issuance-boundary-selector-2026-06-26.md), which the discipline had parked as "lands on the non-compact index, not the shiab/source-action". It was NOT decoupled: the source action's final obstruction C2 IS ~94% the global index / boundary-spectral-section structure. The source-action line and the boundary-index line are the SAME global object: source action's C2 = boundary spectral section (record-issuance) = global Y14=Met(X4) topology (K3 chi-gate/APS). Joe's boundary idea was pointing at the global half all along. NEXT GATE is topological/index-theoretic (not algebraic): compute the boundary eta-invariant / spectral-section holonomy around the non-compact Y14 end and test whether it supplies the ~94% of C2 the local curvature cannot -- where record-issuance-boundary and source-action become one computation.
...
**VZ-FCVZ4 — 4D subprincipal leg: causal in the symmetric model, BLOCKED on the RS action.** tests/vz_fcvz4_subprincipal.py. (Its adversarial-verify agent failed its retry cap, so I reviewed it directly: it runs, all assertions pass, and it is honestly under-claimed.) After eliminating the gamma-trace constraint the reduced RS symbol S_R = A_1 - B E_0^{-1} C has top-order sigma_2 = -B_1 E_0^{-1} C_1 with II_s strictly subprincipal IF the entanglement identity (sigma_2 non-degenerate) holds => causal; if sigma_2 degenerate, spacelike characteristics are possible (explicit example). Round-S^4 SO(4) isotropy forces II_s ~ g (covariant, necessary-not-sufficient). Confirms causality + GR limit in the symmetric model and PINS the exact missing object (the D_GU 0/1 coefficients + constant E-block + II_s inserts), all of which are BLOCKED on the GU RS action on Y14 — the SAME object as FC-VZ-1 and the keystone SOURCE-01. Verdict UNCHANGED (CONDITIONALLY_RESOLVED); does NOT close FC-VZ-4. This independently re-confirms the keystone's conclusion that the RS action is the single binding object.

**ANOMALY-04 — the LOCAL anomaly I_16 does NOT Green-Schwarz factorize (conditional negative result).** tests/sp64_octic_trace_i16.py. Building on the verified [A-hat(TY14)]_16: the Sp(64)-fundamental octic is Str_S F^8 = 2 P_4 with ZERO reducible part and P_4 an INDEPENDENT primitive Casimir at rank 32 (Jacobian rank 4); the gravitational tr R^8 coeff is the verified -1/2419200 != 0. Under the assumed chiral content Omega^0(x)S^+ + Omega^1(x)S^- (net weight n_+-n_- = 1-14 = -13) BOTH irreducible degree-16 channels are nonzero => local_factorizable = False. Cross-checks UNUSUALLY STRONG (verify: LAND, not theater): the spinor-trace machinery validated TWO independent ways (root power-sums AND explicit Jordan-Wigner Clifford matrices) on SO(10) T(16)/T(10)=2 and SO(12) T(32)/T(12)=4 to ~1e-16, and the SO(N) adjoint reductions reproduce the FAMOUS structural zeros SO(32) order-6 = 0 and SO(128) order-8 = 0. ROBUST LEG: the GRAVITATIONAL channel alone (independent of the contested Sp(64)-vs-Sp(1) gauge reading) makes local_factorizable=False as long as n_+ != n_- (1 vs 14). CONDITIONAL on the assumed content + gauge reading; the global eta/Dai-Freed/bordism leg stays OPEN. A non-factorizable local anomaly is a NEGATIVE result for anomaly-freedom, deliberately under-claimed.

**DARK-ENERGY-03 — found the FLRW theta sign-confusion bug; both prior numbers wrong; data-facing sign stays OPEN.** tests/theta_flrw_desi_sign.py (real scipy.solve_ivp DOP853 in full Lambda-CDM, slow-roll attractor IC). The sign-confused exploration (theta-field-flrw-matter-era-ode-2026-06-23.md) HARDCODED d ln(rho_B)/dz = 3 (matter scaling); the real instantaneous z=0 value is +4.229. BOTH prior numbers are wrong (the de Sitter -1.80 AND the matter-era +1.17). Honest f0-independent ratio w_a/(w_0+1) = +2.339 +/- 7.6e-6 (POSITIVE), wB(0)=+0.410. 5 cross-checks pass (analytic slow-roll limit diff=0.0; ODE residual 8.9e-9; z_start 10/30/100 convergence; Richardson; direct-w_DE). STAYS OPEN: the data-facing sign sub-question (FC5/OQ3-A) is definition-dependent (instantaneous-z=0 w_a is positive) and the canon verdict stays OPEN on the structural source-action leg. Verify: LAND_WITH_FIXES (node-map relabel applied).

**RFAIL-03 — Willmore-Schwarzschild: derivative-count inconsistency resolved + O(M) mean curvature vanishes; verdict NOT flipped.** tests/willmore_el_schwarzschild_order.py (sympy + numeric FD). Computed B^V directly from the ii-s graph-Hessian formula: **B ~ M/r^3 is CORRECT, the rfail-non-umbilic H ~ M/r^2 is WRONG** (off by one derivative; dimensionally [1/L] vs [1/L^2]). NEW fact both canon notes missed: the O(M) mean curvature H = box(h) VANISHES identically (M/r is harmonic, Laplacian(1/r)=0), so leading H is O(M^2) ~ M^2/r^4 (numeric slopes 2.000/-4.000). The ambient gimmel-Riemann tensor IS computable from the existing Christoffels and has a nonzero O(1) M-independent mixed block, so it is NOT the bottleneck. The canon verdict (RFAIL-02) is NOT flipped: the residual order is localized onto the one unwritten object (the int|II|^2 EL ambient term). Verify: LAND_WITH_FIXES (X4 independence wording corrected). Cascade pending: rfail-non-umbilic H-scaling correction.

---

### SOURCE-01 — keystone run on the GU source action: the obstruction is causality-required; the ghost must be non-equivariant; the missing object's shape is pinned (2026-06-27)

Keystone workflow (Constrain -> Survey -> Attempt -> adversarial Kill) on the root blocker — the unwritten RS/IG source action that gates SHIAB-04 + generation count + RS-BRST + dark-energy. The source action stays unwritten (genuine missing physics), but three real results landed. No canon change; no promotion. Synthesis: explorations/firewall-and-two-geometries/source-action-necessary-conditions-and-causality-2026-06-27.md; computation: explorations/rs_source_candidate_projected_differential_scratch.py (re-run in main loop, all anchors reproduced).

**(1) The central obstruction [Pi_RS, M_D] != 0 (58.72) is CAUSALITY-REQUIRED — a proposed unification of RS-BRST with Velo-Zwanziger.** The clean no-ghost stabilization needs CONSTRAINT-PRESERVATION [Pi_RS,M_D]=0; the repo's operator identity gives [Pi_RS,M]=0 <=> ker(Gamma) is M-invariant <=> RS decouples as a standalone module. But canon/no-go-class-relative-map.md (F6, lines 365/377/434) says GU evades Velo-Zwanziger PRECISELY because RS does NOT decouple ("GU lies in the domain but not the image of the minimal-coupling functor"). So [Pi_RS,M_D]=0 would push GU into the VZ class => acausal (no guardian). Hence the obstruction is the non-decoupling that keeps GU causal; the ghost is mandatory because the clean quotient is acausal. RS-BRST and VZ are the same constraint. STATUS: strong structural argument (both premises in-repo, adversarially sourced), pending an independent VZ-characteristic check — NOT a theorem.

**(2) In-rep proof the ghost must be NON-EQUIVARIANT (the two-level escape).** The minimal candidate d_RS,-1^phys = Pi_RS o d_A annihilates the obstruction at gradient level (||Gamma.Pi_RS d_A(gauge)|| = 1.6e-14 — but this is the tautology Gamma.Pi_RS=0, zero content) while the escape REAPPEARS one level up: ||[Pi_RS,M_D]|| = 58.72, ||(I-Pi_RS) M_D Pi_RS(gauge)|| = 169.19. Since Pi_RS o d_A is a composite of equivariant maps it sits in the exact class SHIAB-04 proved cannot close. So the compensator sigma_c(xi) must live OUTSIDE the Spin(9,5)-equivariant family, acting where [Pi_RS,M_D]=58.72 mixes. Killed 3 ways (survives=0), by design. Reproduced repo anchors 343.73 / 58.72 / 215.85; H-linearity exact (0.0).

**(3) New exact fact + pinned shape.** The unique gamma-traceless (constraint-preserving) coupling is wedge − 6·contract (t* = −1/6, residual 0.0); canon shiab (1,0,1,0) is gamma-traceFUL (215.85), so constraint-preservation and GU's written shiab are JOINTLY UNSATISFIABLE — any constraint-preserving source action must revise (1,0,1,0). The missing object's shape: a BV action S_IG^susy with (S,S)=0, whose Noether-2 identity delta_2 o d_RS,-1 = 0 FORCES the projector (vs imposing it by hand), the gamma-trace constraint realized cohomologically via the non-equivariant sigma_c(xi), carrying a local-SUSY VZ guardian. Survey: the ONLY candidate mechanism is local-SUSY/super-IG (Weinstein's "Caveat Emptor" direction); Fang-Fronsdal gives only the destabilized skeleton, Vasiliev is machine-distinct (no M(64,H) truncation, needs AdS), Stueckelberg/BRST needs the action as input. Next concrete move: construct a candidate non-equivariant sigma_c(xi) and test (I−Pi_RS)(M_D+sigma_c)Pi_RS=0 with s^2=0 on the explicit rep.
...
**(A) Wide heterodox-lead sweep across all three repos.** Mined the perspective goals + exploration fields of gu-formalization + time-as-finality + temporal-issuance for UNISSUED HETERODOX potential selectors (7 miners -> 43 raw -> 23 ranked -> adversarial verify). **0 survivors.** Every promising lead was (a) already pursued (the repo is more thorough than it looks — the "dark-energy xi-coupling one-shot", the "demote the RS index split", and the "residual gauge orbit = observer" candidates were all already executed), (b) orthodox dressed as heterodox (finite spectral triple for PO1 = the program's own prescribed NCG path; w2/APS spin-selection = APS is already the workhorse), or (c) a rename of a buried lead / collapses to the source action. Two highest-scored unverified candidates killed on closer check: **Kostant cubic Dirac** (claimed to route around the source action via an algebraic `D^2=Cas_g-Cas_h+const`) re-hits the **3!=2 equal-rank wall** the repo already proved fatal to the analytic Dirac (and smuggles back an undetermined coefficient module = the missing source content); **distortion-residue port** returns identically zero because the shiab family is *already* the gauge-equivariance quotient. Net: **the side-routes are exhausted; the binding constraint is unambiguously the unwritten GU source action**, which gates SHIAB-04 + generation count + RS-BRST + dark-energy Assumption 3 at once.

**(B) Joe's hypothesis (chat): "the issuance of records creates a boundary; that boundary is the object we want."** Formalized into 4 readings (APS/eta boundary; finality-superselection wall; TI Issue/Finalize-as-boundary; projection connecting-map), tested, adversarially verified. **Genuinely NEW IN KIND but RETARGETED.** The APS spectral object (eta-invariant, spectral section / boundary holonomy `rho: pi_1 -> U(16)`) is a global spectral datum, NOT a bulk fiberwise condition — it is the one idea that escapes the bulk-selector graveyard, and the mapping is apt (`P_{>=0}` = the non-invertible projection of PO1's "failure to reverse"; `eta` = quantitative irreversibility; spectral section = "which modes finalize" = the issued record). **BUT it lands on the non-compact INDEX (generation-count well-definedness), not the shiab.** As a shiab selector it is **NULL**: `eta=0` exactly on the only computable toy (round S^3, flat AND homogeneous-curved S(6,4); `ind-top-eta-s3-aps-2026-06-23.md` lines 272/357), and the shiab->boundary channel is the `S(6,4)` curvature = the source-action distortion `theta`, so PART B of the test cannot even be set up without the source action. Decisive documentary check (run): `temporal-issuance/FORMAL-OBJECT.md` carries **no** U(16)/Z_p/spectral-section datum that could BE a boundary holonomy (its `rho_n` is the realization/access map, not a holonomy rep) — so record-issuance is coordinate-blind, exactly the prior leftover-space finding. Verifier: `VOCABULARY_DEAD` as a shiab selector; REAL but already-partly-built as an index well-definedness handle that ADDS a free boundary parameter (`rho`) rather than removing one. See explorations/time-as-finality-crosswalk/record-issuance-boundary-selector-2026-06-26.md.

**(C) Roadmap.** A companion repo-state assessment (5 lenses, adversarially theater-filtered) produced the prioritized, source-action-independent next steps now in lab/roadmap/meaningful-next-steps-2026-06-26.md: pure-grav `I_16` + GS factorizability, FLRW high-z DESI sign, Willmore-EL Schwarzschild order, compile the Lean layer for real, de-theater the 81%-bookkeeping test suite. Also surfaced a real hygiene finding: 290/358 tests/ files are `hourly_*` self-asserting no-ops, and "certified" currently means only "a .lean file exists sorry-free" (nothing has ever been kernel-compiled).
...
**File corrected:** `explorations/type-ii1-spectral/type-ii1-twisted-real-structure-2026-06-23.md`
...
**File corrected:** `explorations/geometry-curvature-emergence/pc5-higgs-su2l-u1y-gate-2026-06-23.md`
...
**Changes applied to `explorations/geometry-curvature-emergence/pc5-higgs-su2l-u1y-gate-2026-06-23.md`:**
...
File: `explorations/vz-evasion/vz-oq-cas-e-block-inverse-matrix-2026-06-23.md`
...
File: `explorations/geometry-curvature-emergence/pc5-higgs-cas-clebsch-gordan-2026-06-23.md`
...
File: `explorations/analytic-index-fredholm/oq-rk2-aps-fc3-fc4-closure-2026-06-23.md`
...
File: `explorations/shiab-operator/sc1-oq1a-d7-clebsch-gordan-cas-2026-06-23.md`
...
|---|---|---|---|---|---|
| SC1-OQ1A D7 common-summand / Product B chirality exclusion | CONDITIONALLY_RESOLVED; `V(omega_1+omega_7)` excluded from `Lambda^2 tensor Delta^+` | OPEN; Product B table includes `V(omega_1+omega_7)` | 2104 Product B character audit plus replacement Hom-space computation not yet filed | `rg "sc1-oq1a|V(omega_1+omega_7)|Lambda^2 tensor Delta^+|Product B" RESEARCH-STATUS.md CANON.md DERIVATION-PROGRESS.md NEXT-STEPS.md canon papers` | `explorations/shiab-operator/sc1-oq1a-d7-clebsch-gordan-cas-2026-06-23.md`, `DERIVATION-PROGRESS.md`, `NEXT-STEPS.md`, `explorations/research-cycles/hourly-20260625-2104-cycle1-ig-product-b-d7-table-receipt-attempt.md`, `tests/research-cycles/hourly_20260625_2104_cycle1_receipt_attempts_audit.py` |
| SC1-OQ1A Product A finite-control packet | Product A packet missing / reconstruction-grade | CLOSED route-locally for Product A; selector identity OPEN | 2104 cycle 2 Product A character audit plus missing `SourceNaturalProductABRivalProjectorIdentity_V1` | `rg "SC1-OQ1A|Product A|Product B|common-summand|selector|K_IG" RESEARCH-STATUS.md CANON.md DERIVATION-PROGRESS.md NEXT-STEPS.md canon explorations/shiab-operator/sc1-oq1a-d7-clebsch-gordan-cas-2026-06-23.md` | `explorations/shiab-operator/sc1-oq1a-d7-clebsch-gordan-cas-2026-06-23.md`, `RESEARCH-STATUS.md`, `DERIVATION-PROGRESS.md`, `NEXT-STEPS.md`, `explorations/research-cycles/hourly-20260625-2104-cycle2-ig-product-a-finite-control-packet.md`, `tests/research-cycles/hourly_20260625_2104_cycle2_frontier_gates_audit.py` |
...
Applied to: `explorations/type-ii1-spectral/type-ii1-f6-jbridge-semifinite-twisted-2026-06-23.md`
...
File: `explorations/dark-energy-cosmology/theta-field-flrw-matter-era-ode-2026-06-23.md`
...
File: `explorations/geometry-curvature-emergence/cpa1-ambient-curv-cas-coordinate-2026-06-23.md`
File: `explorations/type-ii1-spectral/type-ii1-f6-jbridge-semifinite-twisted-2026-06-23.md`
...
File: `explorations/analytic-index-fredholm/oq-rs3-gu-vasiliev-comparison-2026-06-23.md`

---

### CORRECTION PC5-VERDICT-OVERSTATED (2026-06-23)
Verdict corrected: RESOLVED -> CONDITIONALLY_RESOLVED
The frontmatter verdict of `explorations/geometry-curvature-emergence/pc5-higgs-cas-clebsch-gordan-2026-06-23.md` was
...
**Severity:** CRITICAL
**File corrected:** `explorations/analytic-index-fredholm/oq-kk1a-cas-norm-fiber-wavefunction-2026-06-23.md`
**Verdict change:** CONDITIONALLY_RESOLVED -> OPEN
...
File: `explorations/analytic-index-fredholm/oq-kk1-bc1-jacobi-operator-parameters-2026-06-23.md`
...
File: `explorations/shiab-operator/sc1-oq2-split-signature-ellipticity-lemma-2026-06-23.md`
...
File: `explorations/dark-energy-cosmology/dark-energy-oq3a-slow-roll-ic-sign-2026-06-23.md`
...
File: `explorations/vz-evasion/vz-f5-hamiltonian-subsidiary-propagation-2026-06-23.md`
...
File: `explorations/dark-energy-cosmology/dark-energy-assumption3-variational-2026-06-23.md`
...
File: `explorations/time-as-finality-crosswalk/freed-hopkins-optionb-ksp-family-2026-06-23.md`
...
File: `explorations/generation-sector/oq-rk2-fc4-k3-holonomy-rank-2026-06-23.md`
...
File: `explorations/vz-evasion/no-go-velo-zwanziger-canon-entry-2026-06-23.md`
...
File: `explorations/misc/c-mpr-9tuple-object-morphism-2026-06-23.md`
...
File: `explorations/shiab-operator/pc1-spinor-spin77-shiab-2026-06-23.md`
...
File: `explorations/time-as-finality-crosswalk/freed-hopkins-xobs-sol-k3-moduli-2026-06-23.md`
...
File: `explorations/anomaly-and-bordism/anomaly-sp64-global-pi15-2026-06-23.md`
...
File: `explorations/dark-energy-cosmology/dark-energy-w-window-mechanism-2026-06-23.md`
...
File: `explorations/generation-sector/n4-ig-dimension-matching-2026-06-23.md`
...
File: `explorations/geometry-curvature-emergence/dd1-distortion-distinct-canon-sharpen-2026-06-23.md`
...
File: `explorations/type-ii1-spectral/type-ii1-fc-epsilon-prime-sign-2026-06-23.md`
...
File: `explorations/vz-evasion/no-go-velo-zwanziger-canon-entry-2026-06-23.md` (§1, §3.5, §3.6, §4, §5)
...
- `explorations/vz-evasion/no-go-velo-zwanziger-canon-entry-2026-06-23.md`: §2 citation of vz-schur corrected from "OQ3-V1/V2/V3 RESOLVED (4D principal-symbol evasion VERIFIED)" to "OQ3-V2/V3 RESOLVED, OQ3-V1 CONDITIONALLY_RESOLVED (constant-coefficient gauge only) ... 4D principal-symbol evasion CONDITIONALLY_RESOLVED, NOT VERIFIED"; the "4D leg is unaffected" clause corrected to note the 4D leg is independently CONDITIONALLY_RESOLVED via the OQ3-V1 flat-gauge limitation. (The file's §1 verdict prose had already been corrected to CONDITIONALLY_RESOLVED, naming the flat-gauge/curved-gauge open condition, by a concurrent pass.)
...
File: `explorations/vz-evasion/vz-schur-complement-2026-06-23.md` (frontmatter + §16/§18/§19); `canon/no-go-class-relative-map.md` (§2.5 line 317); `explorations/vz-evasion/no-go-velo-zwanziger-canon-entry-2026-06-23.md` (§2)
...
Issue: VS-3 (critical). Same-session contradiction with verdict not adjusted. `explorations/shiab-operator/sc1-oq2-split-signature-ellipticity-lemma-2026-06-23.md` (CONDITIONALLY_RESOLVED) hung its analytic-framework conclusion on part (iii) — "the Sp(64) gauge orbit is a PROPER subspace of NM(xi)" (a surviving pointwise physical quotient carrying SM field content) — and listed failure condition F5 as merely "OPEN (reconstruction)". A sibling file written the SAME session, `explorations/shiab-operator/sc1-oq2-f5-gauge-orbit-fill-2026-06-23.md` (CONDITIONALLY_RESOLVED), found the OPPOSITE by explicit CAS check: the gauge orbit FILLS NM(xi). Its own DERIVATION-PROGRESS entry already records that this "NAMES AN INTERNAL CONTRADICTION in the lemma (parts (ii) and (iii) are mutually inconsistent), resolved in favor of (ii)." The lemma file had not absorbed this: it retained part (iii) as live, kept F5 as a generic open gate, and presented the "physical subspace survives" claim throughout §5, §6, §7.3, §8, §9, §11.
...
Fix applied to `explorations/shiab-operator/sc1-oq2-split-signature-ellipticity-lemma-2026-06-23.md`:
...
File: `explorations/shiab-operator/sc1-oq2-split-signature-ellipticity-lemma-2026-06-23.md` (frontmatter, §5, §6, §7.3, §8, §9, §10, §11)
...
File: `explorations/vz-evasion/vz-f5-hamiltonian-subsidiary-propagation-2026-06-23.md` (§4.6(b), §4.7, §4.8, §4.10, §4.11, §6, §7, §8); `canon/no-go-class-relative-map.md` (§2.5 F5 row + F5-full failure-conditions status line)
...
File: `explorations/generation-sector/oq-rk2-fc4-k3-holonomy-rank-2026-06-23.md` (frontmatter + Sec 6.4, 9.2, 10.1, 10.2, 10.3, 11); `DERIVATION-PROGRESS.md` (oq-rk2-fc4-k3-holonomy-rank entry); `NEXT-STEPS.md` (OQ-RK2 block)
...
File: `explorations/generation-sector/oq-rk1-rs-rank-first-principles-2026-06-23.md` (frontmatter + body banner, §5.2, §10 Step 2 & Step 6, §11, §12, §13); `DERIVATION-PROGRESS.md` (oq-rk1-rs-rank-first-principles entry + this note)
...
Fix applied to `explorations/time-as-finality-crosswalk/freed-hopkins-xobs-sol-k3-moduli-2026-06-23.md` (no mathematics changed):
...
File: `explorations/time-as-finality-crosswalk/freed-hopkins-xobs-sol-k3-moduli-2026-06-23.md` (frontmatter; §1; §5.4; §7; §8 RC2 + new RC5/RC6/RC7; §10); `DERIVATION-PROGRESS.md` (freed-hopkins-xobs-sol-k3-moduli per-file index row + this correction note)
...
File: `explorations/shiab-operator/sc1-oq2-split-signature-ellipticity-lemma-2026-06-23.md` (frontmatter, §5, §6, §7.3, §8, §9, §10, §11); `explorations/shiab-operator/sc1-oq2-f5-gauge-orbit-fill-2026-06-23.md` (frontmatter, §1, §6, §7)
...
Issue: SC1-LEMMA-CONTRADICTION-SAME-SESSION (critical). A lemma is stated, an internal contradiction in it is found, and the contradiction is "resolved" — all in the same 2026-06-23 session — yet both files kept CONDITIONALLY_RESOLVED. This is exactly the pattern the loop's own adversarial log forbids: `lab/process/loop-adversarial-log.md` rule 3 — "an explicit internal contradiction in the body of a file is an open problem; block CLOSED or RESOLVED verdicts on any item containing one until the contradiction is resolved IN A SUBSEQUENT SESSION" — and the same log's calibration "(c) when an internal contradiction is explicitly identified in the computation, the verdict must be OPEN until the contradiction is resolved, not merely noted." Same-session self-resolution does not clear it (file separation is not a valid defense). The precedent is `oq-kk1a-cas-norm-fiber-wavefunction` (downgraded CONDITIONALLY_RESOLVED -> OPEN for an internal contradiction earlier the same day).

The two files:
- `explorations/shiab-operator/sc1-oq2-split-signature-ellipticity-lemma-2026-06-23.md` asserts part (iii): the Sp(64) gauge orbit is a PROPER subspace of NM(xi).
- `explorations/shiab-operator/sc1-oq2-f5-gauge-orbit-fill-2026-06-23.md` (same session) finds the orbit DOES fill NM(xi), "opposite to the prior split-signature ellipticity lemma's part (iii)," and explicitly NAMES an internal contradiction in the lemma (parts (ii) and (iii) mutually inconsistent).
...
File: `explorations/shiab-operator/sc1-oq2-split-signature-ellipticity-lemma-2026-06-23.md` (frontmatter, §5, §6, §7.3, §8, §9, §10, §11); `explorations/shiab-operator/sc1-oq2-f5-gauge-orbit-fill-2026-06-23.md` (frontmatter, banner, §6, §7); `DERIVATION-PROGRESS.md` (both index entries + this note); `NEXT-STEPS.md` (SC1 row)
...
Issue: VZ-14D-EVADED-VS-GATED-FC-VZ-1 (moderate). Hidden load-bearing assumption presented as a structural result. The Velo-Zwanziger fifth-theorem canon entry repeatedly stated the 14D evasion as "CONDITIONALLY_EVADED ... gated on E-block invertibility (FC-VZ-1)" while simultaneously asserting the operative mechanism as fact: the Schur-complement kernel argument "establishes `ker S_R^{14D}(xi) = 0` for all 14D non-null covectors" (§2.5 computation-chain cell; §5 closing posture). But `ker S_R = 0` is DERIVED via the Schur-complement formula `S_R = A - B E^{-1} C`, which is defined only when the E-block `E(xi)` is invertible — exactly the unproven precondition FC-VZ-1 ("`E(xi)` has nontrivial kernel for some non-null `xi` -> Schur complement undefined"). So the proof of the evasion assumes its own open gate. The entry was honest that FC-VZ-1 is "the single gap separating 14D from EVADED," and the GUARD (FC-VZ-1) block correctly flagged the E-block argument as same-session and externally unverified — but the prose in §2.5 and the closing posture (§5) presented the kernel argument as an established "reconstruction grade" result without foregrounding that the kernel result is identical to (not independent of) the very invertibility that is unverified. The source file confirms the circularity directly: `explorations/vz-evasion/vz-14d-mixed-covectors-2026-06-23.md` §correction (VZ-01) states "the `det(M) = det(E)·det(S_R)` identity requires `E` invertible as a precondition and cannot be used to prove `E` invertible without circularity," and its row table already carries the 14D `ker S_R = 0` line as "CONDITIONALLY_EVADED ... proof assumes E invertible; E invertibility not independently proved." The canon-level prose lost that single-claim framing.
...
### ENTRY WC-ENUM-COMPLETENESS (2026-07-02, located-not-forced publication gate) — Theorem 1's 7-item obstruction enumeration proven COMPLETE within a delimited covariant class C, every generator 2-primary, class boundary shown SHARP; failure condition did NOT fire

**Work card:** WC-ENUM-COMPLETENESS (`NEXT-STEPS.md`, 2026-07-02 publication-gating section; journal-gating, priority 1). Closes reviewer point 1 against `papers/candidates/located-not-forced/`: Theorem 1 was proof-by-enumeration over 7 obstruction classes (Kramers, mod-2 Witten index, cross-chirality Krein signature, adjoint index 4k, Rokhlin, spinor 2-smoothness, ghost parity), and completeness of that enumeration was an open, prominently-flagged conditionality.

**Result (outcome (i) with a sharply-stated boundary):** completeness is established at computed grade within a delimited class C = all structures on the fixed 192-dim generation carrier that are linear or antilinear in the carrier and equivariant under the sector's split symmetry `G = so(4) (+) so(10)` (real form `so(4) (+) so(5,5)`), built from the sector's own data (equivariant endomorphisms and their (graded) traces, invariant bi/sesquilinear forms and Krein signatures, equivariant antilinear intertwiners and Kramers signs, chirality-sector index integers, and characteristic classes from the sector's own bundle/gauge/boundary-eta/ghost data). **Route (a) — classification (computed):** the class-C generator spaces are exactly dim 2/2/2/2 under the full split covariance; every invariant form is purely cross-chirality; every antilinear structure is T-type (per-block `C^2 = -1` in (9,5), `+1` in (7,7)); and NO equivariant antilinear re-grading exists at all — which independently settles the equivariant core of WC-ANTILINEAR-BOUND. Robust down to `so(10)`-only covariance (spaces 72/72/72/72). **Route (b) — extension engine (exact arithmetic):** an adversarial sweep beyond the equivariant core (gauge twists, boundary/eta, compositions, dressed pairings) finds NO sector-interior odd-primary obstruction (category-D count 0) and shows the class boundary is SHARP, not vacuous — odd primes appear exactly at the first step OUTSIDE the sector's data (`54 -> 3`, `120 -> 7`, `126 -> 5*7`, `j=3/2` quartet `-> 5`; all category-C external). Bonus: GU's own quaternionic structure lands inside the computed class-C span, as it should. The card's failure condition (a covariant sector-interior structure imposing an odd-prime congruence) did NOT fire.

**Verified:** `tests/enum-completeness/enum_class_c_generators.py` (route (a) census; ~26 s, ENUM_STAGE=1/2 checkpoint split), `tests/enum-completeness/enum_extension_engine.py` (route (b); < 5 s, exact Fraction/integer arithmetic — Weyl dim / Casimir / Dynkin over D5, eta family, composition closure; exits nonzero on any category-D finding — none), `tests/enum-completeness/verify/indep_check.py` (independent re-check: own recursive-doubling gammas, `Cl(7,7)`, successive-SVD null space instead of normal-matrix eigh, the Euclidean `(14,0)` chirality-detecting control, exact weight-peeling Schur count; ~17 s). All three exit 0 this pass; census residuals 1e-12..1e-15, next-eigenvalue gaps O(1)-O(100); theorem-grade exact integer combinatorics for the same-chirality vanishing (`16x16` zero-weight count = 0).

**Verdict change:** NONE to any repo canon claim (generation count stays OPEN). Grade: computed + independently re-verified for the census; theorem-grade exact combinatorics for the same-chirality vanishing and exact Fraction arithmetic for the engine; the ghost-parity row is inherited from canon (not recomputed). Honesty guardrail: NOT a symbolic proof over an abstract axiom set — a machine-verified computation on the explicit carrier with printed spectral-gap/residual certificates; it upgrades Theorem 1 from "scoped to the enumeration" to "complete for the delimited class C, engine-swept," not to an unconditional impossibility over all conceivable obstructions. **Residual:** non-equivariant antilinear operators sit outside class C — that is exactly what WC-ANTILINEAR-BOUND then bounds (also closed 2026-07-02, entry below); function-space / Fredholm structures are WC-FUNCTION-SPACE-EXT.

**Result NOT promoted to CANON.md** (pauses for Joe per the card's process gate). Paper text NOT edited by this card (outcome (i)): the Theorem 1 wording upgrade to "complete for the delimited class C, engine-swept" is drafted in the RESULTS file and pauses for Joe with the promotion decision.
File: `canon/enum-completeness-class-c-RESULTS.md` (staged); cascade `NEXT-STEPS.md`, `papers/drafts/prepublish-review-tracker.md`, `papers/candidates/located-not-forced/STAGING-NOTES.md`; scripts `tests/enum-completeness/{enum_class_c_generators.py, enum_extension_engine.py, verify/indep_check.py}`

---

### ENTRY WC-ANTILINEAR-BOUND (2026-07-02, located-not-forced publication gate) — the antilinear non-existence leg upgraded from a finite adversarial hunt to a delimited index-nullity THEOREM; failure condition did NOT fire

**Work card:** WC-ANTILINEAR-BOUND (`NEXT-STEPS.md`, 2026-07-02 publication-gating section; journal-gating, priority 2). Closes reviewer point 3 against `papers/candidates/located-not-forced/`: the paper's caveat (d) antilinear leg was a finite adversarial hunt over an infinite-dimensional space (honest but not closed).

**Result (outcome (a)+(b) of the card menu):** the hunt is closed over a rigorously delimited class `S` = ALL Krein-compatible antilinear operators `C = M . conj` on the 192-dim generation carrier (`M^dag K M = lambda K-bar`, `lambda` real nonzero — the correct antiunitary condition for antilinear maps, which on this carrier IS ghost-pairing compatibility), with NO symmetry, frame, square (`C^2 = eps I`), or continuity assumption — the whole 73728-real-dimensional antilinear operator space, not a candidate list. A declared 9-rung symmetry-breaking ladder (full `so(4)+so(5,5)` down to symmetry-free) is decided per rung: the chiralizer *shape* (an antilinear chirality-swap) does not exist at all wherever the internal `so(5,5)` or its split Cartan survives (swap dim 0 at L0/L2/L2b/L3/L4 — proof, extends WC-ENUM-COMPLETENESS); where it exists with the frame `so(4)` intact (L1/L1b `so(9)` forms) every candidate is frame-trivial BY EQUIVARIANCE and strict admissibility is refuted by an exact closed-form C5 certificate; only the both-broken rung (L5) and below admit frame-active swaps. The symmetry-free bottom is closed by the **index-nullity theorem**: every `C` in `S` maps the chirality pair `(W_+, W_-)` to a K-Lagrangian pair (because the Krein form is purely cross-chirality, `W_±` are K-isotropic), so every physical (maximal K-positive, dim 96) subspace keeps net chiral index EXACTLY 0 under every admissible antilinear re-grading. Sharpest honest point (published, not suppressed): the hunted operator — a frame-non-trivial antilinear class-CII swap — **EXISTS** in `S` (closed-form witnesses for all four `(C^2, lambda)` sign patterns, frame charge ~19) and still forces nothing; existence was never the issue, Krein compatibility alone pins the index at 0.

**Verified:** `tests/antilinear-bound/antilinear_ladder_census.py` (per-rung antilinear Hom censuses, preserve/swap splits, frame charges, exact admissibility certificates; 36 asserts; ANTI_STAGE=1/2 checkpoint split for lifetime-capped sandboxes), `tests/antilinear-bound/antilinear_symmetry_free_bound.py` (the index-nullity theorem, closed-form witnesses, definiteness/isotropy transport, D1 continuity control; 133 asserts), `tests/antilinear-bound/verify/indep_check.py` (independent substrate: own recursive-doubling gammas, different (9,5) embedding/seed, Gram-eigenvalue ranks, EXACT integer weight/Clebsch reproduction of the full census dimension table, `Cl(7,7)` cross-signature, and a Euclidean `(14,0)` control that fires `|chi| = 96` to prove the cross-chirality premise is load-bearing — the theorem is not vacuous; 78 asserts). All three re-run this pass: EXIT 0, **247 hard asserts total, all passed** (census 36 = 16+20 staged; bound 133; verify 78).

**Verdict change:** NONE to any repo canon claim (generation count stays OPEN; nothing here forces or forbids three generations). Grade: proof-grade for the 5-line finite-dimensional index-nullity theorem with machine-certified premises (K Hermitian involution, signature (96,96), purely cross-chirality, `K Gamma_c = -Gamma_c K`) and adversarial instantiation; exact integer combinatorics for the census table; one search-grade cell flagged (strict A2+A3 at L5, not load-bearing — index nullity covers it). Honesty guardrail: this is a machine-verified computation bounding what the sector's antilinear operators can do to a chiral count on the explicit carrier — NOT a symbolic proof from an abstract axiom set and NOT a function-space statement; a formalization error in the pass's own first draft (`M^dag K M = lambda K` instead of `lambda K-bar`; `K` is genuinely complex here, `||Im K|| = 10.4`) was caught and fixed before any result was recorded. **Residual (one sentence):** outside `S`, admissibility itself fails — non-Krein antilinear operators do not act on the sector's physical states (computed control maps a physical subspace to an indefinite-Gram image) — and the function-space setting (sections, Fredholm, spectral flow) is the separate card WC-FUNCTION-SPACE-EXT.

**Result NOT promoted to CANON.md** (pauses for Joe per the card's process gate). Paper edited v2.5.2, both copies, minimal (caveat (d), abstract, intro item 3, Section 6, status table, conclusion). Publication stays DEFERRED (flips only on Joe's review of both gates).
File: `canon/antilinear-bound-RESULTS.md` (staged); paper `papers/candidates/located-not-forced/located-not-forced-generation-count-2026-06-29.{md,tex}` (v2.5.2), `papers/candidates/located-not-forced/CHANGELOG-v2.5.2-antilinear-bound.md`; cascade `NEXT-STEPS.md`, `papers/drafts/prepublish-review-tracker.md`, `papers/candidates/located-not-forced/STAGING-NOTES.md`; scripts `tests/antilinear-bound/{antilinear_ladder_census.py, antilinear_symmetry_free_bound.py, verify/indep_check.py}`

---

### ENTRY WC-ENUM-COMPLETENESS (2026-07-02, publication-gating card 1) — Theorem 1's 7-item obstruction enumeration is COMPLETE within a delimited class C (computed grade); extension engine finds no sector-interior odd-primary escape; class boundary shown SHARP

**Target:** the located-not-forced paper's Theorem 1 conditionality ("completeness of the enumeration is open"), work card WC-ENUM-COMPLETENESS in `NEXT-STEPS.md` (journal-gating, priority 1). Outcome (i) of the card's honest-outcome menu, with the class boundary stated sharply.

**Route (a), computed:** class C = all (anti)linear structures on the 192-dim `j=1` carrier equivariant under the split symmetry `so(4) (+) so(10)` (real form `so(4) (+) so(5,5)`), built from the sector's own data (intertwiners, bilinear/sesquilinear forms, their index integers, and the characteristic classes of its spin/gauge/boundary/ghost data). ALL generator spaces computed exactly on `Cl(9,5)`: commutant/antilinear/bilinear/sesquilinear = 2/2/2/2 (= span(Id, Gamma_c); one T-structure per chirality block; the Krein pair), every invariant form purely cross-chirality (with the exact-integer torus proof: 16x16 zero-weight-sum count = 0), every antilinear structure chirality-PRESERVING and quaternionic per block (C^2 = -1: Kramers Z/2), index-integer lattice {0, +-96, 192} all even, dim Hom(W+, W-) = 0. Robust under shrinking the covariance to `su(2)_+ (+) so(10)` (8/8/8/8) and to `so(10)` alone (72/72/72/72). **Key computed correction (reported, not patched):** the split/quaternionic internal real forms make the 16 self-conjugate, so NO chirality-swapping equivariant antilinear (AZ-CII re-grading — the one antilinear escape shape) exists in class C at all, in (9,5) or (7,7): sharper than the paper's finite adversarial hunt within the delimited class, and it settles the equivariant core of WC-ANTILINEAR-BOUND (residual = the non-equivariant remainder). GU's own `J_quat` compresses INTO the computed span (distance 1.1e-13).

**Route (b), exact arithmetic:** engine categories A (sector-available 2-primary) / B (odd-primary but homotopy-fixed = the located carrier `e_R = 1/12` in `-p_1/24`) / C (external: VEV, non-sector twist, added symmetry) / D (sector-interior odd-primary obstruction = kill). **Category-D findings: NONE.** Sector gauge twists (1, 10, 16, 16bar, 45) give Dynkin congruences {0, 1, 2, 2, 8} — 2-primary or vacuous; odd primes appear at the FIRST step beyond the sector's data (54 -> 12 = 2^2*3, 120 -> 28 = 2^2*7, 126 -> 35 = 5*7, 144 -> 34 = 2*17; family j=3/2 -> 10 = 2*5, excluded by the leg3 embedding enumeration): the boundary is sharp, not vacuous. eta_q family 2-primary for all q (odd numerator / 2^3); compositions of the items' moduli closed 2-primary (exhaustive); gauge-dressed same-chirality pairings: exactly 0 for R = 1/10/45 (exact zero-weight counts), torus-possible for R = 16 but VEV-gated (external spurion, consistent with SHIAB-05). Dai-Freed rows flagged from-memory; the 3-primary ones all require data the sector lacks (Z/3 deck group — the spine is RP^3 = L(2;1); global Z_9).

**Verified:** `tests/enum-completeness/enum_class_c_generators.py` (~26 s, ENUM_STAGE staging for capped sandboxes), `tests/enum-completeness/enum_extension_engine.py` (< 5 s, Fraction-exact, exits 1 on any category-D), `tests/enum-completeness/verify/indep_check.py` (~17 s; independent gammas/signature/algorithm + (14,0) chirality-detecting control + exact weight-peeling Schur count). All exit 0 this pass; residuals 1e-12..1e-15.

**Verdict change:** Theorem 1's conditionality upgrades from "enumerated list, completeness open" to "complete for delimited class C (computed grade), engine-swept, boundary sharp." Paper text NOT edited (outcome (i), not (iii)); RESULTS staged at `canon/enum-completeness-class-c-RESULTS.md`; CANON.md promotion and any paper-wording upgrade PAUSE FOR JOE. Honesty guardrails: machine-verified computation on the explicit carrier, not a symbolic proof from axioms; ghost item (7) inherited from canon, not recomputed; class C excludes non-equivariant operators (the hunt's domain) by construction.
...
### ENTRY WC-ANTILINEAR-BOUND #2 ADDENDUM (2026-07-02) — the antilinear admissible class is the null-eigenspace class P_iso (strictly larger than the Krein-compatible S); index nullity holds on all of it; computed + independently re-verified

**Target:** adversarial-review criticism #2 against the located-not-forced paper -- the delimited Krein-compatible class S (`M^dag K M = lambda K-bar`) leaves a loophole ("could an operator evade S while still acting on the physical chiral sector?").

**Result (computed + independently re-verified):** the index-nullity proof used only that the re-graded chirality eigenspaces `C(W_+), C(W_-)` are K-null (Lagrangian) -- never the full Krein condition. So the admissible class is the strictly larger null-eigenspace class `P_iso = { antilinear C : C(W_+), C(W_-) K-isotropic }` (the intrinsic mark of a chirality re-grading, since the ORIGINAL chirality's own eigenspaces `W_+/-` are K-null), and index nullity `chi_C(P) = 0` holds on all of it. Non-Krein members were CONSTRUCTED (re-graded eigenspaces = an arbitrary complementary K-Lagrangian pair from the Lagrangian Grassmannian; Krein residual order 1, eigenspace isotropy < 1e-8) and are still index-null. A nonzero count requires a K-DEFINITE re-grading, which is not a chirality (it grades physical-vs-ghost, carrying the vectorlike `+-96`) and does not act on the physical sector. This corrects the paper's earlier residual "outside the Krein class admissibility fails" (too strong) to "a nonzero count needs a K-definite non-chirality re-grading."

**Verified:** `tests/antilinear-bound/nonkrein_physical_admissibility.py` (61 hard asserts, exit 0); independent re-check `tests/antilinear-bound/verify/nonkrein_indep_check.py` (69 hard asserts, exit 0) on OWN recursive-doubling gammas + a different seed + `Cl(7,7)` cross-signature, with a Euclidean `(14,0)` premise-failure control firing `|chi| = 96` (the null-eigenspace hypothesis is load-bearing; the theorem is not vacuous). Grade: computed + independently re-verified -- same as the main bound.

**Verdict change:** the index-nullity theorem itself is unchanged; its stated SCOPE widens from S to P_iso. Paper edited v2.7 (both copies: caveat (d), abstract, intro item 3, Section 6, status table, conclusion; `CHANGELOG-v2.7-antilinear-nonkrein.md`). RESULTS staged at `canon/antilinear-nonkrein-admissibility-RESULTS.md`; **CANON.md promotion PAUSES FOR JOE**. Honesty guardrails: finite-dimensional kinematics on the explicit carrier (not a symbolic proof from axioms); two self-corrections during the pass (isotropy is a Krein-FORM condition, not operator-anticommutation; `Gamma_C = M conj(Gamma_c) M^{-1}`, the `conj` load-bearing) are recorded in the RESULTS Integrity section; the QFT effective / non-perturbative (function-space) half of #2 remains the open WC-FUNCTION-SPACE-EXT.
File: `canon/antilinear-nonkrein-admissibility-RESULTS.md` (staged); paper `papers/candidates/located-not-forced/located-not-forced-generation-count-2026-06-29.{md,tex}` (v2.7), `papers/candidates/located-not-forced/CHANGELOG-v2.7-antilinear-nonkrein.md`; scripts `tests/antilinear-bound/nonkrein_physical_admissibility.py`, `tests/antilinear-bound/verify/nonkrein_indep_check.py`; cascade `NEXT-STEPS.md`, `papers/drafts/prepublish-review-tracker.md`, `papers/candidates/located-not-forced/STAGING-NOTES.md`

---

### ENTRY WC-FUNCTION-SPACE-EXT CONDITIONAL THEOREM (2026-07-02) — Theorem 2 + the antilinear bound extend to the section / spectral-flow setting as a conditional theorem; residual precisely localized to APS/end + family-index; computed + independently re-verified

**Target:** WC-FUNCTION-SPACE-EXT (`NEXT-STEPS.md`, post-publication card), the residual named by reviewer criticisms #2 and #3 and by Theorem 2's finite-dimensional scope. The "bigger swing" (Joe-authorized), advancing the earlier finite-Galerkin FIRST PROBE to a conditional theorem.

**Result (conditional theorem, computed + independently re-verified):** on a genuine 1D lattice Dirac section model (cross-chirality Krein space, `Gamma = sigma_3 (x) I`, `K = sigma_1 (x) I`, `P = -i d/dx`), every norm-continuous family of self-adjoint, chirality-odd (Dirac), Krein-self-adjoint (`D^dag K = K D`), Fredholm operators takes the form `D = sigma_1 (x) B` (proof: `Gamma`-odd + `K`-self-adjoint with `K = sigma_1` forces `D = [[0,B],[C,0]]`, `C = B^dag` self-adjoint, `B = C^dag` Krein => `B` Hermitian). Hence the spectrum is symmetric about 0, the negative (physical) sector is chirality-balanced (`n_-(t) = tr(Gamma P_<0) = 0`), and the **net chiral spectral flow is EXACTLY 0** through genuine zero crossings (non-vacuous). Control: a Fredholm family with nonzero integer net chiral spectral flow necessarily violates Krein-self-adjointness (and is `Gamma`-even, not a chirality operator). This is the section analog of the finite Theorem 2 (physical sector chirality-balanced because `K` is cross-chirality).

**Verified:** `tests/function-space-ext/dirac_spectral_flow_section.py` (20 asserts, exit 0; central-difference momentum; `n_-(t)=0` through 20 crossings; spectrum symmetric to 0.0); independent re-check `tests/function-space-ext/verify/dirac_spectral_flow_indep_check.py` (129 asserts, exit 0; SPECTRAL/Fourier momentum, different seed, non-degenerate `B` confirming per-eigenvector chirality-neutrality EXACTLY at 8e-14, analytic `spec(sigma_1 (x) B) = +- spec(B)` at 2.5e-14, control). Grade: computed + independently re-verified conditional theorem (structural core is short finite-dim linear algebra per t; machine-certified premises).

**Verdict change:** the CARD moves from OPEN to a CONDITIONAL THEOREM with the residual precisely localized; the residual -- (a) gap well-posedness of the physical projection, (b) the APS/noncompact-end eta correction (can carry an unpaired chiral piece on a manifold with boundary; consistent with "external on present evidence"), (c) family-index/higher-topology terms -- remains genuinely OPEN. Paper edited v2.8 (both copies: Theorem 2 scope remark, caveat (d), Section 6, status table, conclusion; also fixed two v2.7 misses). RESULTS staged at `canon/function-space-index-conservation-RESULTS.md`; **CANON.md promotion PAUSES FOR JOE**. Honesty guardrails: the 1D Dirac model is a faithful but simplified stand-in for the RS-bundle setting; the interior/closed/gapped statement is established, the analytic boundary terms are not; internal tier (caveat (e)).
...
### ENTRY CORE THEOREMS SYMBOLIC PROOF (2026-07-02) — the core theorems proved at the STRUCTURE level over symbolic entries; grade-axis upgrade from computed-on-carrier toward proof-grade

**Target:** the caveat every RESULTS file carried ("machine-verified on the explicit 192-dim carrier, not a symbolic proof from axioms; a Lean/symbolic port would upgrade the grade"). The "grade upgrade" swing (Joe-authorized), the internal move on the verification-tier ladder's grade axis while the external reviewer is arranged.

**Result (symbolic / structure-level):** the index-nullity / index-conservation core (Theorem 2), the antilinear null-eigenspace bound (P_iso), the function-space `sigma_1 (x) B` form, and the 2-primary obstruction list are proved from the **axioms of a cross-chirality Krein space** (any dimension), with the load-bearing algebraic identities certified by **sympy to vanish identically for SYMBOLIC entries** (not numeric). Key steps: `K Gamma + Gamma K = 0` => `W_+-` K-isotropic => a K-positive P meets K-null subspaces only at 0 => `chi = n - n = 0` (dimension-independent); `Gamma`-odd + Krein-self-adjoint => `sigma_1 (x) B` => symmetric spectrum + chirality-neutral modes; each obstruction a power-of-two modular identity. 22 sympy identities, exit 0.

**Verified:** `tests/symbolic-proofs/core_theorems_symbolic_proof.py` (exit 0; 22 symbolic-0 certifications; py_compile clean, UTF-8). No Lean/Coq/Z3 in sandbox; the dimension-general step (`n - n = 0`) is the written proof, symbolically checked on `n=2` blocks.

**Verdict change:** GRADE axis upgrades for the core theorems (G-computed -> G-proof/symbolic); the "not symbolic from axioms" caveat is discharged for the core. VERIFICATION axis unchanged: still internal single-process (V3 ceiling); a Lean formalization and independent replication remain the V3->V4 crossing. Scope: finite-dimensional structural theorems only -- does NOT close the function-space analytic residual (APS/end, family-index). RESULTS staged at `canon/core-theorems-symbolic-proof-RESULTS.md`; **CANON.md promotion + the per-RESULTS grade-line and paper caveat (e) softening PAUSE FOR JOE.** Side fix: three session `.py` files had been saved as UTF-16 (null bytes) -- converted to UTF-8, py_compile clean.
File: `canon/core-theorems-symbolic-proof-RESULTS.md` (staged); script `tests/symbolic-proofs/core_theorems_symbolic_proof.py`; cascade the core RESULTS files' grade lines (pending Joe)

---

### ENTRY EXTERNAL TOPOLOGICAL INDEX = FLUX (2026-07-02) — the external topological datum carries the ODD chiral count; index = magnetic flux number, computed + independently re-verified; completes the boundary/APS side of WC-FUNCTION-SPACE-EXT

**Target:** the "bigger swing" (Joe-authorized) at the boundary/APS residual and the paper's "external on present evidence -- supplied by a net-self-dual chiral background (instanton zero-modes, flux, K3/CY)" conclusion.

**Result (computed + independently re-verified):** a 2D magnetic-flux Wilson-Dirac on a torus (Landau gauge + x-seam twist; `D = s1(x)Tx + s2(x)Ty + s3(x)(r*Wilson)`, `Gamma = s3(x)I`, cross-chirality `K = s1(x)I`) has **net chiral zero-mode index = magnetic flux number Phi** (Aharonov-Casher / Atiyah-Singer). `Phi = 1, 3, 5` give ODD indices. The interior/closed cross-chirality sector is forced EVEN (v2.8 conditional theorem + the 1D closed-parity note), and the ODD count enters ONLY through the external topological background -- which is ANY integer, NOT 2-primary-constrained, and NOT a selection of 3. The flux background breaks the interior Krein-self-adjoint class (Krein violation ~1.9). This decisively realizes and concretizes the paper's "external" conclusion. Full arc: interior even (2-primary) -> external index = flux = any integer.

**Verified:** `tests/function-space-ext/flux_index_2d.py` (7 asserts, exit 0; 16x16, Phi=0..3, index=Phi exactly, all zero modes one chirality); independent re-check `tests/function-space-ext/verify/flux_index_2d_indep_check.py` (7 asserts, exit 0; sizes 20x20, 24x24, flux up to 6, incl. odd 1,3,5). Both clean UTF-8.

**Verdict change:** NONE to any repo canon claim (generation count stays OPEN; nothing derives 3). Grade: computed + independently re-verified; STANDARD index theorem (index=flux), its value being to confirm/concretize the paper's external mechanism and pin the parity (interior even, external any-integer). Honest residual: the full APS/noncompact-end and family-index statement for the actual Rarita-Schwinger operator remains OPEN; the 2D flux torus is a faithful realization of the mechanism, not that RS operator. RESULTS staged at `canon/external-topological-index-flux-RESULTS.md`; **CANON.md promotion + any paper pointer PAUSE FOR JOE.** Also (superseded exploration this pass): `explorations/analytic-index-fredholm/external-chiral-background-parity-2026-07-02.md` established the 1D closed-parity half (closed => even) and correctly localized the odd count to the topological index -- now decisively computed here.
File: `canon/external-topological-index-flux-RESULTS.md` (staged); scripts `tests/function-space-ext/flux_index_2d.py`, `tests/function-space-ext/verify/flux_index_2d_indep_check.py`; exploration `explorations/analytic-index-fredholm/external-chiral-background-parity-2026-07-02.md`; cascade `NEXT-STEPS.md`, `papers/candidates/located-not-forced/STAGING-NOTES.md`

---

### ENTRY EXTERNAL-BY-STRUCTURE SYNTHESIS (2026-07-02) — the generation count upgraded from "external on present evidence" to "external by structure" (interior provably even; odd count is a boundary/topological index), modulo the RS function-space residual

**Target:** the aggressive "deep" swing (Joe-authorized) at the order-3 -> integer-3 bridge. Orientation found the paper's Section 9 has already exhaustively shown every GU-native route is 2-primary (forcing-slot test; gravitino index -42 = 0 mod 3; 16-twist = 0 mod 3 for every twist; carrier-mass capstone) -- so "force 3" re-confirms the negative. The productive aggressive move is the OTHER direction: elevate the central verdict's modality.

**Result (synthesis theorem, over separately-verified components):** the net chiral generation count decomposes as `chi = chi_interior + chi_external`. (I) `chi_interior` is EVEN/2-primary, now with proof-grade legs: Theorem 1 (enum-complete for class C + each obstruction a symbolic power-of-two identity), Theorem 2 (linear index conservation, symbolically proved from the cross-chirality Krein axioms), and the antilinear null-eigenspace bound (symbolically proved via the same transversality). (II) `chi_external` is a topological index = flux/instanton number = ANY integer (computed: 2D flux Dirac index=flux, odd for odd flux). COROLLARY: any ODD count is NECESSARILY external -- the interior cannot supply it over the complete delimited class. This upgrades "located, not forced -- external on present evidence" to "external by STRUCTURE" (the honest, delimited strong-firewall reading).

**Verified:** assembled from `canon/core-theorems-symbolic-proof-RESULTS.md` (symbolic interior-even), `canon/enum-completeness-class-c-RESULTS.md` (interior class exhausted, engine-swept), `canon/external-topological-index-flux-RESULTS.md` (external index=flux, re-verified). No new computation -- a synthesis of proven/computed results enabled by this session's symbolic proofs + enum-completeness + flux result.

**Verdict change:** NONE to the generation-count verdict itself (stays OPEN; nothing derives 3 -- the external index is any integer, nothing privileges 3). What changes is the MODALITY of "external": from evidential to structural, MODULO the one honest open residual -- the full function-space Rarita-Schwinger APS/end + family-index statement (`canon/function-space-index-conservation-RESULTS.md`), which if closed would make the structural verdict unconditional. Grade: synthesis theorem (proof/symbolic interior core; computed+swept class-C completeness; computed+re-verified external index). Internal tier. RESULTS staged at `canon/external-by-structure-synthesis-RESULTS.md`; **CANON.md promotion + the Section 9 / status-table modality upgrade PAUSE FOR JOE.**
File: `canon/external-by-structure-synthesis-RESULTS.md` (staged); cascade `papers/candidates/located-not-forced/located-not-forced-generation-count-2026-06-29.md` (Section 9 / status table -- pending Joe), `NEXT-STEPS.md`, `papers/candidates/located-not-forced/STAGING-NOTES.md`

---

### ENTRY WC-FUNCTION-SPACE-EXT RESIDUAL CLOSURE (2026-07-03) — the three open residual items of the conditional section-setting theorem (gap well-posedness, APS/end eta, family-index) are each DISCHARGED on faithful models by the sigma_1 (x) B mechanism; the residual collapses into "external by structure"; computed + independently re-verified

**Target:** WC-FUNCTION-SPACE-EXT (`NEXT-STEPS.md`, post-publication card) — the **three residual items** left explicitly OPEN by the v2.8 conditional theorem (`canon/function-space-index-conservation-RESULTS.md`): (1) gap well-posedness of the physical projection on a noncompact end, (2) the APS/noncompact-end eta correction, (3) family-index/higher-topology terms. Joe-directed "close the analytic residual" (chat 2026-07-03).

**Result (each item discharged on faithful models, one mechanism):** a chirality-odd (`{D,Gamma}=0`) + Krein-self-adjoint (`D^dag K = K D`) operator for cross-chirality `K = sigma_1` is forced to `D = sigma_1 (x) B` (B Hermitian), so `spec(D) = +- spec(B)` is symmetric about 0 and the physical sector is chirality-balanced. Each residual item is that one symmetry in a different analytic register. **(1)** On an open-chain (noncompact-end) Krein-Dirac `D = sigma_1 (x) (m_inf I + T)`, the 0-gap = distance of the asymptotic spectrum from 0, set by the END value `m_inf`: gapped end (`m_inf=1.5`) keeps a stable gap `~0.50` across `L=16..128` with `tr(Gamma P_<0)=0` to `4e-15`; gapless end (`m_inf=1.0`) closes the gap `0.017 -> 0.0003` — well-posedness IFF the end is gapped (a weighted/gapped-completion hypothesis, not a chiral leak), and the count is 0 whenever well-posed. **(2)** Any boundary/end operator IN the class is `sigma_1 (x) B_bdy` => spectrum symmetric => APS `eta_0 = 0` and half-term 0 EXACTLY (30 random class draws, sizes 2..13, max asymmetry `7.1e-15`); a nonzero eta needs an EXTERNAL out-of-class unpaired mode (`eta_0 = +-1`, half-term `+-1/2`). **(3)** For the family `D(t) = sigma_1 (x) B(t)`, the negative bundle is `{upper band} (+) {lower band}` so `c1(E_-(D)) = c1(upper) + c1(lower) = 0` identically; realized on a QWZ Chern-insulator (`c1(lower)=-1`, `c1(upper)=+1`, each nonzero — non-vacuous — `D` negative-bundle Chern `0`). The external side is already certified (`flux_index_2d.py`: index = flux number, odd for odd flux, ANY integer, breaks the interior Krein class).

**Verified:** `tests/function-space-ext/gap_wellposedness_end.py` (14 asserts, exit 0), `.../aps_end_eta_class_symmetry.py` (156 asserts, exit 0), `.../family_index_bundle.py` (8 asserts, exit 0), `.../flux_index_2d.py` (external). Independent re-checks (different substrate/seed/method/grid): `verify/gap_wellposedness_indep_check.py` (24 asserts — seeded random B, sizes 6..48), `verify/aps_end_eta_class_symmetry_indep_check.py` (50 asserts — different seed, integer + complex B, basis-free odd-moment witness `tr(D^{2k+1})=0` at `0.0e+00`), `verify/family_index_bundle_indep_check.py` (4 asserts — `m=-1.6`, `Nk=32`, projector-completeness `P_l + P_u = I` at `8.9e-16`), `verify/flux_index_2d_indep_check.py`. All exit 0. No failure condition fired.

**Verdict change:** the CARD moves from CONDITIONAL THEOREM + open residual to **RESIDUAL DISCHARGED on faithful models (computed + independently re-verified)**: within the sector class, the net chiral count is conserved at 0 in the section / boundary / family settings, and the SOLE source of a nonzero (odd) count is an external topological index (any integer, not 2-primary-constrained, not 3) — the "external by structure" reading, now with the analytic residual discharged rather than deferred. **Honest residual that REMAINS:** model -> true RS `Y14` bundle — the general-bundle statement is standard APS + family-index machinery applied to the same `sigma_1 (x) B` structure, asserted-by-machinery here, not re-derived on `Y14` (a computation, not a conceptual gap). Internal tier (caveat (e)); no number fitted. RESULTS staged at `canon/function-space-index-conservation-residual-closure-RESULTS.md`; **paper edits (Theorem 2 / caveat (d) scope sentence) and CANON.md promotion PAUSE FOR JOE.**
File: `canon/function-space-index-conservation-residual-closure-RESULTS.md` (staged); scripts under `tests/function-space-ext/` + `tests/function-space-ext/verify/`; cascade `NEXT-STEPS.md`
