...
correction_de06: "CORRECTION DARK-ENERGY-06 (2026-07-14, W129): SCOPE the DARK-ENERGY-05 numbers as M^2 = 8-specific and RETIRE the OQ2 single-band-point gate on the exclusion. W129 (tests/W129_oq2_m2_band_sweep.py, exit 0, 13/13; positive controls reproduce H46C's M^2=8 row to 4 digits and the LCDM baseline 30.68) reruns the theta_star-calibrated raw-BAO comparison across the full admissible OQ2 band (ground eigenvalues {3, 7, 8} of the S^3/A_1/BC_1 assignments, plus a bracketing scan M^2 in [1,25] covering the excited states and the 20.25 continuum threshold), the 1-component ansatz, and z_start = 10/60 IC variants, with the Gaussian omega_m h^2 prior additionally replaced by a profiled scan (Planck-penalized and flat) at M^2 = 3, 8, 20.25. VERDICT HOLDS-BAND-WIDE at the pre-stated escape criterion: at every band point the DESI-CPL-matched amplitude f0_CPL (where the calibrated w0 reaches DESI's -0.752) is excluded -- dchi^2 = +47.2 (BC_1, f0_CPL=0.17), +43.7 (A_1, 0.23), +33.5 (S^3, 1.63; still +14.9 with omega_m h^2 profiled); 1-component dAIC >= +53.5 everywhere; z_start variants shift dAIC by < 0.06. No admissible (M^2, ansatz) point escapes; every f0-scan best case is the LCDM limit f0 -> 0. HONEST SOFTENING, on the record: the DE-05 bound 'f0 < ~0.03' is the M^2=8 number, NOT the band number -- across the admissible set the 3-sigma-equivalent bound is f0 < 0.027 (BC_1) / 0.039 (A_1) / 0.208 (S^3, M^2=3), and at M^2=3 the reference f0=0.125 is only mildly disfavored (dAIC +5.25; +2.0 with omega_m h^2 profiled), so DE-05's 'excluded for f0 >= ~0.03' must be read at M^2=8. The band-safe statement is signal-level: at every admissible M^2 everything the BAO+theta_star bound allows is an LCDM mimic (|w0+1| < 0.1 at each bound) and every DESI-signal-reproducing amplitude is decisively excluded. Remaining limits: SNe unintegrated (named residual; it would squeeze the one soft direction found, the low-omega_m h^2 flat-prior profile, which alone brings M^2=8/f0=0.125 to dAIC +3.4 at a 5-sigma omega_m h^2 excursion -- rejected as an escape since it contradicts the CMB anchor the calibration relies on); single BAO dataset (DESI DR2). Verdict stays OPEN; no promotion; M^2=8 stays reconstruction-grade (OQ2 as 'which eigenvalue' remains open but no longer gates the exclusion); f_0/B_i remain fits. See explorations/W129-oq2-m2-band-sweep-de-exclusion-2026-07-14.md."
correction_de05: "CORRECTION DARK-ENERGY-05 (2026-07-13, Wave 46): SCOPE the DARK-ENERGY-04 clause (b) 'raw-distance comparison ... MARGINAL ... competitive-to-better in shape once the amplitude is marginalized'. Wave 46 executed the theta_star re-solve Wave 45 named as blocker B1: imposing Planck's acoustic scale 100theta*=1.04110 (arXiv:1807.06209 Table 2, TT,TE,EE+lowE+lensing; r*/z*/r_drag fixed, omega_m h^2=0.1430 fixed, early physics untouched -- frozen theta density is 3.4e-5 of matter at z=30) on GU's own backreacted H(z) gives GU's OWN CMB-calibrated amplitude: H0_GU=63.75, A_GU=31.97 (+5.66% vs Planck), OVERSHOOTING the BAO-preferred amplitude for its own shape by +5.7 sigma_A (lever arm dln theta*/dln h = 0.19 amplifies late-time deformations; Wave 45's 'expected shift < 1%' corrected on the record, measured -5.4% in h). Result (tests/wave46/H46C_theta_star_cmb_calibration.py, exit 0, 20/20; LCDM positive controls reproduce Planck theta* and recover h=0.6736): dAIC vs LCDM = +21.58 (Planck-fixed A) / +35.78 (own theta* calibration) / -3.17 (amplitude freed -- a shape statement with NO CMB-consistent realization) / +16.03 (omega_m h^2 profiled for BOTH models under the Planck prior). With per-f0 CMB calibration the BAO-preferred f0 is the LCDM limit f0->0 (3-sigma-equivalent bound f0 < ~0.03); the CPL-tuned f0=0.125 is excluded at dchi^2=+35.8; the DE-04 'BAO-preferred f0 ~0.05' was an artifact of holding the amplitude at the Planck value. Sector status at exploration grade (M^2=8 only; BAO+theta* only, no SNe): falsified as a CPL fit (H43/H44, unchanged) AND excluded as a CMB-consistently-calibrated distance model for f0 >= ~0.03; the theta component survives only as an undetected f0 < ~0.03 riding on a DeWitt-Lambda LCDM-mimic. Verdict stays OPEN; no promotion; M^2=8 stays reconstruction-grade (OQ2 open); f_0/B_i remain fits. See explorations/wave46/H46C-theta-star-gu-cmb-calibration-2026-07-13.md."
correction_de04: "CORRECTION DARK-ENERGY-04 (2026-07-13, Wave 45): SCOPE the DARK-ENERGY-03 phrase 'neither a clean confirmation nor a clean falsification vs DESI'. Written 2026-06-30 it was correct; after Waves 20/25/29 it must be read as two separate comparisons. (a) The (w0,wa)-CPL-projection comparison IS now FALSIFIED at exploration grade: GU's CPL locus misses DESI DR2 at every admissible root-system M^2, at the full (M^2,f0)-plane global minimum (~3.2 sigma), under a 1-component ansatz, IC variation, and a self-consistent backreacted background (H43/H44, tests/wave20 + tests/wave25). (b) The raw-distance comparison on the actual DESI DR2 BAO likelihood remains LCDM-amplitude-DEGENERATE: MARGINAL, excluded only at the canonical f0 + CMB-fixed amplitude point, competitive-to-better in shape once the amplitude is marginalized (H46, tests/wave29; dAIC accounting in tests/wave45). The DESI DR2 digits in that chain are VERIFIED against the primary sources arXiv:2503.14738 (Table 4 + official likelihood files) and arXiv:1807.06209 Table 2 (Wave 45, tests/wave45/H46B_referee_grade_desi_verification.py, exit 0). Verdict stays OPEN; no promotion; f_0/B_i remain fits; the BAO-preferred f0 (~0.05) and the CPL-tuned f0 (0.125) are mutually inconsistent (factor >=2), which is itself a finding. See explorations/wave45/H46B-referee-grade-desi-verification-2026-07-13.md."
...
> **CORRECTION DARK-ENERGY-06 (2026-07-14, W129) -- band scope on DARK-ENERGY-05 below.** The OQ2
> M^2-band sweep is now EXECUTED (`tests/W129_oq2_m2_band_sweep.py`, exit 0, 13/13; H46C's M^2 = 8
> row and the LCDM baseline reproduced exactly). The theta_star-calibrated raw-BAO exclusion
> **HOLDS BAND-WIDE**: at every admissible OQ2 point (M^2 = 3, 7, 8), every bracketing point of
> [1, 25], the 1-component ansatz, and the z_start IC variants, the amplitude at which the model
> would reach the DESI CPL signal (w0 = -0.752) is excluded at dchi^2 >= +33.5 (softest point
> M^2 = 3: +33.5 raw, +14.9 with omega_m h^2 profiled for both models). The OQ2 single-band-point
> gate on this exclusion is retired. **Honest softening**: the DE-05 bound "f0 < ~0.03" is the
> M^2 = 8 number only -- across the admissible band the 3-sigma-equivalent bound is f0 < 0.027
> (BC_1, canonical) / 0.039 (A_1) / **0.208** (S^3, M^2 = 3), and at M^2 = 3 the reference
> f0 = 0.125 is only mildly disfavored (dAIC +5.25; +2.0 profiled). The band-safe statement is
> signal-level: everything the bound allows at any admissible M^2 is an LCDM mimic
> (|w0 + 1| < 0.1), and no admissible (M^2, ansatz) point escapes at DESI-signal amplitudes.
> Remaining: SNe unintegrated; single BAO dataset. Verdict stays OPEN; no promotion; M^2 = 8
> stays reconstruction-grade (OQ2 as "which eigenvalue" remains open, no longer gating).
> See `explorations/W129-oq2-m2-band-sweep-de-exclusion-2026-07-14.md`.

> **CORRECTION DARK-ENERGY-05 (2026-07-13, Wave 46) -- scope note on clause (b) of DARK-ENERGY-04
> below.** The Wave 45 blocker B1 (the theta_star re-solve of GU's own CMB-calibrated amplitude)
> is now EXECUTED (`tests/wave46/H46C_theta_star_cmb_calibration.py`, exit 0, 20/20). Imposing
> Planck's 100 theta_star = 1.04110 on GU's own H(z) (early physics fixed; the frozen theta
> density is 3.4e-5 of matter at z = 30) gives H0_GU = 63.75 and amplitude A_GU = 31.97, +5.66%
> above Planck's -- OVERSHOOTING the BAO-preferred amplitude for GU's own shape by +5.7 sigma_A.
> Consequences: the "competitive-to-better in shape once the amplitude is marginalized" reading
> (dAIC = -3.17) has **no CMB-consistent realization**; at GU's own calibration dAIC = **+35.78**
> (and still **+16.03** with omega_m h^2 profiled for both models under the Planck prior); with
> per-f0 CMB calibration the BAO-preferred f0 is the **LCDM limit f0 -> 0** (bound f0 < ~0.03),
> so the "BAO-preferred f0 ~ 0.05" below was an artifact of holding the amplitude at the Planck
> value. Sector status at exploration grade (M^2 = 8 only; BAO+theta_star only): falsified as a
> CPL fit (unchanged) AND excluded as a CMB-consistently-calibrated distance model for
> f0 >= ~0.03. Verdict stays OPEN; no promotion.
> See `explorations/wave46/H46C-theta-star-gu-cmb-calibration-2026-07-13.md`.

> **CORRECTION DARK-ENERGY-04 (2026-07-13, Wave 45) -- scope note on the paragraph below.** The
> DARK-ENERGY-03 sentence "neither a clean confirmation nor a clean falsification" is HISTORICAL
> as an unscoped statement and now splits into two comparisons: **(a) the (w0,wa) CPL-projection
> comparison is FALSIFIED at exploration grade** (H43/H44, Waves 20/25: GU's CPL locus misses DESI
> DR2 at ~3.2 sigma globally, robust to root-system M^2, ansatz, ICs, and self-consistent
> backreaction); **(b) the raw-distance comparison on the actual DESI DR2 BAO likelihood is
> MARGINAL** (H46, Wave 29: excluded only at canonical f0 + CMB-fixed amplitude; competitive-to-
> better in shape once the amplitude is marginalized, dAIC = -3.17, not decisive; the two rescue
> directions are mutually inconsistent in f0). DESI DR2 / Planck digits in that chain are verified
> against the primary sources (Wave 45, `tests/wave45/H46B_referee_grade_desi_verification.py`).
> Verdict stays OPEN. See `explorations/wave45/H46B-referee-grade-desi-verification-2026-07-13.md`.
