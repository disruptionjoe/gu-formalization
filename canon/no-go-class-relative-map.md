...
- The Velo-Zwanziger entry is GU-specific. Full analysis chain 2026-06-22 through 2026-06-23: `explorations/vz1-velo-zwanziger-analysis-2026-06-22.md` and vz-* pack (vz-schur, vz-oq1, vz-oq2, vz-subprincipal, vz-f5, vz-f6, vz-14d-mixed-covectors). Status upgraded from OPEN to CONDITIONALLY_RESOLVED (horizontal + full 14D mixed covectors, reconstruction grade) + VERIFIED at 4D principal-symbol level (OQ3-V1/V2/V3 RESOLVED). Evasion mechanism: Clifford module non-decoupling (RS sub-bundle is not a sub-Clifford-module of E, so VZ assumption H1 is violated). Remaining open: F5 (full constrained-Hamiltonian analysis under Sp(64) curvature); OQ-RS-2 (loop corrections to B/C blocks); KK zero-mode existence. The "trivial internal coupling" claim was found to be false at the 4D level (RS sector carries SM charges); OQ2 (guardian symmetry) is contingent-RESOLVED because RS does not decouple kinematically.
