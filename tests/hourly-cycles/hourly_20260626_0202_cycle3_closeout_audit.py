"""Audit the 0202 cycle 3 closeout and synthesis artifacts."""
...
ARTIFACTS = {
    "IG": ROOT / "explorations/hourly-20260626-0202-cycle3-ig-projector-restart-closeout.md",
    "RS": ROOT / "explorations/hourly-20260626-0202-cycle3-rs-evidence-manifest-closeout.md",
    "PTUJ": ROOT / "explorations/hourly-20260626-0202-cycle3-ptuj-formula-transition-closeout.md",
    "DGU": ROOT / "explorations/hourly-20260626-0202-cycle3-dgu-symbol-vz-closeout.md",
    "QFT": ROOT / "explorations/hourly-20260626-0202-cycle3-qft-source-shadow-closeout.md",
    "SYNTHESIS": ROOT / "explorations/hourly-20260626-0202-three-cycle-fifteen-hole-synthesis.md",
}
...
class Cycle3CloseoutAudit(unittest.TestCase):
    ...
    def test_route_closeout_blocks_match_cycle_frontiers(self) -> None:
