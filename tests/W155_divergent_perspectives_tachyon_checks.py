"""
W155 -- deterministic checks for the ten-divergent-perspectives tachyon reframe sweep.
...
reframes in explorations/W155-ten-divergent-perspectives-tachyon-2026-07-14.md.
...
# ---------------------------------------------------------------------------
# CORE IDENTITY (perspective 6 / perspective 10 convergence): a2 = -a1^2 exactly.
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# F(R) SHAPE: downward parabola. Real roots, single Morse maximum (perspective 5).
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# INFLATION honest obstruction (perspective 1B): Einstein-frame potential.
...
# ---------------------------------------------------------------------------
# PATTERN / SATURATION hooks (perspectives 3, 7): scalar dispersion peaks at k=0.
...
check("C14 unstable band k in [0, 1/sqrt(2)) (k_cut = sqrt(-m^2)); finite-k peak "
      "requires the R^2 k^4 / spin-2 sector (perspective 3 open check)",
