...
TABLE = [
    ...
    ("SA-G10", "FIT"), ("SA-G11", "FIT"), ("SA-G12", "FIT"),
    ("SA-G13", "DECLARATION"),
...
check("G1 31 requirement rows", len(TABLE) == 31)
check("G2 FORCED count = 8", counts.get("FORCED") == 8)
check("G3 DECLARATION count = 10", counts.get("DECLARATION") == 10)
check("G4 FIT count = 13", counts.get("FIT") == 13)
