...
`selected_cubic_reduced_numerator_probe.py` and
`conditional_physics_ledger_v018_probe.py`. They enforce the full free-pencil
external legs, the compact-core diagonal shell zero, the rival mixed
completions, the symplectic bulk/preboundary fence and the exact v0.17-to-v0.18
ledger migration. Planted controls reject a frozen-block-as-full-numerator
promotion, denominator-as-pole promotion, EOM-exact-as-selected promotion,
missing source ownership and silent use of P1/P2/P3.
