...
`selected_cubic_augmented_torsion_d3_owner_probe.py`,
`selected_cubic_augmented_torsion_d3_owner_independent.sage` and
`conditional_physics_ledger_v020_probe.py`. They compute the first intrinsic
selected-cubic owner by independent exact routes, enforce the stationary
pullback jet-order boundary, preserve the mandatory symplectic nonpromotion,
and freeze exactly three v0.20 distance migrations with unchanged verdicts,
residue, quotients and P1/P2/P3.
