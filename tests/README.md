...
`first_perturbative_background_c_operator_probe.py` with an independent Sage
control and v0.16 ledger probe. It constructs the action-owned fixed-background
TT spectral `C`, verifies its zero-freedom first-order lift, and classifies its
Jordan, complex, disconnected-real and scalar-nonselection loci. Planted
controls forbid promotion to a stationary vacuum, full nonlinear or Fock-space
metric, common domain, source attribution or P1/P2/P3 use.
