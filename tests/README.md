...
- `channel-swings/pw2d_native_transported_shiab_action_probe.py` checks the
  ...
  complete `kappa1/2` mass action jet, Delta-only quadratic response, separate
