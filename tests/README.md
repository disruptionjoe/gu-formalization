...
| `channel-swings/` (401 Python + 30 Sage) | active channel and Lane-1 swing probes; the current count includes the K77 total raw-`Upsilon`/labelled-null-screen probe and ledger-v0.60 integrity gate. The detailed historical inventory remains represented by the files and per-wave entries above. |
