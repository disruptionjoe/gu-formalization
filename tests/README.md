...
| `channel-swings/` (436 Python + 42 Sage) | active channel and Lane-1 swing probes; the current count includes the full pointwise K77 u(64,64) action bank, its independent Sage reconstruction, and ledger-v0.77 integrity gate. The detailed historical inventory remains represented by the files and per-wave entries above. |
