...
`selected_cubic_intrinsic_homogeneous_ward_closure_probe.py`,
`selected_cubic_intrinsic_homogeneous_ward_closure_independent.sage` and
`conditional_physics_ledger_v023_probe.py`. The production route proves exact
moving-Shiab covariance and zero intrinsic cubic/quadratic Ward variation for
all 91 K77 bivector generators; frozen and wrong-sign plants remain nonzero.
The independent Sage route rebuilds the structural exterior/matrix identity,
the symplectic fence forbids full Ward/BV/preboundary promotion, and the
ledger check freezes exactly five v0.23 distance migrations with unchanged
verdicts, residue, quotients and P1/P2/P3.
