...
| `channel-swings/` (407 Python + 30 Sage) | active channel and Lane-1 swing probes; the current count includes the K77 paired-Upsilon/Xi Green-owner probe and ledger-v0.63 integrity gate. The detailed historical inventory remains represented by the files and per-wave entries above. |
