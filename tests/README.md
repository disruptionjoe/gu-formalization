...
`moving_gimmel_hodge_frame_owner_probe.py` and
`conditional_physics_ledger_v026_probe.py`. They compute the exact local
trace-reversed `Sym2`/gimmel inertia and TT derivative, prove density response
zero with live fixed-frame Hodge motion, construct the co-moving-frame
compensator, and freeze five distance-only migrations with unchanged verdicts,
residue, quotients and P1/P2/P3. Complete selected-action observation/BV/BFV
