...
| `channel-swings/` (614 Python + 92 Sage) | active channel and Lane-1 swing probes; the current count includes the v0.215 observer-time Hermitian-reduction probe and ledger gate, the v0.214 real-primalizer phase packet, and all predecessors. The detailed historical inventory remains represented by the files and per-wave entries above. |
