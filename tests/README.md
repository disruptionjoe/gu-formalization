...
- `channel-swings/k457_k152_shifted_residual_gram_reduction.py` and its probe
  reduce the complete residual to 59586 coherent finite Gram entries plus the
  post-order-12 tail while fencing numerical evaluation.
