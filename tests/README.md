...
- `channel-swings/pw2fr2b2b2d_kappa_c4_identifiability_probe.py`
  ...
  and a live native-ray Green concomitant. It also exhibits two admissible
  `U4` completions proving that this normal subbank does not identify the
  complete off-shell `kappa1` or `I1` C4 coefficient. Run it with
