...
`k77_wave2_i1b_conormal_symbol_weld_domain_probe.py`: an exact
selector-independent I1B principal-symbol, fixed-section `85/91` annihilator,
all-section factorization, normal-density weld and `H9/H10` trace-domain gate.
