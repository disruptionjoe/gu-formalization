...
| `channel-swings/` (630 Python + 92 Sage) | active channel and Lane-1 swing probes; the current count includes the v0.223 observer-Q_B radial-stationarity composition and append-only ledger gate, v0.222 contact/Euler Hodge-adapter, v0.221 trace-Hq normal-contact correction, and all predecessors. The detailed historical inventory remains represented by the files and per-wave entries above. |
