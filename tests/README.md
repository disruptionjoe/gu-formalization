...
| `channel-swings/` (112) | active channel and Lane-1 swing probes, including the native operator/domain/`w1` bridge audit, the Pin+ degree-14 Smith/table gate, the Pin/Smith class-realization ultimatum, and the Mannheim--Callias end-admission gate |
