...
`selected_first_order_epsilon_preboundary_compose_probe.py` and
`conditional_physics_ledger_v025_probe.py`. They compose the selected product
with prior exact principal/homogeneous/primitive-epsilon owners, independently
verify compact Dirichlet versus unrestricted boundary flux, and freeze five
distance-only migrations with unchanged verdicts, residue, quotients and
P1/P2/P3. The v0.24 action-owner split remains binding before Q1.
