...
| `channel-swings/` (454 Python + 51 Sage) | active channel and Lane-1 swing probes; the current count includes the principal Ward/gamma-epsilon reconciliation, independent Sage route, ledger-v0.86 integrity gate, and all predecessors. The detailed historical inventory remains represented by the files and per-wave entries above. |
