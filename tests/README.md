...
`cross_theory_mechanism_donor_crosswalk_probe.py`. It enforces the five-class
port vocabulary, complete recipient/translation/datum/constraint/kill/revival
contract, two-port cap, wrong-type and already-present fences, frozen v0.17
ledger and the dependent five-wave scaffold. Planted controls reject a third
port, a generic near-match bucket, hidden compactification data, an unmapped LQG
measure, premature FRG and physical promotion before symplectic descent.
