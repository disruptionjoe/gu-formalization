...
| `channel-swings/` (626 Python + 92 Sage) | active channel and Lane-1 swing probes; the current count includes the v0.221 trace-Hq normal-contact correction, v0.220 source-normal-jet reconciliation, the v0.219 full-contact identifiability packet, and all predecessors. The detailed historical inventory remains represented by the files and per-wave entries above. |
