...
`selected_cubic_gauge_rotated_lc_ward_owner_probe.py`,
`selected_cubic_gauge_rotated_lc_ward_owner_independent.sage` and
`conditional_physics_ledger_v021_probe.py`. They compute the symmetric-frame
LC mixed TT shell kernel by independent exact routes, exhaust the LC/Gauss and
radial-Hessian carriers, expose the rank-five gauge obstruction, enforce the
mandatory symplectic nonpromotion, and freeze exactly five v0.21 distance
migrations with unchanged verdicts, residue, quotients and P1/P2/P3.
