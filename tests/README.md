...
`k77_wave2_moving_shiab_epsilon_ward_green_domain_probe.py`: an exhaustive
eight-channel moving-Shiab rank census, primitive epsilon/even-Ward owner
check, and compact-core `H10 -> H9` Green-domain gate. Its immediate
predecessor is `k77_wave2_i1b_conormal_symbol_weld_domain_probe.py`, the exact
