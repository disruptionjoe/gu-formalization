...
| `channel-swings/` (452 Python + 50 Sage) | active channel and Lane-1 swing probes; the current count includes the metric-transverse augmented-torsion probe, independent Sage route, ledger-v0.85 integrity gate, and all predecessors. The detailed historical inventory remains represented by the files and per-wave entries above. |
