...
FINDINGS = (
    Finding(
        ...
        "ALREADY-ABSORBED",
        "explorations/hourly-cycles/hourly-20260626-1003-cycle3-tau-source-locator-packet.md",
    ...
    Finding(
        ...
        "SOURCE-BOUND",
        "explorations/hourly-cycles/hourly-20260625-0502-cycle2-author-manuscript-dgu-vz-action-receipt-gate.md",
