...
check("repo", "current question has advanced through K121 to native cubic assembly", "complete native i1b pullback cubic" in current.lower())
check("repo", "roadmap preserves K118 beneath current K121", "K121" in roadmap[:3500] and "K118" in roadmap and "action layer" in roadmap.lower())
