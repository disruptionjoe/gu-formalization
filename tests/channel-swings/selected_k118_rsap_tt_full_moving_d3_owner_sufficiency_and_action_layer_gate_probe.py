...
check("repo", "current question begins with action-layer selection", "action layer" in current.lower() and "two-jet" in current.lower())
check("repo", "roadmap leads with K118", "K118" in roadmap[:3500] and "action layer" in roadmap[:3500].lower())
