...
check("repo", "current state advances through K126", "K126" in current and "K127" in current)
check("repo", "roadmap routes the curved lower-order packet", "K127" in roadmap[:8000])
...
print("CURVED_LOWER_ORDER_SYMMETRIC_TT_PACKET=3_PARAMETERS_OPEN_K127")
