...
rb4 = (ROOT / "lab/evidence/predecessor-records/rb4-observer-cartan-moving-family.md").read_text()
rb5 = (ROOT / "lab/evidence/predecessor-records/rb5-flag-ownership-and-hessian-eligibility.md").read_text()
rb6 = (ROOT / "lab/evidence/predecessor-records/rb6-source-concomitant-grammar.md").read_text()
rb7 = (ROOT / "lab/evidence/predecessor-records/rb7-stationary-nonmetric-order-parameter.md").read_text()
