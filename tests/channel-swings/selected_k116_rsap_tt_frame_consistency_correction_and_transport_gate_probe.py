...
check(
    ...
    "complete native i1b pullback cubic" in current_state.lower(),
)
check("repo", "roadmap preserves K116 as superseded predecessor", "K116 CORRECTS THE TT TRANSPORT TARGET" in roadmap and "K121" in roadmap[:3000])
