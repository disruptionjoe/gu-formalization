...
```
| GU-MEDIA-2020-JRE-1453 | 02:44:13 (approx, per media-index outline) | terminology | "Geometric Unity replaces spacetime" framing | verified (once direct-quote confirmed) | sources/claim-ledger.md + cross-ref to Oxford 2013 Sector I row |
...
- Worked examples (sibling #24): `specifications/six-axis/examples/` (Type II_1 spectral SM, Sorkin causal-set, RG universality-class).
