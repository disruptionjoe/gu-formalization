...
the certified K520/K508 interval backend at 180 Arb digits and one thread.
...
for 2,979,200 ordered descriptor-cell evaluations and 9,253,216
divided-difference operations; all 32 independent first-cell direct K412
overlaps pass. Observed wall time is 3,531.15 seconds, or 110.35 seconds per
...
Together with K512--K520, this executes 292 of the 916 programs omitted by
K508; 624 remain. K521 does not establish a complete face bank, projective
...
## K520 order-ten face shards 057--064 (2026-09-26)

K520 executes the exact 32 programs in K511 shards 057 through 064 through
the certified K519/K508 interval backend at 180 Arb digits and one thread.
All 224 positive-width normal cells are finite, have strictly positive
cumulative arguments and preserve all 28 coherent groups. The batch accounts
for 2,979,200 ordered descriptor-cell evaluations and 6,482,448
divided-difference operations; all 32 independent first-cell direct K412
overlaps pass. Observed wall time is 3,808.00 seconds, or 119.00 seconds per
program, as host evidence rather than a runtime bound. The stored-result probe
passes `21/21` controls and rejects `11/11` hostile mutations.

Together with K512--K519, this executes 260 of the 916 programs omitted by
K508; 656 remain. K520 does not establish a complete face bank, projective
normal-cone cover, recursive positive-interior cover, analytic tails, complete
hybrid integral, K500 leakage, K473 floor, K457 value, K152 interval, source
result or physical conclusion.

## K519 order-ten face shards 049--056 (2026-09-26)

K519 executes the exact 32 programs in K511 shards 049 through 056 through
the certified K518/K508 interval backend at 180 Arb digits and one thread.
All 224 positive-width normal cells are finite, have strictly positive
cumulative arguments and preserve all 28 coherent groups. The batch accounts
for 2,979,200 ordered descriptor-cell evaluations and 7,846,720
divided-difference operations; all 32 independent first-cell direct K412
overlaps pass. Observed wall time is 3,668.62 seconds, or 114.64 seconds per
program, as host evidence rather than a runtime bound. The stored-result probe
passes `21/21` controls and rejects `11/11` hostile mutations.

Together with K512--K518, this executes 228 of the 916 programs omitted by
K508; 688 remain. K519 does not establish a complete face bank, projective
normal-cone cover, recursive positive-interior cover, analytic tails, complete
hybrid integral, K500 leakage, K473 floor, K457 value, K152 interval, source
result or physical conclusion.

## K518 order-ten face shards 041--048 (2026-09-26)

K518 executes the exact 32 programs in K511 shards 041 through 048 through
the certified K517/K508 interval backend at 180 Arb digits and one thread.
All 224 positive-width normal cells are finite, have strictly positive
cumulative arguments and preserve all 28 coherent groups. The batch accounts
for 2,979,200 ordered descriptor-cell evaluations and 8,394,624
divided-difference operations; all 32 independent first-cell direct K412
overlaps pass. Observed wall time is 3,337.92 seconds, or 104.31 seconds per
program, as host evidence rather than a runtime bound. The stored-result probe
passes `21/21` controls and rejects `11/11` hostile mutations.

Together with K512--K517, this executes 196 of the 916 programs omitted by
K508; 720 remain. K518 does not establish a complete face bank, projective
normal-cone cover, recursive positive-interior cover, analytic tails, complete
hybrid integral, K500 leakage, K473 floor, K457 value, K152 interval, source
result or physical conclusion.
...
K515 executes the exact 32 programs in K511 shards 017 through 024 through
the certified K514/K508 interval backend at 180 Arb digits and one thread.
All 224 positive-width normal cells are finite, have strictly positive
cumulative arguments and preserve all 28 coherent groups. The batch accounts
for 2,979,200 ordered descriptor-cell evaluations and 10,021,872
divided-difference operations; all 32 independent first-cell direct K412
overlaps pass. Observed wall time is 3,845.26 seconds, or 120.16 seconds per
program, as host evidence rather than a runtime bound. The stored-result probe
passes `21/21` controls and rejects `11/11` hostile mutations.

Together with K512--K514, this executes 100 of the 916 programs omitted by
K508; 816 remain. K515 does not establish a complete face bank, projective
normal-cone cover, recursive positive-interior cover, analytic tails, complete
hybrid integral, K500 leakage, K473 floor, K457 value, K152 interval, source
result or physical conclusion.

## K514 order-ten face shards 009--016 (2026-09-25)

K514 executes the exact 32 programs in K511 shards 009 through 016 through
the unchanged K508 interval backend at 180 Arb digits and one thread. All 224
positive-width normal cells are finite, have strictly positive cumulative
arguments and preserve all 28 coherent groups. The batch accounts for
2,979,200 ordered descriptor-cell evaluations and 10,632,608
divided-difference operations; all 32 independent first-cell direct K412
overlaps pass. Observed wall time is 3,656.09 seconds, or 114.25 seconds per
program, as host evidence rather than a runtime bound. The stored-result probe
passes `21/21` controls and rejects `11/11` hostile mutations.

Together with K512/K513, this executes 68 of the 916 programs omitted by K508;
848 remain. K514 does not establish a complete face bank, projective
normal-cone cover, recursive positive-interior cover, analytic tails, complete
hybrid integral, K500 leakage, K473 floor, K457 value, K152 interval, source
result or physical conclusion.

## K513 order-ten face shards 001--008 (2026-09-25)

K513 executes the exact 32 programs in K511 shards 001 through 008 through
the unchanged K508 interval backend at 180 Arb digits and one thread. All 224
positive-width normal cells are finite, have strictly positive cumulative
arguments and preserve all 28 coherent groups. The batch accounts for
2,979,200 ordered descriptor-cell evaluations and 10,681,664
divided-difference operations; all 32 independent first-cell direct K412
overlaps pass. Observed wall time is 3,621.85 seconds, or 113.18 seconds per
program, as host evidence rather than a runtime bound. The stored-result probe
passes `21/21` controls and rejects `11/11` hostile mutations.

Together with K512, this executes 36 of the 916 programs omitted by K508; 880
remain. K513 does not establish a complete face bank, projective normal-cone
cover, recursive positive-interior cover, analytic tails, complete hybrid
integral, K457 value, K152 interval, source result or physical conclusion.
...
Exactly two of axes `2..7` lie in q=`[13/5,15]`; every other coordinate uses
the established low or high interval; and at least one non-middle coordinate
is high. The resulting 945 boxes are pairwise disjoint and outside the
interiors of K247, K265, K266 and K267.

K230 licenses its retained rational-function representative only after
integration over a complete S6-invariant domain. K268 therefore enumerates
all middle-axis pairs and all high subsets in every fixed-axis block. Exact
FLINT recurrences compile signed heads through total degree nine, exact
product-cosh centered moments integrate those heads, and complete-homogeneous
...
complete union is strictly positive in the normalized interval
`[6.069842828829e-16,6.778691761632e-16]`, with conservative declared lower
`1.0e-16`.

An independent reverse-order raw-allocation replay recompiles all 945 boxes,
reproduces every polynomial hash, independently reconstructs all moments and
rational tails, and replays directed normalization. Two- and three-point
product quadratures lie inside the exact interval. Absolute-weight and
wrong-measure mutations differ as required; the dominant-block deletion
control also passes.

K268 controls only this declared adjacent two-exchangeable-axis collar. It
does not control regions with three or more exchangeable middle coordinates,
fixed-axis middle q>`15`, q>`2304`, the full K218 integral, the complete
...
Reproduce with `python3 tests/channel-swings/k217_order_six_signed_inner_box.py --write`
and `_local/cas-venv/bin/python tests/channel-swings/k217_order_six_signed_inner_box_probe.py`.
The producer integrates `X^n` for `n<=3` using exact uniform Dirichlet
support-intersection moments and `J_r=int_0^log(2) cosh(t)^(r+1)dt`;
the probe uses direct factorial moments, ordinary one-dimensional integrals,
independent pointwise coefficients and a planted sign mutation. The
binomial tail is bounded before signs by
`2928*C*binom(17,4)*(35/1024)^4/[1-(35/1024)*(18/5)]`, where `C` is
the raw prefactor times simplex volume, `pi>3` and the exact auxiliary
`int product cosh(t_j)dt=(3/4)^8`.
No cancellation is assumed in that remainder. SC-ACT-01/02 (`ASSERTS`),
SC-META-53 (`UNCERTAIN`) and LT-SM8/LT-GR6b/RA-F1/AC-F1 (`NEEDS`)
remain unchanged.
...
K217 corrects K213's **written** raw angular `prod z_i^(2/3)` multiplier:
the original raw angular measure is uniform after the K202 reference density
and residual cancel. The pointwise radial/Bessel identity is separate; do
not infer that its probe validated the erroneous angular multiplier.
...
| The residual face topology is explicitly banked | all 15 nonempty size-three active-gap masks are serialized; exact rational substitution verifies pure-Cauchy normalization on all 3 size-two and 15 size-three face centers, and generic noncoalescent point controls are positive | exact scaffold and failure localization only; the shifted outward Taylor-entry tails are not serialized |
...
| K192 releases cubature, action columns or physical positivity | no outward face-chart cover, Duffy/Jacobi remainder, complete core error, outward order-six total, action column, residual, complement/flux floor, scalar center or K152 interval exists | false; `SC-META-53` stays `UNCERTAIN`, `LT-SM8`, `LT-GR6b`, `RA-F1`, `AC-F1` stay `NEEDS` |
...
| A supplied three-stage action complex has gauge images inside cycles; chain maps preserve cycles and gauge equivalence; corrected observation is a chain map when its projector fixes observed gauge images and is invisible to the observed equation map; the frozen strict packet cannot select any injectively parameterized action family | `Lean/GUFormalization/SourceNativeActionObservationComplex.lean`; Lean `gaugeImage_isCycle`, `ChainMap.mapCycle`, `ChainMap.mapsCohomologousCycles`, `corrected_mapsCycle`, `corrected_mapsCohomologous`, and `strictSource_does_not_select_injective_actionFamily`; exact rational hostile probe; default-target axiom receipt | L1 conditional linear/homological interface with an actual cycle-subtype quotient; not a source-selected action, split, domain, positive physical Hilbert space or physical state quotient |
...
| Claim | Evidence | Honest grade |
| --- | --- | --- |
| Every completed finite supplied-action Burnside span object `A` is sent to the additive commutative group `Hom(point,A)`, and every span acts by postcomposition | `Lean/GUFormalization/GroupActionBurnsideMackeyFunctor.lean`; Lean `pointMackeyFunctor` and its additive instance | L1 exact representable additive functor |
...
| The all-object point-representable functor is supplied separately above; classification, subgroup-change coherence, source-native realization, physical representation, selector, prediction, or GU verdict | not constructed by the point-endomorphism theorem | open here / separately narrowed |

## Additive Burnside span category (2026-08-31)

| Claim | Evidence | Honest grade |
| --- | --- | --- |
| Disjoint coproduct of span apices gives every finite supplied-action span hom-set a commutative monoid | `Lean/GUFormalization/GroupActionBurnsideSpanCategory.lean`; explicit empty/unit/associative/commutative apex equivalences | L1 exact group-action algebra |
...
| The point-endomorphism law and all-object point-representable functor are supplied separately above; source-native realization, physical representation, selector, prediction, or GU verdict | not constructed by this additive span completion | open here / separately narrowed |
...
| A separate categorical universal property, Mackey functor across subgroup change, source-native realization, physical representation, selector, prediction, or GU verdict | not constructed by the present raw span-category theorem; homwise addition/preadditivity is supplied separately above | open / explicitly excluded |
...
| Arbitrary-span composition, homwise preadditive completion, point-endomorphism law, and the point-representable functor are supplied separately by the span modules above; physical representation category, source-native action, coupling, selector or GU verdict | not constructed by this object-level finite-action Burnside group | open here / separately narrowed |
...
| The completed span category bypasses this obstruction by changing the homs; the point-endomorphism law and point-representable functor are supplied separately; physical realization | not constructed by this obstruction theorem | open here / separately narrowed |
