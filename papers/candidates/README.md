...
|---|---|---|
| [`good-stable-compactification-no-go/`](good-stable-compactification-no-go/) | **Compact-Image Obstructions for a Hyperbolic Grading in Sp(32,32)**; standalone mathematical v0.6 candidate with exact Sage/property certificates and a narrow Lean kernel. Eleven findings from the v0.5 hostile-specialist pass are repaired; a clean adversarial saturation rerun remains pending. No PDF or release package exists. | [`STAGING-NOTES.md`](good-stable-compactification-no-go/STAGING-NOTES.md) |
