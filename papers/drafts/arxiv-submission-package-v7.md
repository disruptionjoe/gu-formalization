...
version: v7
source_paper: papers/drafts/what-geometric-unity-needs-to-do-next-v7.md
do_not_submit: true
---
...
*Package prepared 2026-06-23. Source paper: papers/drafts/what-geometric-unity-needs-to-do-next-v7.md.
Do not submit — Joe Hernandez reviews and submits himself.*
