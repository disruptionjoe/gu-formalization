...
|---|---|---|---|---|
| **A1** Lean-formalize the theorem legs | `A1-lean-formalization-inventory.md`, `A1-arith-core-check.lean` (compiles clean, Lean 4.32.0-rc1, no sorry/axiom in proof bodies), `A1-located-not-forced-legs.lean` (mathlib skeleton, UNVERIFIED), `A1-arithmetic-certificate.py` (17 checks) | Partial (honest) | holds | mathlib-dependent legs need a `.lake`/mathlib compile; only the arithmetic core is Lean-verified |
